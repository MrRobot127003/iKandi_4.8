...
{
    public partial class frmDepartmentWiseScheduler : System.Web.UI.Page
    {
        string MailType = "Sampling Status Report";
        string Flag = string.Empty;
        string FitsPath = string.Empty;
        string name = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            string url = "http://localhost:3220/Departmentwise_Report.aspx";
        ...
        public Boolean SendClientRegistrationEmail(String ClientName, String UsernamePasswordList, String ToEmail, string MailType)
        {
            ...
            try
            {
                ...
                {
                    if (MailType == "Sampling Status Report")
                    {
                        List<Attachment> atts = new List<Attachment>();

                        //ReportType = "HandOver-PreOrder";
                        name = "Sampling-status" + ".xlsx";
                        ...
                        //name = "UpCommingDC_ForFabricSorted" + ".xlsx";
                        //if (File.Exists(Constants.FITS_FOLDER_PATH + name))
                        //{
