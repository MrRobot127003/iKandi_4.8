<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BuyingHouseList.aspx.cs" Inherits="iKandi.Web.Internal.Buyinghouse.BuyingHouseList" MasterPageFile="~/layout/Secure.Master" %>

<%@ Register src="../../UserControls/Lists/BuyingHouseList.ascx" tagname="BuyingHouseList" tagprefix="uc1" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="cph_main_content" runat="server">
    ...
    <script type="text/javascript" src='<%=Page.ResolveUrl("~/js/form.js")%>'></script>
        ...
        <uc1:BuyingHouseList ID="BuyingHouseList1" runat="server" />
