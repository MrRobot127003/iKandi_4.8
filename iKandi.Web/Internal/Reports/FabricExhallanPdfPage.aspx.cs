...
{
    public partial class FabricExhallanPdfPage : System.Web.UI.Page
    {
        ...
        public void BindTopSectionAccessory()
        {
            ...
            sb.Append("<tr>");
            sb.Append("<td colspan='2' style='background: #39589c;color: #fff;font-size:15px'>Fabric challan</td>");
            sb.Append("</tr>");
            sb.Append("<tr>");
            ...
            sb.Append("</tr>");
            //sb.Append("<tr>");
            //sb.Append("<td style='text-align:left;border-right:0px;'>Send Qty. <span style='color:#000'>" + " 1,234 " + "</span>" + "Unit" + "</td>");
            //sb.Append("<td style='text-align:left;border-left:0px;'>Remaining Qty. <span style='color:#000'>" + " 4563 " + "</span>" + "Unit" + "</td>");
            //sb.Append("</tr>");
            sb.Append("</table>");
