...
{
    public partial class KeyManpowerSummaryMMR : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                bindKeypowerGrd(DateTime.ParseExact(txtCreatedDate.Value, "dd MMM yy (ddd)", System.Globalization.CultureInfo.InvariantCulture).ToString());
            }
        }
        ...
        protected void grdKeyManPowerMMReport_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                try
                {
                    ...
                    decimal ManPowerC47Percent, ManPowerC45Percent, ManPowerD169Percent, ManPowerC52Percent, ManPowerBIPLPercent = 0;
                    decimal ManPowerC47Budget, ManPowerC47Today, ManPowerC45Budget, ManPowerC45Today, ManPowerD169Budget, ManPowerD169Today, ManPowerC52Budget, ManPowerC52Today, ManPowerBIPLBudget, ManPowerBIPLToday = 0;
