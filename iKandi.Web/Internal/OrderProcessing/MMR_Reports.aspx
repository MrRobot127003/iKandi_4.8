<%@ Page Title="" Language="C#" MasterPageFile="~/layout/Secure.Master" AutoEventWireup="true" CodeBehind="MMR_Reports.aspx.cs" Inherits="iKandi.Web.Internal.OrderProcessing.MMR_Reports" %>
...
.disp_non
{
  ...
  <script type="text/javascript">
    ...
    function DateValidation() {
        //debugger;
        var Today = new Date();
        var txtDate = new Date(ParseDateToSimpleDate($(".date").val()));
    ...
    <table border="0" cellpadding="0" cellspacing="0" width="1500px" align="center" style="font-family:Arial;">
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td style="width: 25%; padding-left:25px;">
                <asp:TextBox ID="txtDate" runat="server" CssClass="th" Width="120px"></asp:TextBox>
                <asp:RequiredFieldValidator ID="rfvStartDate" runat="server" Display="None" ErrorMessage="Please select a Date." ControlToValidate="txtDate" ValidationGroup="G1" />  
                <asp:Button ID="btnCreate" runat="server" Text="Search" CssClass="go" OnClientClick="javascript:return DateValidation()" OnClick="btnCreate_Click" ValidationGroup="G1" />
                <asp:ValidationSummary ID="vsSummary" runat="server" ShowMessageBox="true" ShowSummary="false" ValidationGroup="G1" />
                
              </td>
              <td align="center" style="width: 45%; color: #FFFFFF; font-size: 18px;">
                Daily MMR Report (<asp:Label ID="lblDate" runat="server" Text="0"></asp:Label>)
              </td>
              ...
              <td style="padding-right: 15px;">
                <a rel="shadowbox;width=780;height=600;" href="/internal/OrderProcessing/MoBudget_Formulas.aspx?show=MMRDailyReport" onclick="return OpenShadowbox(this);"><img src="../../images/help.png" height="30px" alt="" title="Help!" /></a>
              </td>
            </tr>
          </table>
        </td>
                ...
                <tr>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvBudgetSummary1" runat="server" AutoGenerateColumns="false" 
                          Width="100%" ShowFooter="true" FooterStyle-Height="70px" 
                      ...
                      <Columns>
                        ...
                        <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed; border-spacing:0; border-collapse:collapse; padding:0px; margin:0px;">
                              ...
                              <tr style="height:35px;"><td align="center"><asp:Label ID="lblManPowerTotalActual" runat="server" Font-Size="12px" Font-Bold="true" Text="" /></td></tr>
                            </table>
                          </FooterTemplate>
                        </asp:TemplateField>
                         <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="42px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                        ...
                        <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed; border-spacing:0; border-collapse:collapse; padding:0px; margin:0px;">
                              ...
                              <tr style="height:35px;"><td id="tdTotalManpowerDiff" runat="server" align="center"><asp:Label ID="lblTotalManPowerDiff" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                            </table>
                          </FooterTemplate>
                        </asp:TemplateField>
                        ...
                        <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" style="table-layout:fixed; border-spacing:0; border-collapse:collapse; padding:0px; margin:0px;">
                              ...
                              <tr style="height:35px;"><td id="tdTotalCostDiff" runat="server" align="center" style="background-color: #E7E7E7;"><asp:Label ID="lblTotalCostDiff" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                            </table>
                          </FooterTemplate>
                        </asp:TemplateField>
                      </Columns>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvBudgetSummary2" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false"  HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" style=" table-layout:fixed; padding:0px; margin:0px;" 
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvBudgetSummary4" runat="server" AutoGenerateColumns="false" 
                          Width="100%" ShowFooter="true" FooterStyle-Height="35px" 
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false" RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" 
                          CellPadding="0" CellSpacing="0"
      ...
      <td style="height:20px;">
       ...
       <th>
          ...
          <asp:GridView ID="gvMMRFactory" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="SalesHeader"
            RowStyle-CssClass="RangeStyle" Width="1500PX" ShowHeader="false" 
                RowStyle-Height="38px" onrowdatabound="gvMMRFactory_RowDataBound" style="table-layout:fixed;">
            <Columns>
      ...
      <tr>
        <td>
              ...
              <table border="0" cellpadding="0" cellspacing="0" width="1500px" align="left" style="margin-left:0px; margin-top:-1px; table-layout:fixed;" bgcolor="#ffffff">
                <tr>
                  <td valign="top" style="width: 150px;">
                    <asp:GridView ID="gvMMRSummaryStaff" runat="server" AutoGenerateColumns="false" 
                      ...
                      <Columns>                    
                           <asp:BoundField DataField="StaffDept" HeaderText="" ItemStyle-Width="150px" ItemStyle-CssClass="op-type"   />
                      </Columns>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvMMRSummary1" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" RowStyle-CssClass="disp_non" RowStyle-Height="0px" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
      ...
      <tr>
       ...
       <th>
          ...
          <asp:GridView ID="gvAvailMin" runat="server" AutoGenerateColumns="false" HeaderStyle-CssClass="SalesHeader"
            RowStyle-CssClass="RangeStyle" Width="100%" ShowHeader="false" RowStyle-Height="35px" OnRowDataBound="gvAvailMin_rowDataBound">
            <Columns>
              <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="310px" HeaderStyle-HorizontalAlign="Center">
                <ItemTemplate>
                  <asp:Label ID="lblHeader" runat="server" Font-Size="12px" Text=''></asp:Label>
            ...
            <ContentTemplate>--%>
              <table border="0" cellpadding="0" cellspacing="0" width="1500px" align="left" style="margin-left:0px; margin-top:-1px;" bgcolor="#ffffff">
                <tr>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvFactoryDetails1" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" FooterStyle-Height="32px"
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      ...
                      <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>
                            ...
                            <asp:Label ID="lblManPowerBudget" ToolTip="Manpower budget" runat="server" Font-Size="12px" Text='<%#Eval("ManPowerBudget") %>'></asp:Label>
                                                
                          </ItemTemplate>
                          <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px; border-bottom:1px solid gray; border-spacing:0;"><asp:Label ID="lblTotalManPowerBudget" runat="server" Font-Size="12px" Font-Bold="true" /></td></tr>
                              
                              <tr><td align="center" style="height:33px;"><asp:Label ID="lblTotalMonthlyBudgetCount" runat="server" Font-Size="12px" Font-Bold="true" Text="" /></td></tr>
                              
                            </table>
                          </FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-VerticalAlign="Middle" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          <HeaderTemplate>Actual</HeaderTemplate>
                          <HeaderStyle CssClass="bot-header" />
                          <ItemTemplate>
                          <div id="dvManPowerActual"  runat="server" class="differe-act">
                            <asp:Label ID="lblManPowerActual" runat="server" Font-Size="12px" Text='<%#Eval("ManPowerActual") %>'></asp:Label>
                             </div>                            
                          </ItemTemplate>
                          ...
                          <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td id="tdTotalManPowerActual" runat="server" align="center" style="height:33px; border-bottom:1px solid gray; border-spacing:0;"><asp:Label ID="lblTotalManPowerActual" runat="server" Font-Size="12px" Font-Bold="true" Text="0" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <HeaderStyle CssClass="bot-header" />
                          <ItemTemplate>
                         <div id="dvCostActual" class="differe-act" runat="server">
                            <asp:Label ID="lblCostActual" runat="server" Font-Size="12px" Text='<%#Eval("CostActual") %>'></asp:Label>
                            <asp:HiddenField ID="hdnOldBudCost" runat="server" />
                            </div>
                          </ItemTemplate>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvFactoryDetails2" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" FooterStyle-Height="34px" 
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" OnRowDataBound="gvFactoryDetails2_RowDataBound"  OnRowCreated="gvFactoryDetails2_RowCreated" style="table-layout:fixed">
                      <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          <HeaderTemplate>Budget</HeaderTemplate>
                          <HeaderStyle CssClass="bot-header" />
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <HeaderStyle CssClass="bot-header" />
                          <ItemTemplate>
                             <div id="dvManPowerActual" class="differe-act" runat="server">
                            <asp:Label ID="lblManPowerActual" runat="server" Font-Size="12px" Text='<%#Eval("ManPowerActual") %>'></asp:Label>
                             </div> 
                            ...
                            <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td id="tdTotalManPowerActual" runat="server" align="center" style="height:33px;"><asp:Label ID="lblTotalManPowerActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvFactoryDetails3" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" FooterStyle-Height="32px" 
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" OnRowDataBound="gvFactoryDetails3_RowDataBound"  OnRowCreated="gvFactoryDetails3_RowCreated" style="table-layout:fixed">
                      <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          <HeaderTemplate>Budget</HeaderTemplate>
                          <HeaderStyle CssClass="bot-header" />
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td id="tdTotalManPowerActual" runat="server" align="center" style="height:33px; border-bottom:1px solid #666;"><asp:Label ID="lblTotalManPowerActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>                           
                           ...
                           <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td id="tdTotalCostActual" runat="server" align="center" style="height:33px; border-bottom:1px solid #666;"><asp:Label ID="lblTotalCostActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvFactoryDetails4" runat="server" AutoGenerateColumns="false" Width="100%" ShowFooter="true" FooterStyle-Height="32px" FooterStyle-ForeColor="#7E7E7E"
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" HeaderStyle-Font-Bold="false"  HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" OnRowDataBound="gvFactoryDetails4_RowDataBound" OnRowCreated="gvFactoryDetails4_RowCreated" style="table-layout:fixed">
                      <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          <HeaderTemplate>Budget</HeaderTemplate>
                          <HeaderStyle CssClass="bot-header" />
                          ...
                          <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px; border-bottom:1px solid gray;"><asp:Label ID="lblTotalManPowerBudget" runat="server" Font-Size="13px" Font-Bold="true" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>
                            ...
                            <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" id="tdTotalManPowerActual" runat="server" style="height:33px; border-bottom:1px solid gray;"><asp:Label ID="lblTotalManPowerActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                            
                              <tr><td align="center" id="tdMonthlyTotalActual" runat="server" style="height:33px;"><asp:Label ID="lblMonthlyTotalActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>
                           ...
                           <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px; border-bottom:1px solid gray;"><asp:Label ID="lblTotalCostBudget" runat="server" Font-Size="13px" Font-Bold="true" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td id="tdTotalCostActual" runat="server" align="center" style="height:33px; border-bottom:1px solid gray;"><asp:Label ID="lblTotalCostActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                ...
                <tr>
                  <td valign="top" style="width: 180px;">
                    <asp:GridView ID="gvStaffDept" runat="server" AutoGenerateColumns="false" 
                          Width="100%" ShowHeader="false" RowStyle-Height="35px" 
                          RowStyle-ForeColor="#7E7E7E" ondatabound="gvStaffDept_DataBound">
                      <Columns>                    
                           <asp:BoundField DataField="StaffDept" HeaderText="" ItemStyle-Width="180px" ItemStyle-CssClass="op-type" />
                      </Columns>
                    </asp:GridView>
                  </td>              
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvCMTFactory1" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" 
                          FooterStyle-BackColor="LightGray" onrowcreated="gvCMTFactory1_RowCreated" 
                      ...
                      <Columns>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                         ...
                         <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px;"><asp:Label ID="lblOverHeadBudget" runat="server" Font-Size="13px" Font-Bold="true" /></td></tr>
                              <tr><td style="height:1px; background-color:#7E7E7E;"></td></tr>
                              <tr><td align="center" style="height:33px; background-color: #E7E7E7;"><asp:Label ID="lblCMTTotalBudget" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                        ...
                        <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px;"><asp:Label ID="lblOverHeadActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                              <tr><td style="height:1px; background-color:#7E7E7E;"></td></tr>
                              <tr><td align="center" style="height:33px; background-color: #E7E7E7;"><asp:Label ID="lblCMTTotalActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                            </table>
                          </FooterTemplate>
                        </asp:TemplateField>
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>
                           ...
                           <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px;"><asp:Label ID="lblTotalCostBudget" runat="server" Font-Size="13px" Font-Bold="true" /></td></tr>
                              <tr><td style="height:1px; background-color:#7E7E7E;"></td></tr>
                              <tr><td align="center" style="height:33px; background-color: #E7E7E7;"><asp:Label ID="lblCMTTotalCostBudget" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                        ...
                        <asp:TemplateField ItemStyle-HorizontalAlign="Center" ItemStyle-Width="62px" HeaderStyle-HorizontalAlign="Center" FooterStyle-HorizontalAlign="Center">
                          ...
                          <ItemTemplate>
                           ...
                           <FooterTemplate>
                            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                              <tr><td align="center" style="height:33px;"><asp:Label ID="lblTotalCostActual" runat="server" Font-Size="13px" Font-Bold="true" Text="" /></td></tr>
                              <tr><td style="height:1px; background-color:#7E7E7E;"></td></tr>
                              <tr><td align="center" style="height:33px; background-color: #E7E7E7;">
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvCMTFactory2" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E"  
                          FooterStyle-BackColor="LightGray" onrowcreated="gvCMTFactory2_RowCreated" 
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvCMTFactory3" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E"  
                          FooterStyle-BackColor="LightGray" onrowcreated="gvCMTFactory3_RowCreated" 
                  ...
                  <td valign="top" style="width: 310px;">
                    <asp:GridView ID="gvCMTFactory4" runat="server" AutoGenerateColumns="false" 
                      ...
                      ShowHeader="true" HeaderStyle-Height="35px" HeaderStyle-Font-Size="11px" 
                          HeaderStyle-Font-Bold="false" HeaderStyle-CssClass="top-header"
                      RowStyle-Height="35px" RowStyle-ForeColor="#7E7E7E" 
                          FooterStyle-BackColor="LightGray" onrowcreated="gvCMTFactory4_RowCreated" 
      ...
      <tr><td style="display:none;">
          <asp:Button ID="btnPrint" runat="server" Text="Print This" 
              onclick="btnPrint_Click" /></td></tr>
