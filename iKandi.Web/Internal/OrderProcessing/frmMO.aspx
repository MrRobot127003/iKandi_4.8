...
<%@ Page Language="C#" AutoEventWireup="true" MasterPageFile="~/layout/Secure.Master" CodeBehind="frmMO.aspx.cs" Inherits="iKandi.Web.frmMO" EnableEventValidation="false" %>

<%@ Register Assembly="AjaxControlToolkit" Namespace="AjaxControlToolkit" TagPrefix="cc1" %>

<%--<%@ Register Src="~/UserControls/Lists/frmMO_BasicSection.ascx" TagName="ManageOrderBasicInfo" TagPrefix="uc1" %>--%>
<%@ Register Src="~/UserControls/Forms/frmMO_BasicSection_new.ascx" TagName="ManageOrderBasicInfo" TagPrefix="uc1" %>
...
<asp:Content ID="Content1" ContentPlaceHolderID="cph_main_content" runat="server">
    <style type="text/css">
        ...
        .datepicker2 { z-index:999999 !important;}
    ...
    <link href="../../App_Themes/ikandi/_ui-lightness/jquery-ui-1.8.6.custom.css" type="text/css" rel="stylesheet" />
    <script type="text/javascript">
        ...
        $(function () {
            ...
            //            $(".th").addClass("datepicker2");
            //            $(".th1").addClass("datepicker2");
            //            $(".th2").addClass("datepicker2");
        });
    </script>
    <script type="text/javascript">
        ...
        $(function () {            
            $("input[type=text].MOFabric").autocomplete("/Webservices/iKandiService.asmx/SuggestFabricNameByName", { dataType: "xml", datakey: "string", max: 10, "width": "220px" });
            $("input[type=text].MOFabric", "#main_content").result(function () { if ($(this).val().length === 1) { $(this).val(''); } });
        });
    ...
    <style type="text/css">
        ...
        .main_bottomheader_wrapper
       {    padding: 5px;
            border-bottom: 1px solid lightgray;
        }
         .main_bottomheader_wrapper #search
        {
            margin: 7px 0 0;
        }
   .divClientSummaryLink table
        {
            width:85%;
            }
.inputbox_bordercolor:focus {
        border-color: #0BCD60!important;
  ...
  @media screen and (max-width:1600px){
    ...
    <div class="main_bottomheader_wrapper">

    <div id="divClientSummaryLink" runat="server" visible="true" class="divClientSummaryLink">

        <table border="0" cellpadding="0" cellspacing="0" style="font-size: 11px ! important; padding-bottom: 0px; color: gray;">
            <tr>
           <td style="border: none !important; width: 55px;">
                <input type="hidden" runat="server" class="do-not-disable" id="hdntabvalue" />
                <asp:Label ID="lablsearch" Text="Search" runat="server" style="background-color: white;height:10px;line-height:11px;"></asp:Label>
            </td>
            
                <td style="border: none !important;width: 100px;">
                    <input type="text" id="txtsearch" style="width: 100px ! important; color: #000; padding: 0px 2px;" class="costing-MO do-not-disable" runat="server" maxlength="60" />
                </td>
               <td style="border: none !important; width: 35px;">
                    <asp:Label ID="lblMateial" Text="Fabric" runat="server" style="background-color: white;height:10px;line-height:11px;"></asp:Label>
                </td>
                <td style="border: none !important;width: 130px;">
                   
                    <input type="text" id="txtFabric" style="width: 150px ! important; color: #000; padding: 0px 2px;" class="costing-MO MOFabric do-not-disable" runat="server" maxlength="60" />
                </td>
                <td style="border: none !important; width: 95px;">
                    <asp:DropDownList ID="ddlDateType" runat="server" CssClass="do-not-disable mo_dropdown_style1" onchange="javascript:BindddlBuyingHouse('');" Style="width: 90px!important">
                ...
                <td style="border: none !important; width: 80px;">
                    <asp:DropDownList ID="ddlYear" runat="server" CssClass="do-not-disable mo_dropdown_style1" Style="width: 70px!important" onchange="javascript:BindddlBuyingHouse('');">
                    </asp:DropDownList>
                </td>
                <td style="border: none !important; width: 30px;">
                ...
                <td style="border: none !important; width: 70px;">
                    <input type="text" id="txtfrom" onchange="showDatecancelbutton('txtfrom');return false" style="width: 90px ! important;font-size:10px;" class="th" runat="server" readonly="readonly" />
                </td>
                ...
                <td style="border: none !important; width: 70px;">
                    <input type="text" id="txtTo" onchange="showDatecancelbutton('txtTo');return false" style="width: 90px ! important;font-size:10px;" class="th" runat="server" readonly="readonly" />
                </td>
                <td style="border: none !important; width: 30px;">
                    <input type="image" id="imgto" src="../../App_Themes/ikandi/images1/delete1.png" title="clear to Date" onclick="removetext('txtTo');return false" />
                </td>
                ...
                <td style="width: 100px">
                    AM &nbsp;
                    <asp:DropDownList ID="Ddlam" runat="server" onchange="javascript:BindAccountManagerBind('');" CssClass="do-not-disable mo_dropdown_style1" Style="width: 70px !important;" Height="18px" Font-Size="11px">
                    </asp:DropDownList>
                </td>
                <td align="left" style="text-transform: none; color: #000 !important; padding-left: 5px; width: 100px;" class="radio-but">
                ...
                <td align="left" style="text-transform: none; color: #000 !important; padding-left: 5px; width: 100px; color: gray;">
                    &nbsp;<div style="color: Gray; float: left; width: auto; margin-top: 3px;line-height:10px;">
                        Unshipped
                    </div>
    ...
    <div id="search">
        ...
        <table border="0" cellpadding="0" cellspacing="0" class='<%=(hdnSelectFilter.Value == "1") ? "hide_me " : ""%>' width="100%">
            <tr>
                <td align="left" colspan="2" style='padding-right: 10px; border: none !important;'>
                    <table  cellspacing="0" style="font-size: 11px ! important; padding-bottom: 0px; color: gray;">
                        <tr>
                            <td style="border: none !important; width:70px;">
                                <asp:Label ID="Label1" runat="server" Text="Order Type"></asp:Label>
                            </td>
                            <td style="border: none !important; width: 130px;">
                                <asp:DropDownList ID="ddlordertype" runat="server" CssClass="do-not-disable mo_dropdown_style1" Style="width: 100px!important;">
                                    <asp:ListItem Text="ALL" Value="-1" Selected="True"></asp:ListItem>
                                    <asp:ListItem Text="BIPL" Value="1"></asp:ListItem>
                                    <asp:ListItem Text="Kasuka" Value="3"></asp:ListItem>
                                    <asp:ListItem Text="Value Added Style" Value="4"></asp:ListItem>
                                    <asp:ListItem Text="Gratitude exports" Value="5"></asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <td style="border: none !important; width: 110px;">
                                <asp:DropDownList ID="ddlBH" runat="server" CssClass="do-not-disable mo_dropdown_style1" onchange="javascript:BindClient('');" Style="width: 100px!important">
                                </asp:DropDownList>
                            </td>
                            ...
                            <td style="border: none !important; width: 130px;">
                                <asp:DropDownList ID="ddlClients" runat="server" onchange="javascript:BindParentDepartmentDDl('');" CssClass="do-not-disable mo_dropdown_style1" Style="width: 110px!important">
                                </asp:DropDownList>
                            ...
                            <td style="border: none !important; width: 80px;">
                                <asp:DropDownList ID="ddlParentDeptID" runat="server" Style="width: 65px!important" onchange="javascript:functionNotRestForParent(this);" CssClass="do-not-disable mo_dropdown_style1">
                            ...
                            <td style="border: none !important; width: 90px;">
                                <asp:DropDownList ID="ddlDepartment" runat="server" Style="width: 85px!important" onchange="javascript:functionNotRest(this);" CssClass="do-not-disable mo_dropdown_style1">
                                    <asp:ListItem Value="-1">All</asp:ListItem>
                                </asp:DropDownList>
                            ...
                            <td style="border: none !important; width: 150px;">
                                <asp:DropDownList ID="ddlStatusMode" runat="server" CssClass="do-not-disable mo_dropdown_style2" Style="width: 140px;height:18px;">
                            ...
                            <td style="border: none !important; width: 150px;">
                                <asp:DropDownList ID="ddlStatusModeSequence" runat="server" CssClass="do-not-disable mo_dropdown_style2" Width="140px" Height="18px">
                                </asp:DropDownList>
                            </td>
                            <td style="border: none !important; width: 30px;">
                            ...
                            <td style="border: none !important; width: 110px;">
                                <asp:DropDownList ID="ddlUnit" runat="server" CssClass="do-not-disable mo_dropdown_style1" Style="width: 100px;">
                                </asp:DropDownList>
                            </td>
                            <td style="border: none !important; width: 140px;">
                                Alloc.
                                <asp:DropDownList ID="ddlOutHouse" runat="server" CssClass="do-not-disable mo_dropdown_style1" Style="width: 55px !important;">
                            ...
                            <td style="border: 0px !important;">
                                <asp:Button ID="btn_search" OnClientClick="javascript:return setvalue();" OnClick="btn_search_Click" runat="server" BorderWidth="0" CssClass="go" Text="Search" />
        ...
        <div style="display: none;">
            <ul class="ui-tabs-nav ui-helper-reset ui-helper-clearfix ui-widget-header ui-corner-all">
                <li id="tabMerch" class="tab ui-corner-top ui-state-default" runat="server">
                    <asp:LinkButton ID="lnkBtnTab" runat="server" OnCommand="lnkBtnTab_Click" CommandName="Tab1" Text="Merchandising" CssClass="do-not-disable"></asp:LinkButton></li>
            </ul>
        </div>
        <div id="tabs-1" class="ui-corner-bottom" style="min-width:1400px;">
            ...
            <asp:Button CssClass="submit" ID="btn_Submit" runat="server" OnClick="btn_Submit_Click" Visible="false" OnClientClick="return submitForm()" />
        </div>
    </div>
    <div id="links" class="hide_me">
        <div class="form_box item_list">
            <div class="form_heading">
                Links</div>
            <br />
            <a href="/Internal/Sales/Order.aspx" target="OrderForm" title="CLICK TO VIEW ORDER FORM" class="hyp">Order Form</a><br />
            <a href="/Internal/Sales/OrderLimitations.aspx" title="CLICK TO VIEW ORDER LIMITATION FORM" target="OrderLimitationsForm" class="hyp">Order Limitations Form</a><br />
            <a href="/Internal/Fabric/FabricWorkingSheet.aspx" target="FabricWorkingSheetForm" title="CLICK TO VIEW FABRIC WORKING SHEET " class="hyp">Fabric Order Form</a><br />
            <a href="/Internal/Fabric/FabricAccessoriesWorkSheet.aspx" target="FabricAccessoriesWorkSheetForm" title="CLICK TO VIEW FABRIC ACCESSORIES WORKING SHEET" class="hyp">Accessory Order Form </a>
            <br />
            <a href="/Internal/Fabric/CuttingSheet.aspx" title="CLICK TO VIEW CUTTING SHEET" target="CuttingSheetForm" class="hyp">Cutting Order Form</a><br />
            <a href="javascript:void(0)" class="clientView" onclick="closeQuickLayer();showClientDetailsPopup('#CLIENTID#');return false" title="CLICK TO VIEW CLIENT DETAIL" target="ClientView" class="hyp">Client Details</a><br />
            <br />
        </div>
    </div>
    <div class="middle" id="quickviewContent" style="display: none;">
        <div class="form_box item_list">
            <div class="form_heading">
                Links</div>
            <br />
            <a href="/Internal/Merchandising/QualityControl.aspx" target="QAForm" title="CLICK TO VIEW QUALITY ASSURANCE FORM" class="hyp">Quality Assurance Form</a><br />
            <a href="/Internal/Sales/OrderLimitations.aspx" title="CLICK TO VIEW ORDER LIMITATION FORM" target="OrderLimitationsForm" class="hyp">Order Limitations Form</a><br />
            <br />
        </div>
    </div>
    <%-------------------------13/11/2015 Edited by Prabhaker-------------------------%>
    <div style="width: 100%;box-shadow: rgb(43 83 135 / 8%) 0px 5px 8px 0px;">
        <div style="float: left; width: 7%;margin-bottom:5px;">
            <input type="button" id="Button1" class="print da_submit_button" value="Print" onclick="return PrintManageOrderPDF();" / style="color:White!important;">
        </div>
        <div style="float: left; width: 70%;">
            <table cellspacing="2" style="font-size: 9px ! important; color: Gray;" class='<%=(hdnSelectFilter.Value == "1") ? "hide_me " : "hide_me"%>'>
                ...
                <tr>
                    ...
                    <td style="border: none !important;">
                        <asp:Label Visible="true" ID="lblSortedBy" runat="server" CssClass="do-not-disable" Text="Sorted By"></asp:Label>
                    </td>
                    <td style="border: none !important;">
                        <asp:DropDownList ID="ddlOrder1" runat="server" CssClass="do-not-disable mo_dropdown_style1" Visible="true">
                    ...
                    <td style="border: none !important;">
                        <asp:DropDownList runat="server" ID="ddlOrder2" CssClass="do-not-disable mo_dropdown_style1" Visible="true">
                    ...
                    <td style="border: none !important;">
                        <asp:DropDownList runat="server" ID="ddlOrder3" CssClass="do-not-disable mo_dropdown_style1" Visible="true">
                            <asp:ListItem Text="Select ....." Value="-1"></asp:ListItem>
                            <asp:ListItem Value="1">Buyer</asp:ListItem>
                            <asp:ListItem Value="2">Style Number</asp:ListItem>
                            <asp:ListItem Value="3">Dept.</asp:ListItem>
                    ...
                    <td style="border: none !important;">
                        <asp:DropDownList runat="server" ID="ddlOrder4" CssClass="do-not-disable mo_dropdown_style1" Visible="true">
                            <asp:ListItem Text="Select ....." Value="-1"></asp:ListItem>
                            <asp:ListItem Value="1">Buyer</asp:ListItem>
                            <asp:ListItem Value="2">Style Number</asp:ListItem>
                            <asp:ListItem Value="3">Dept.</asp:ListItem>
                    ...
                    <td style="border: 0px;">
                        <asp:Button ID="btn_Bottom_search" OnClientClick="javascript:return setvalue();" OnClick="btn_search_Click" runat="server" Text="Search" BorderWidth="0" CssClass="go" />
                    </td>
                </tr>
            </table>
        </div>
