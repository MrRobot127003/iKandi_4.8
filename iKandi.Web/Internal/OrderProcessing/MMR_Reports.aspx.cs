...
{
    public partial class MMR_Reports : System.Web.UI.Page
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                WorkingHrs = objBuyingHouseController.GetMMR_WorkingHours_BAL(dtStartDate, DateTime.MinValue);
                ...
                FillBudgetSummaryStaffDept("", dtStartDate, sFinancialYear);

                FillBudgetSummary("C 47", dtStartDate, sFinancialYear);
                FillBudgetSummary("C 45-46", dtStartDate, sFinancialYear);
                FillBudgetSummary("B 45", dtStartDate, sFinancialYear);                
                FillBudgetSummary("BIPL", dtStartDate, sFinancialYear);

                FillUnitName();
                FillWorkerType("", dtStartDate, sFinancialYear);               

                FillFactoryDetails("C 47", dtStartDate, sFinancialYear);
                FillFactoryDetails("C 45-46", dtStartDate, sFinancialYear);
                FillFactoryDetails("B 45", dtStartDate, sFinancialYear);                
                FillFactoryDetails("BIPL", dtStartDate, sFinancialYear);

                // Fill CMT Data FillCMTReports 

                FillCMTUnitName();
                FillStaffDept("", dtStartDate, sFinancialYear);

                FillCMTReports("C 47", dtStartDate, sFinancialYear);
                FillCMTReports("C 45-46", dtStartDate, sFinancialYear);
                FillCMTReports("B 45", dtStartDate, sFinancialYear);                
                FillCMTReports("BIPL", dtStartDate, sFinancialYear);

                // Fill MMR Summary

                FillMMRFactoryUnitName();
                FillMMRSummaryStaff("", dtStartDate, sFinancialYear);

                FillMMRSummary("C 47", dtStartDate, sFinancialYear);
                FillMMRSummary("C 45-46", dtStartDate, sFinancialYear);
                FillMMRSummary("B 45", dtStartDate, sFinancialYear);                
                FillMMRSummary("BIPL", dtStartDate, sFinancialYear);
        ...
        protected void btnCreate_Click(object sender, EventArgs e)
        {
            ...
            if (txtDate.Text != "")
            {
                dtStartDate = DateTime.ParseExact(txtDate.Text, "dd MMM yy (ddd)", System.Globalization.CultureInfo.InvariantCulture).Date;
                //if (dtStartDate > DateTime.Now.Date)
                //{
                //    dtStartDate = DateTime.MinValue;
                //    Page.ClientScript.RegisterStartupScript(this.GetType(), "ShowMessage", "alert('Date should not be greater than today');", true);  
                //    lblDate.Text = "";
                //    return;
                //}
        ...
        {
            DataTable dtStaffDept = objBuyingHouseController.GetMMR_BudgetSummary_Daily_BAL(sUnitName, dtDate, sFinancialYear);
        ...
        private void FillBudgetSummary(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            if (sUnitName == "C 47")
            {
                DataTable dtFactoryDetails = objBuyingHouseController.GetMMR_BudgetSummary_Daily_BAL(sUnitName, dtDate, sFinancialYear);
        ...
        private void FillWorkerType(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            DataTable dtWorkerType = objBuyingHouseController.GetDaily_MMR_Report_BAL(sUnitName, dtDate, DateTime.MinValue, sFinancialYear);
        ...
        private void FillFactoryDetails(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            if (sUnitName == "C 47")
            {
                DataTable dtFactoryDetails = objBuyingHouseController.GetDaily_MMR_Report_BAL(sUnitName, dtDate, DateTime.MinValue, sFinancialYear);
        ...
        protected void gvFactoryDetails1_RowDataBound(Object sender, GridViewRowEventArgs e)
        {
            ...
            {                
                ...
                if (WorkingDays != "")
                {
                    ...
                    {
                        lblMonthlyTotalActual.Text = Math.Round(Convert.ToDouble(TotalManPowerActual) * Convert.ToDouble(WorkingDays), 0) == 0 ? "" : Math.Round(Convert.ToDouble(TotalManPowerActual) * Convert.ToDouble(WorkingDays), 0).ToString("#,##0");
                    }
                    if (TotalCostBudget > 0)
                    {
                        lblTotalMonthlyCostBudget.Text = Math.Round((Convert.ToDouble(TotalCostBudget) * Convert.ToDouble(WorkingDays)) / 100000, 1) == 0 ? "" : "₹ " + Math.Round((Convert.ToDouble(TotalCostBudget) * Convert.ToDouble(WorkingDays)) / 100000, 1).ToString("#,##0") + " L"; 
                    }
                    if (TotalCostActual > 0)
                    {
                        lblTotalMonthlyCostActual.Text = Math.Round((Convert.ToDouble(TotalCostActual) * Convert.ToDouble(WorkingDays)) / 100000, 1) == 0 ? "" : "₹ " + Math.Round((Convert.ToDouble(TotalCostActual) * Convert.ToDouble(WorkingDays)) / 100000, 1).ToString("#,##0") + " L";
                    }
                }
        ...
        private void FillStaffDept(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            DataTable dtStaffDept = objBuyingHouseController.GetMMR_CMT_Report_Daily_BAL(sUnitName, dtDate, sFinancialYear);
            gvStaffDept.DataSource = dtStaffDept;
            gvStaffDept.DataBind();
        }

        private void FillCMTReports(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            if (sUnitName == "C 47")
            {
                DataTable dtFactoryDetails = objBuyingHouseController.GetMMR_CMT_Report_Daily_BAL(sUnitName, dtDate, sFinancialYear);
        ...
        {
            DataTable dtStaffDept = objBuyingHouseController.GetMMR_Summary_Daily_BAL(sUnitName, dtDate, sFinancialYear);
        ...
        private void FillMMRSummary(string sUnitName, DateTime dtDate, string sFinancialYear)
        {
            if (sUnitName == "C 47")
            {
                DataTable dtMMRSummary = objBuyingHouseController.GetMMR_Summary_Daily_BAL(sUnitName, dtDate, sFinancialYear);
        ...
        //        if (BudgetwithMachine1 > 0)
        //        {
        //            //lblProMachineBudget.Text = "₹ " + Math.Round(Convert.ToDouble(BudgetwithMachine1) / 100000, 1) + " L";
        ...
        //        if (ActualwithMachine1 > 0)
        //        {
        //            //lblProMachineActual.Text = "₹ " + Math.Round(Convert.ToDouble(ActualwithMachine1) / 100000, 1) + " L";
        ...
        {
            NotificationController  objNotificationController = new NotificationController();
            bool bPrint = objNotificationController.SendEmailForMMR_Report(true);
        }
