...
{
    public partial class CostingSheetNew : BasePage
    {
        #region Properties
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!string.IsNullOrEmpty(StyleNumber))
            {
                ...
                CostingCollection objCostingCollection = service.GetCostingByStyleNumber_New(StyleNumber, 1, SingleVersion);
