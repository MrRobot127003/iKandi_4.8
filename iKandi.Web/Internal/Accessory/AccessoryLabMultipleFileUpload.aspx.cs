...
{
    public partial class AccessoryLabMultipleFileUpload : System.Web.UI.Page
    {
        ...
        AccessoryWorkingController objAccessoryWorkingcontroller = new AccessoryWorkingController();
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (!IsPostBack)
            {
                ...
                DS = SaveFourPointCheckLabFileForAccessory(Type, SrvID, "",'S');
                dtFiles = DS.Tables[0];
        ...
        protected void btnSvaeFile_Click(object sender, EventArgs e)
        {
            ...
            foreach (RepeaterItem rptItem in rptFile1.Items)
            {
                ...
                SaveFourPointCheckLabFileForAccessory(Type, SrvID, hdnWholeFile.Value, 'U');
                count += 1;
        ...
        public DataSet SaveFourPointCheckLabFileForAccessory(int type, int SrvID, string FileName, char Action)
        {
            return this.objAccessoryWorkingcontroller.FourPointCheckLabFileForAccessory(type, SrvID, Action, FileName);
        }
    }
