<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="FileUploadTest.aspx.cs" Inherits="iKandi.Web.Internal.Fabric.FileUploadTest" %>
         ...
         Upload File
                            ...
                            <asp:Repeater ID="rptFile1" runat="server">
                                ...
                                <ItemTemplate>
                                   <%--<div class="img-fll">
                                       ...
                                       <div class="img-fll">
                                         <asp:HyperLink ID="imgfile" Target="_blank"   runat="server" ImageUrl='<%# ResolveUrl("~/uploads/Quality/" + (Eval("InternalLabReports"))) %>'  Width="50px" CssClass="imgupload preview"  NavigateUrl='<%# ResolveUrl("~/uploads/Quality/" + (Eval("InternalLabReports"))) %>'>
                                         </asp:HyperLink>
                                         ...
                                         <asp:HiddenField ID="hdnFilePath" Value='<%#DataBinder.Eval(Container.DataItem, "InternalLabReports")%>' runat="server" />
                                       </div>
                                </ItemTemplate>
                                <FooterTemplate>
            ...
            <tr>
                <td colspan="3" align="center">
                    <asp:Button ID="btnSvaeFile" runat="server" Text="Submit" CssClass="submit" 
                        onclick="btnSvaeFile_Click" />
