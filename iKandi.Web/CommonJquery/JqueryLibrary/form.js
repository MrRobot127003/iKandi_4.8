/// <reference path="../../js/service.min.js" />


 //include('../../js/service.min.js');
...
function BindControls() {
    ...
    $('input.date-picker', '#main_content').datepicker({ changeYear: true, yearRange: '1900:2020', dateFormat: 'dd M y (D)', buttonImage: '~/Images/calendar.gif' }).focus(function () { this.blur(); return false; });

//    $("'input.th', '#main_content'").datepicker({ dateFormat: 'dd M y (D)' });
    ...
    //added by shubhendu 
    $('input.numeric-field-with-decimal-places').keyup(function (e) {
        CancelShiftOperation(e);
    });
    ...
    $('input.numeric-field-with-one-decimal-places', '#main_content').keydown(function (e) {
        e = e || window.event;
        return ValidateNumericFields(e.keyCode, $(this), true, 1);
    });
    ...
    //added by shubhendu for validation for BiPL & IkandiPrice
    $('input.numeric-field-with-two-decimal-places').keydown(function (e) {
        e = e || window.event;
        return ValidateNumericFields(e.keyCode, $(this), true, 2);
    });
    ...
    if (isShow) {
        ...
        switch (messageType) {
            ...
            case 'message':
                ...
                $('.validation_messagebox img.image-message').attr('src', '/Images/ikandi/images/images/info.png');
                break;
            case 'confirmation':
...
function DisableAllFields(containerID) {
    ...
    */
    // hide the button too
    $(".savefb", '#main_content').hide();
    $(".submitfb", '#main_content').hide();
    $(".printfb",'#main_content').hide();
