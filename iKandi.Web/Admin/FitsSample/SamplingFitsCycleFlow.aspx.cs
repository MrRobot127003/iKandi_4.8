...
{
    public partial class SamplingFitsCycleFlow : BasePage
    {
        ...
        private void GetSamplingFitsCycleFlow()
        {
            ...
            if (StyleId > 0)
            {
                ...
                List<SamplePattern> objSamplePattern = FITsControllerInstance.GetSamplingFitsCycleFlow(objSample, Convert.ToInt32(UserId), -1, -1, -1, -1);
                if (objSamplePattern.Count > 0)
                {
        ...
        protected void btnFitsReuse_Click(object sender, EventArgs e)
        {
            ...
            List<SamplePattern> objSamplePattern = FITsControllerInstance.GetSamplingFitsCycleFlow(objSample, Convert.ToInt32(UserId), CreateNew, NewRefrence, ReUse, ReUseStyleId);
            gvSamplingFitsCycleflow.DataSource = objSamplePattern;
            gvSamplingFitsCycleflow.DataBind();
            btnSubmit.Visible = true;
        ...
        protected void gvSamplingFitsCycleflow_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                else
                {
                    ...
                    lblFits.Text = FitsStatus == "" ? Status : FitsStatus;
        ...
        protected void btnSubmit_Click(object sender, EventArgs e)
        {
            ...
            foreach (GridViewRow gvr in gvSamplingFitsCycleflow.Rows)
            {
                ...
                string hdnChkSample = ((HiddenField)gvr.FindControl("hdnChkSample")).Value;
                DateTime hdnSampleCalenderDate;
                if (hdnChkSample == "")
                {
                    hdnSampleCalenderDate = DateTime.MinValue;
                }
                else
                {
                    hdnSampleCalenderDate = DateTime.ParseExact(hdnChkSample, "dd MMM yy", System.Globalization.CultureInfo.InvariantCulture);
                }
                ...
                objSample.Status = hdnStatus.Value;
                ...
                if (lblSampleActDate.Text == "")
                {
                    if (ChkSample.Enabled == true)
                        objSample.SampleSentActualDate = hdnSampleCalenderDate;
                    else
                ...
                if (IsBiplUser == true)
                {
                    ...
                    {
                        if ((IsBiplUser == true) && (objSample.IsIkandiClient == 0) && (FitsType == 0))
                        {
                            if (ChkIsQC.Enabled == true)
                            {
                                objSample.IsQCPresent = ChkIsQC.Checked;
                            ...
                            objSample.FitsSentFor = lblFits.Text == "" ? hdnStatus.Value : lblFits.Text;
                            objSample.FitsPlanningFor = ddlFits.SelectedItem.Text;
                            if (chkStcApproved.Checked == true)
                            {
                                objSample.StcApproved = chkStcApproved.Checked;
                            }
                        }
                        if ((IsBiplUser == true) && (objSample.IsIkandiClient == 0) && (FitsType == 1))
                        {
                            if (ChkIsQC.Enabled == true)
                            {
                                objSample.IsQCPresent = ChkIsQC.Checked;
                            ...
                            if (ChkRefSample.Checked == true)
                                objSample.ReqRefSample = true;
                        ...
                        if ((IsBiplUser == true) && (objSample.IsIkandiClient == 1))
                        {
                            if (ChkIsQC.Enabled == true)
                            {
                                objSample.IsQCPresent = ChkIsQC.Checked;
                            ...
                            objSample.FitsSentFor = lblFits.Text;
                            objSample.FitsPlanningFor = ddlFits.SelectedItem.Text;
                            if (chkStcApproved.Checked == true)
                            {
                                objSample.StcApproved = chkStcApproved.Checked;
                ...
                // Save data
                sSave = FITsControllerInstance.SaveSamplingFitsCycleFlow(objSample, Convert.ToInt32(UserId), IsBiplUser, IsIKandiUser, ReUse, ReUseStyleId);
                if (sSave != "")
                {
