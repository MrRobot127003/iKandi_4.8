...
{
    public partial class ValueAdditionWithHistory : System.Web.UI.Page
    {
        int OrderDetailId = 0;
        int UnitId = 0;
        ...
        private void FillValueAdditionDetails()
        {
            ...
            //oTemplateField.HeaderStyle.Width = 50;
        ...
        protected void gvValueAdditionHistory_DataBound(object sender, EventArgs e)
        {
            for (int i = gvValueAdditionHistory.Rows.Count - 1; i > 0; i--)
            {
                ...
                Label lblDate = (Label)row.Cells[2].FindControl("lblDate");
                Label lblPreviousDate = (Label)previousRow.Cells[2].FindControl("lblDate");
        ...
        protected void gvValueAdditionHistory_RowCreated(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                Cell.Text = "Status From - To";
                Cell.HorizontalAlign = HorizontalAlign.Center;
                Cell.Font.Bold = true;
                Cell.CssClass = "remove-head";
                // Cell.ColumnSpan = 1;
                //Cell.Height = 25;
                //Cell.Font.Size = 10;
