<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdatePredecessor.aspx.cs" Inherits="iKandi.Web.Admin.UpdatePredecessor" %>
...
<body bgcolor="#FFFFFF">
  ...
  <div>
    <table border="0" cellpadding="0" cellspacing="0" width="100%" align="center">
      <tr>
        <td align="center" style="background-color: #405D99; height:50px; color: #FFFFFF; font-size: 22px; font-family:Arial; font-weight:bold;">Update Predecessor</td>
      </tr>
      <tr>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            <tr>
              <td align="left" style="width:40%; padding-left:10px;">
                <asp:ListBox ID="lstPredecessor" runat="server" CssClass="txt" Font-Size="12px" Height="200px" Width="250px" SelectionMode="Multiple"></asp:ListBox>
              </td>
              ...
              <td align="right" style="width:40%; padding-right:10px;">
                <asp:ListBox ID="lstUpdatePredecessor" runat="server" CssClass="txt" Font-Size="12px" Height="200px" Width="250px" SelectionMode="Multiple"></asp:ListBox>
              </td>
            </tr>
          </table>
        </td>
