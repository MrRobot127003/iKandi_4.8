<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="UpdateDesignationSorting.aspx.cs" Inherits="iKandi.Web.Admin.UpdateDesignationSorting" %>
          ...
          <table border="0" cellpadding="0" cellspacing="0" width="100%">
            ...
            <tr>
              <td align="center" style="padding-top:25px; padding-bottom:5px; font-family:Arial;">
                <asp:GridView ID="gvManageDesignation" runat="server" AutoGenerateColumns="false" HeaderStyle-Height="25px" HeaderStyle-Font-Size="16px" HeaderStyle-Font-Bold="false"
                  ...
                  <Columns>             
                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                      <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" width="175px">
                          <tr><td align="center" style="padding-top:5px; padding-bottom:5px; background-color:#405D99; color:#FFFFFF;">Designation</td></tr>
                        </table>
                      </HeaderTemplate>
                      <ItemTemplate>
                        <asp:HiddenField ID="hdnDesignationId" runat="server" Value='<%#Eval("DesignationId") %>' />
                        <asp:Label ID="lblDesignationName" runat="server" Font-Size="12px" Text='<%#Eval("DesignationName") %>'></asp:Label>
                      </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField ItemStyle-HorizontalAlign="Left" HeaderStyle-HorizontalAlign="Center" HeaderStyle-VerticalAlign="Top">
                      <HeaderTemplate>
                        <table border="0" cellpadding="0" cellspacing="0" width="200px">
                          <tr><td align="center" style="padding-top:5px; padding-bottom:5px; background-color:#405D99; color:#FFFFFF;">Line Designation</td></tr>
                        </table>
                      </HeaderTemplate>
                      <ItemTemplate>
                        <asp:Label ID="lblLineDesignationName" runat="server" Font-Size="12px" Text='<%#Eval("LineDesignationName") %>'></asp:Label>
                      </ItemTemplate>
                    </asp:TemplateField>
            ...
            <tr>
              <td align="center">
                ...
                <asp:Button ID="btnClose" runat="server" Text="Cancel" CssClass="da_submit_button" Width="" OnClick="btnClose_Click" />
              </td>
            </tr>
          </table>
        </td>
