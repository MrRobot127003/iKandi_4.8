...
{
    public partial class frm_Reallocation_Outhouse : System.Web.UI.Page
    {
        ...
        {
            randorHourlyHtml();
            Application["Reallocation_Outhouse"] = WriteFile;
        ...
        public void randorHourlyHtml()
        {
            ...
            {
                quest = WebRequest.Create("http://localhost:3240/Reallocation_Outhouse.aspx");
            }
            else
            {
                quest = WebRequest.Create("http://192.168.0.4/Reallocation_Outhouse.aspx");
            }
            ...
            Reallocation_ReportHtml = "Reallocation_Outhouse_" + Day + Month + ".html";
