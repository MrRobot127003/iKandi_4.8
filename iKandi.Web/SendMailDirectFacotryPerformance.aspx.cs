...
{
    public partial class SendMailDirectFacotryPerformance : System.Web.UI.Page
    {
        string MailType = "Production Daily Mail";
        string Flag = string.Empty;
        protected void Page_Load(object sender, EventArgs e)
        {
          // string url = "http://192.168.0.4/FacotryPerformance.aspx";
             string url = "http://localhost:3220/FacotryPerformance.aspx";//:TODO chnage to live url 
