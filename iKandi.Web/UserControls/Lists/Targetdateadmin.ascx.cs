...
{
    public partial class Targetdateadmin : System.Web.UI.UserControl
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            if (!IsPostBack)
            {
                ...
                ds = controller.Gettargetdatesforadmin();
        ...
        {        
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if (Convert.ToInt16(hdnStatusId.Value) < 7)
                {
                    ...
                    ddlfrom.Items.RemoveAt(29); 
                    ddlfrom.Items.RemoveAt(28);
                    ddlfrom.Items.RemoveAt(27);
                }
