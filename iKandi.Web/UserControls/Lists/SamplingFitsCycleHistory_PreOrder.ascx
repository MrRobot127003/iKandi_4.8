<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="SamplingFitsCycleHistory_PreOrder.ascx.cs" Inherits="iKandi.Web.UserControls.Lists.SamplingFitsCycleHistory_PreOrder" %>
...
.fll{
float:left; width:59%;height:19px	
}
.flr{
	float:left; width:40%;
}
.flln{
	width:52%; float:left; text-align:left; height:19px; padding:0px 4px;
}
.fllr{
...
{background: #3a5795;
    ...
    .image_top
    {
     ...
     #facebox .popup td.body div.content
     {
...
<div>
<table class="fixed-header item_list bipl-sec" rules="all"  style="border-collapse:collapse; width:640px;border-bottom:1px solid #999" cellspacing="0" border="0">
  <tbody>
   <tr>
   <th scope="col" style="width:150px;">Client <br /> Department</th>
   ...
   <asp:Label runat="server" ID="lblPDHead" Text="PD. Merch"> </asp:Label> 
	  ...
	  <th scope="col" style="width:100px;">St. Number</th>
      <th scope="col" style="width:200px;">Fabric 1</th>
			  
			  <th scope="col" style="width:100px;">Color/Print</th>
      <th scope="col" style="width:30px;">Thumbnail</th>
	  
			<%--  <th scope="col" style="width:180px;"><span style="width:170px;"></span></th>--%>
			  <th scope="col" style="width:120px;display:none">Stc Target</th>
    </tr>
    <tr>
        <td valign="top">
      <div style="width:100%;border-bottom:1px solid #b7b4b4;" class="h19 gray">
    ...
    <td>  <asp:Label ID="lblFabric1" ForeColor="gray" runat="server" Text='<%# Eval("Fabric") %>'></asp:Label></td>
    <td> <asp:Label ID="lblColorPrint" runat="server" ForeColor="Gray" Text='<%# Eval("FabricDetails") %>'></asp:Label></td>
    ...
    <td style="display:none"> <asp:Label ID="lblSTCTargetDate" Font-Bold="true" ForeColor="Black" runat="server" Text=""></asp:Label>
                                </td>
    </tr>
        </tbody>
        </table>
     ...
     <asp:GridView runat="server" ID="gvSamplingFitsCycleHistory" RowStyle-ForeColor="Gray"
            CssClass="item_list" BorderWidth="0" AutoGenerateColumns="false" AllowPaging="true" PageSize="20"
            Width="640px" style="border:1px solid #999"
            onrowdatabound="gvSamplingFitsCycleHistory_RowDataBound">
            ...
            <columns> 
             <asp:TemplateField  HeaderStyle-Width="80px">
                      <HeaderTemplate>
                        ...
                        <ItemStyle VerticalAlign="Top" Width="140px" CssClass="mar-remove" />                       
                  </asp:TemplateField> 
                  <asp:TemplateField HeaderStyle-Width="100px" HeaderText="Is QC Present- QC Name" Visible="false">
                  <ItemTemplate>
                  <asp:CheckBox ID="ChkIsQC" runat="server" style="padding:0px; display:none; margin:0px;"></asp:CheckBox>  
                             <asp:HiddenField ID="hdnMasterQCId" Value='<%# Eval("QCMasterId") %>' runat="server"></asp:HiddenField>
                                <asp:Label ID="lblQC" runat="server" CssClass="" Text=""></asp:Label>
                 </ItemTemplate>
                  ...
                  <HeaderTemplate >
                  AM / PD Manager<br /> Prod. Merch. / PD
                 ...
                 <asp:TemplateField HeaderStyle-Width="100px" Visible="false">
                  ...
                  <HeaderTemplate>Handover Dt. <%--ETA --%>
                  <%--<br />  --%> <%--Act.--%>             
                  </HeaderTemplate>
                  <ItemTemplate>
                  <div class="F8 gray h19" style="width:100%;border-bottom:1px solid #b7b4b4; display:none;">
  <strong><asp:Label ID="lblHandoverEta" runat="server" Text="" Font-Bold="true"></asp:Label></strong>
  </div>
      ...
      <asp:HyperLink ID="hlkHandover" runat="server" Visible="false" Target="_blank" style="float:left; padding-right:5px; width:auto;"> <img src="../../images/view-icon.png" class="image_top" /> </asp:HyperLink>
    ...
    <%-- </div>--%>
                                   ...
                                   <td style="text-align:right">
                                     <%--  <div style="width: 20%; float: left; display: none;">--%>
                                      ...
                                      <%-- </div>--%>
                                       ...
                                       <a onclick="javascript:return CallCadRolePopup('<%# Eval("Status") %>');" class="coutns"
                                           href="#">Remake
                                           <%# Eval("RemakeCount") %>
                                       </a>
                                   </td>
                  ...
                  <HeaderTemplate>Sample Sent Dt. <%--ETA ,Stc Appr.,--%>, Sampling File <%--<br />--%>
                  <%--Act. , Stc Appr.--%>
                  ...
                  <ItemStyle VerticalAlign="Top" />
                   ...
                   <asp:TemplateField HeaderStyle-Width="105px" Visible="false">
                   <HeaderTemplate>
                   Ref Req., Sampling Comm. Upload, Dt. <%--ETA<br />
                      Act--%>
                   </HeaderTemplate>
                   <ItemTemplate>
                    <div class="h19">
                   ...
                   <ItemStyle VerticalAlign="Top" CssClass="cellback" />
                    ...
                    <asp:TemplateField ItemStyle-Width="90px" HeaderStyle-Width="90px" HeaderText="Fit Cycle time" Visible="false">
                    <HeaderTemplate>
                    Sampling Cycle time <br />
                    Days (Week)
                   ...
                   <asp:TemplateField ItemStyle-Width="170px" HeaderStyle-Width="170px" HeaderText="Comment" Visible="false">
                        <ItemTemplate>
     ...
     <br />
    <asp:HyperLink ID="hlnkflow" Target="_blank"  CssClass="addClass" runat="server">Re Intial Sampling Pre Order Cycle</asp:HyperLink>
    <br />
   ...
   &nbsp;<br />
    <input type="button" id="btnPrint" class="da_submit_button" value="Print" style="height:24px" onclick="return PrintPDF();" />
    </div>
    <br />
    <div id="divpattern" runat="server">
  <h1 class="Headertext">  Ref/ Production pattern after STC( Before 20% pcs cut)</h1>
<asp:GridView runat="server" ID="grdsamplebefore" RowStyle-ForeColor="Gray" CssClass="item_list"
    AutoGenerateColumns="false" Enabled="false" AllowPaging="true" Width="640px" OnRowDataBound="grdsamplebefore_RowDataBound">
    <Columns>
    ...
    <script type="text/javascript">
        $(document).ready(function () {
            debugger;
                ...
                $(".addClass").attr("href", "../../Admin/FitsSample/frmPreorder_SamplingCycle.aspx?StyleId=" + StyleId);
                return false;
