<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="HourlyReportStyleCode.ascx.cs" EnableViewState="false" Inherits="iKandi.Web.UserControls.Lists.HourlyReportStyleCode" %>
<style type="text/css">
    body {
        background: #f9f9fa;
