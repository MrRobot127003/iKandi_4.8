...
{
    public partial class frmMO_BasicSection : BaseUserControl
    {
        ...
        protected void repAccess_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                HtmlImage imgPending = (HtmlImage)e.Item.FindControl("imgPending");
                HtmlImage imgAccessoryR = (HtmlImage)e.Item.FindControl("img1");
                if (AccessoryPending_OrderId > 0)
                {
                    imgPending.Src = "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png";
                    imgAccessoryR.Src = "../../App_Themes/ikandi/images/icons8-r-24Grn.png";

                }
                else
                {
                    imgPending.Src = "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png";
                    imgAccessoryR.Src = "../../App_Themes/ikandi/images/icons8-r-24Blu.png";
                }
