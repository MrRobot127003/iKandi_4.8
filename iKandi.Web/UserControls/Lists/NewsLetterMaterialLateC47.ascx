<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsLetterMaterialLateC47.ascx.cs"
    Inherits="iKandi.Web.UserControls.Lists.NewsLetterMaterialLateC47" %>
<style type="text/css">
    body
    {
        background: #f9f9fa;
...
<div style="text-align: center; padding: 5px 0px; background-color: #405D99; color: #FFFFFF;
    ...
    <div  style="text-align: center; padding: 5px 0px; background-color: #405D99; color: #FFFFFF;
        font-weight: bold;position: fixed;top:0; z-index: 1000; font-size: 14px; text-transform: capitalize; font-family: Verdana;
        width: 1435px;">
        <span style="font-weight: bold;">Material Late (C 47)</span>
    </div>
</div>
<asp:GridView ID="gvMaterialShort" Width="1435px" AutoGenerateColumns="false" CssClass="item_list persist-area"
    runat="server" OnRowDataBound="gvMaterialShort_RowDataBound" Style="margin: 0px auto;">
    <Columns>
        <asp:TemplateField>
            <HeaderTemplate>
                Style Code<br />
            ...
            <HeaderStyle Width="5%" CssClass="headercol1" />
            <ItemTemplate>
                <table style="border: 0px;" width="100%" cellspacing="0" cellpadding="0" frame="void"
                    rules="all">
                    <tbody>
                        <tr>
            ...
            <ItemTemplate>
                <table style="border: 0px;" width="100%" cellspacing="0" cellpadding="0" frame="void"
                    ...
                    <tbody>
                        <tr>
                            <td style="margin-top: 5px; text-align: center;">
                                <asp:Label runat="server" ID="lblExFactStDate" CssClass="black" Text='<%# (Convert.ToDateTime(Eval("MinExFactory")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("MinExFactory"))).ToString("dd MMM (ddd)")%>'></asp:Label>
                                <br />
                            </td>
                        </tr>
                        <tr>
        ...
        <asp:TemplateField>
            <HeaderTemplate>
                ...
                <br />
                <br />
                <table style="border: 0px; margin-top: 20px; margin-bottom: 5px;" width="100%" cellspacing="0"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th style="width: 75px; border-right: 0px !important;">
                                End Eta
                            </th>
                        </tr>
                    </tbody>
            ...
            <HeaderStyle Width="40%" CssClass="headercol2" />
            <ItemTemplate>
                <table cellpadding="0" cellspacing="0" rules="all" frame="void" width="100%">
                    <asp:Repeater ID="rptFabric" OnItemDataBound="rptFabric_ItemDataBound" runat="server">
                        <ItemTemplate>
                            <tr>
                                <td style="width: 150px; margin-top: 5px; padding-left: 5px !important;">
                                    <asp:Label ID="lblFabric" runat="server" Text='<%# Eval("FabricName") %>'></asp:Label>
                                </td>
                                <td style="width: 120px">
                                    <asp:Label ID="lblFabColor" runat="server" Text='<%# Eval("FabricColor") %>'></asp:Label>
                                </td>
                                ...
                                <td style="width: 75px; text-align: center;">
                                    <asp:Label ID="lblFabStartEta" runat="server" Font-Size="9px" Text='<%# (Convert.ToDateTime(Eval("FabricStartEta")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("FabricStartEta"))).ToString("dd MMM (ddd)")%>'></asp:Label>
                                </td>
                                <td style="width: 75px; text-align: center;">
                                    <asp:Label ID="lblFabEndEta" runat="server" Font-Size="9px" Text='<%# (Convert.ToDateTime(Eval("FabricEndEta")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("FabricEndEta"))).ToString("dd MMM (ddd)")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <asp:TemplateField>
            ...
            <HeaderStyle Width="30%" CssClass="headercol3"  />
            <ItemTemplate>
                <table cellpadding="0" cellspacing="0" rules="all" frame="void" width="100%">
                    <asp:Repeater ID="rptAccess" runat="server" OnItemDataBound="rptAcc_ItemDataBound">
                        <ItemTemplate>
                            <tr>
                                <td style="width: 130px; margin-top: 5px; padding-left: 5px !important;">
                                    <asp:Label ID="lblAccQty" runat="server" Text='<%# Eval("AccessName") %>'></asp:Label>
                                </td>
                                <td style="width: 60px; text-align: center;">
                                    <asp:Label ID="lblAccSerialNo" runat="server" Text='<%# Eval("SerialNumber") %>'></asp:Label>
                                </td>
                                <td style="width: 75px; text-align: center;">
                                    <asp:Label ID="lblAccContractNo" runat="server" Text='<%# Eval("ContractNumber") %>'></asp:Label>
                                </td>
                                <td style="width: 75px; text-align: center;">
                                ...
                                <td style="width: 75px; text-align: center;">
                                    <asp:Label ID="lblAccEta" runat="server" Font-Size="9px" Text='<%# (Convert.ToDateTime(Eval("AccessEta")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("AccessEta"))).ToString("dd MMM (ddd)")%>'></asp:Label>
                                </td>
                            </tr>
                        </ItemTemplate>
                    </asp:Repeater>
        ...
        <asp:TemplateField>
                ...
                <table style="border: 0px; margin-top: 20px; margin-bottom: 5px;" width="100%" cellspacing="0"
                    ...
                    <tbody>
                        <tr>
                            ...
                            <th style="width: 80px; border-right: 0px !important;">
                                Eta/ CWIP(Pcs)
                            </th>
                        </tr>
                    </tbody>
            ...
            <HeaderStyle Width="18%" CssClass="headercol4"  />
            <ItemTemplate>
                <div style="overflow-x: hidden; max-height: 200px;">
                    <table cellpadding="0" cellspacing="0" rules="all" frame="void" width="100%">
                        <asp:Repeater ID="rptStatus" OnItemDataBound="rptStatus_ItemDataBound" runat="server">
                            <ItemTemplate>
                                <tr>
                                    <td style="width: 60px; margin-top: 5px; padding-left: 5px !important;">
                                    ...
                                    <td style="width: 100px; margin-top: 5px; text-align: center;">
                                        <asp:Label ID="lblStaus" runat="server" Text='<%# Eval("status") %>'></asp:Label>
                                    </td>
                                    <td style="width: 80px; text-align: center;">
                                        <asp:Label ID="lblStausEta" Font-Size="9px" CssClass="oneday" runat="server" Text=""></asp:Label>
                                    </td>
                                </tr>
                            </ItemTemplate>
                        </asp:Repeater>
