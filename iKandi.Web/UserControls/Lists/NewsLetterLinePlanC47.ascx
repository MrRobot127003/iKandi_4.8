<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="NewsLetterLinePlanC47.ascx.cs" Inherits="iKandi.Web.UserControls.Lists.NewsLetterLinePlanC47" %>
...
.css("left", (e.pageX + yOffset) + "px");
    ...
    <div style="text-align: center; padding:5px 0px; background-color: #405D99;  color: #FFFFFF; font-weight: bold; font-size:14px; text-transform:capitalize; font-family:Verdana; width:1460px; margin:0px auto;">
       <span style="font-weight: bold;">Line Plan (C 47)</span>
    </div>


    <asp:GridView ID="gvNewsLetterLinePlan" Width="1460px" 
      ShowFooter="true" ShowHeader="false" AutoGenerateColumns="false" 
        CssClass="item_list Linepersist-area" runat="server" style="margin:0px auto; table-layout:fixed;" 
   ...
   <%-- Day1--%>
    ...
    <HeaderStyle CssClass="Linepersist-header" />
    </asp:GridView>  
  <div>
