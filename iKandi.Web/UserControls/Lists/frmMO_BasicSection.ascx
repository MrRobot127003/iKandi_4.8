<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmMO_BasicSection.ascx.cs" Inherits="iKandi.Web.frmMO_BasicSection" %>
...
<style type="text/css">
    ...
    .Stagetooltip {
        ...
        .Stagetooltip .lblStage1Val {
            ...
            .Stagetooltip .lblStage1Val::after {
                content: "";
                position: absolute;
                top: 0px;
                left: -16px;
...
<style type="text/css">
    ...
    .item_list2 .tooltipTable td.FirstColSta
    {
...
<script type="text/javascript">
    ...
    function UpdateCutAvg(OrderID) {
        ...
        Shadowbox.init({ animate: true, animateFade: true, modal: true });
        Shadowbox.open({ content: url, type: "iframe", player: "iframe", title: "", height: 500, width: 1282, modal: true, animate: true, animateFade: true, options: { onClose: SBClose} });
        return false;
        // end
    ...
    function ShowBiplPriceUpdatePopup(elem) {
        ...
        var check=JSON.stringify(Idarray[0]);
        $("#" + Idarray[0] + "divbiplPrice").show();

        //tl00_cph_main_content_mb_GridView1_ctl02_imgBiplPrice
...
<script type="text/javascript">
    ...
    //    function ShowSamplingFitsHistory(StyleId) {
    //        var sURL = '../../Admin/FitsSample/SamplingFitsCycleHistory.aspx?StyleId=' + StyleId;
    //        Shadowbox.init({ animate: true, animateFade: true, modal: true });
    //        Shadowbox.open({ content: sURL, type: "iframe", player: "iframe", title: "", height: 460, width: 950, modal: true, animate: true, animateFade: true, options: { onClose: SBClose} });
...
<script type="text/javascript">
    // this code added by bharat on 4-july
    function FabricAmPerFormanceRe(FabricDetails, QualityId, OrderDetailID, Fabric) {
        //        

        //added by raghvinder on 13 March 2020 start        
        ...
        //added by raghvinder on 13 March 2020 end
        ...
        Shadowbox.init({ animate: true, animateFade: true, modal: true });
        Shadowbox.open({ content: url, type: "iframe", player: "iframe", title: "", height: 250, width: 500, modal: true, animate: true, animateFade: true, options: { onClose: SBClose} });
        return false;
    }
    // end
...
<style type="text/css">
    ...
    .item_list2 TD
    {
        padding: 0px !important; /* background-color: #f9f9fa;*/
        border: 1px solid #e6e6e6;
        text-align: left;
        vertical-align: top;
    }
...
<div class="form_box myDIV" style="border: none !important;">
    ...
    <table class="item_list2 showHeaderTop" id="GridHeader" runat="server" border="0" cellpadding="0" cellspacing="0" style="width: 1641px; position: -webkit-sticky; position: sticky; top: 0; z-index: 34;">
        <tr class="persist-header">
            <th class="newtext13" valign="top" scope="col" style="width: 202px !important; text-align: center">
                <label>
                    Basic Info</label>
            </th>
            <th scope="col" style="width: 426px; z-index: 1">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="head-table">
                    <tbody>
                        ...
                        <tr>
                            <td style="min-width: 81px" align="center" rowspan="2">
                                Quality/Description
                            </td>
                            <td align="center" style="text-align: center; width: 60px;" rowspan="2">
                                Avg/wd Inch
                            </td>
                            <td style="min-width: 90px" align="center" rowspan="2">
                                Pre Inhouse Stage<br>
                                Stg Rec.(Chkd.) Stat
                            </td>
                            <td align="center" style="text-align: center; width: 56px;">
                                inhouse
                            </td>
                            <td align="center" style="text-align: center; width: 49px;">
                                Issued
                            </td>
            ...
            <th scope="col" style="width: 400px; z-index: 1">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="head-table">
                    <tbody>
                        <tr>
                            <th colspan="7">
                        ...
                        <tr>
                            <td style="min-width: 110px; max-width: 110px; text-align: center">
                                Quality(Size)
                                <br>
                                Color Print
                            </td>
                            <td style="min-width: 90px; max-width: 90px; text-align: center">
                                Pending In House Days
                            </td>
                            <td style="min-width: 27px; text-align: center">
                                In House
                            </td>
            ...
            <th scope="col" style="width: 378px;">
                <table width="100%" cellpadding="0" cellspacing="0" border="0" class="head-table">
                    <tbody>
                        <tr>
    ...
    <asp:GridView CssClass="item_list2 persist-area" ID="GridView1" Width="1645px" runat="server" AutoGenerateColumns="False" ShowHeader="true" OnRowDataBound="GridView1_RowDataBound" AllowPaging="false" PageSize="10">
        <Columns>
            <asp:TemplateField HeaderText="<label>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Basic Info</label>" HeaderStyle-CssClass="newtext13" ItemStyle-CssClass="newcss2 newtext13" HeaderStyle-Width="186px" ItemStyle-Width="186px" ItemStyle-VerticalAlign="top" HeaderStyle-VerticalAlign="Top">
                <ItemTemplate>
                    <div style="width: 100% !important; text-align: center;">
                        <input type="hidden" id="Hidden1" name="contractNumber<%# Container.DataItemIndex + 1 %>" value='<%# (Eval("ContractNumber") != null) ? Eval("ContractNumber").ToString() : ( (Eval("LineItemNumber") != null) ? Eval("LineItemNumber")  : "" ) %>' />
                        <input type="hidden" id="orderDetailID<%# Container.DataItemIndex + 1 %>" name="orderDetailID<%# Container.DataItemIndex + 1 %>" value='<%# Eval("OrderDetailID") %>' />
                        <input type="hidden" id="OrderID<%# Container.DataItemIndex + 1 %>" name="OrderID<%# Container.DataItemIndex + 1 %>" value='<%# Eval("OrderID") %>' />
                        <input type="hidden" id="ClientID<%# Container.DataItemIndex + 1 %>" name="ClientID<%# Container.DataItemIndex + 1 %>" value='<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.client.ClientID %>' />
                        <input type="hidden" id="hdnOrderDate<%# Container.DataItemIndex + 1 %>" name="hdnOrderDate<%# Container.DataItemIndex + 1 %>" value='<%# (Convert.ToDateTime((Eval("ParentOrder") as iKandi.Common.Order).OrderDate) == Convert.ToDateTime("1/1/1900"))? "" : (Eval("ParentOrder") as iKandi.Common.Order).OrderDate.ToString("dd MMM") %>' />
                        <input type="hidden" id="hdnExFactory<%# Container.DataItemIndex + 1 %>" name="hdnExFactory<%# Container.DataItemIndex + 1 %>" value='<%# (Convert.ToDateTime(Eval("ExFactory")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("ExFactory"))).ToString("dd MMM")%>' />
                        <div style="width: 186px !important; height: 30px;">
                            <div style="width: 29%; text-align: left; float: left;">
                                <span style="text-align: center; font-size: 8px;">
                                    <asp:HiddenField ID="hdnIsOldOrder" runat="server" Value='<%# Eval("IsOldOrder")  %>'></asp:HiddenField>
                                    <asp:Label ID="lblOrdDate" ToolTip="Order Date" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Visible='<%# Eval("bOrderDateRead") %>' runat="server" Text='<%# (Convert.ToDateTime((Eval("ParentOrder") as iKandi.Common.Order).OrderDate) == Convert.ToDateTime("1/1/1900"))? "" : (Eval("ParentOrder") as iKandi.Common.Order).OrderDate.ToString("dd MMM (ddd)") %>'></asp:Label>
                                </span>
                            </div>
                            <div style="width: 30%; text-align: right; float: left;">
                                <asp:Label ID="lblIsRepeatOrder" Font-Size="8px" ToolTip="R means repeat order" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>'></asp:Label>
                            </div>
                            <div style="width: 40%; text-align: right; float: right;">
                                <span class="newtext"><a id="hypSerial" runat="server" style="font-size: 11px;" class="hide_me clsSerialnumber">
                                    ...
                                    <span><a target="_blank" href='/Internal/Sales/OrderPlace.aspx?orderid=<%# Eval("OrderID")%>' title="Order Form" style='height: 80px; width: 19px ! important; font-size: 11px; <%# "color :" + Eval("LinktypeForeColor").ToString() %>'>
                                        <%# (Eval("ParentOrder") as iKandi.Common.Order).SerialNumber%></a></span></a>
                                    <%--END--%>
                                    <asp:Label ID="lblSerial" runat="server" ToolTip="Serial Number" ForeColor="#0000ee" Visible="false" Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).SerialNumber%>'></asp:Label>
                                    <asp:HiddenField ID="hdnSerialNumber" runat="server" Value='<%# (Eval("ParentOrder") as iKandi.Common.Order).SerialNumber%>'></asp:HiddenField>
                                </span>
                            </div>
                        ...
                        <div class="imagecontainer">
                            <span style="text-align: center;">
                                <a title="CLICK TO VIEW ENLARGED IMAGE" href="javascript:void(0)" onclick='showStylePhotoWithOutScroll(<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID.ToString()+",-1,"+Eval("OrderDetailID").ToString() %>)'>
                        ...
                        <asp:HiddenField ID="hdnStyleNo" runat="server" Value='<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>' />
                         ...
                         <asp:Label ID="lblStyleNumber"   ToolTip="Style Number" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("stylenumberColor")) %>' style="font-weight:bold;" Visible="false" Text='<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>'></asp:Label>--%>
                            <span class="newtext2" style="text-align: center;" id="spnStyleNumber" runat="server">
                                ...
                                <a href="javascript:void(0)" onclick="showLinksPopup_ManageOrder('<%# Eval("OrderID") %>', '<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.client.ClientID %>',  this, '<%# Eval("OrderDetailID") %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID.ToString()%>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.sCodeVersion.ToString()%>', '<%# (Eval("ParentOrder") as iKandi.Common.Order).Fits.StyleCodeVersion %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleCode.ToString()%>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.cdept.DeptID%>','<%# Eval("File") %>','<%# Eval("File2") %>', '<%# Eval("File3") %>')" style='font-size: 11px; font-weight: bold; <%# "color :" + Eval("stylenumberColor").ToString() %>'>
                        ...
                        <%--dinesh--%>
                        <div style="width: 100% !important; height: auto; text-align: center;">
                            ...
                            <asp:TextBox ID="lblDiscription" CssClass="autoheight_orderdiscription" TextMode="MultiLine" data-expandable MaxLength="50" onchange="javascript:return UpdateDescription(this);" Style="font-size: 8px !important; color: #807F80 !important;width:96%; text-transform: capitalize; background-color: #f9f9fa; text-align: left;" Visible='<%#Eval("bBusinessDescriptionRead") %>' Enabled='<%#Eval("bBusinessDescriptionwrite") %>' runat="server" Text='<%# Eval("Description") %>'></asp:TextBox>
                        </div>
                        <!--Description-->
                        <div style="width: 100% !important; vertical-align: top; background-color: #f9f9fa;">
                            <span id="spnDepartment" style="text-align: center;" class="newtext4" runat="server" visible='<%# Eval("bDepartmentRead") %>'><a href="javascript:void(0)" title="CLICK TO GO DEPARTMENT WISE B/D ORDERS" style='font-size: 8px !important; font-weight: bold; <%# "color :" + Eval("BlackToForeColor").ToString() %>' onclick="GetManageOrderiKandiQuantityByDept('<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.cdept.DeptID%>')">
                                <%# (Eval("ParentOrder") as iKandi.Common.Order).Style.cdept.Name%></a></span>
                            <asp:Label ID="lblDepartment" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Style="font-size: 8px;" Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.cdept.Name%>'></asp:Label>
                        </div>
                        <div style="width: 100%; height: 21px; text-align: center;">
                            <span style="width: 40%; text-align: center; padding-top: 5px; background-color: #f9f9fa;">
                                ...
                                <asp:TextBox ID="lbLine" ToolTip="Line No." MaxLength="15" Width="40%" onchange="javascript:return UpdateLineNo(this);" Style="font-size: 8px; background-color: #f9f9fa; text-align: right" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Visible='<%#Eval("bLineNo") %>' Enabled='<%#Eval("bLinewrite") %>' runat="server" Text='<%# Eval("LineItemNumber")%>'></asp:TextBox>
                            </span><span style="width: 5px; background-color: #f9f9fa;">|</span>
                            <%--  Yadvendra--%>
                            <span style="width: 20px;">
                                <asp:Label ID="lblDestinationCode" runat="server" Style="font-size: 8px;" Text='<%# Eval("DesinationCode")%>'></asp:Label>
                            </span><span style="width: 5px; background-color: #f9f9fa;">|</span> <span style="width: 32%; text-align: left; padding-top: 5px; background-color: #f9f9fa;">
                                ...
                                <asp:TextBox ID="lblContract" ToolTip="Contract No" MaxLength="15" Width="40%" onchange="javascript:return UpdateContractNo(this);" Style="font-size: 8px; background-color: transparent !important; text-align: left" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Visible='<%#Eval("bContractNo") %>' Enabled='<%#Eval("bContractwrite") %>' runat="server" Text='<%# Eval("ContractNumber")%>'></asp:TextBox>
                            </span>
                            <div style="clear: both;">
                            </div>
                        </div>
                    ...
                    <span style="color:#e6e6e6;">|</span>
                        ...
                        <div style="width: 100% !important; height: 20px; text-align: center; display: inline-block;">
                            ...
                            <asp:Label ID="lbldressPrice" Style="font-size: 10px; color: #000000;font-weight:600; font-size: 10px !important;" Text='<%# Eval("DressPrice")%>' runat="server"></asp:Label>
                            <span><span id="spnBiplPrice" runat="server"><a title="CLICK TO SEE COSTING FORM" style='font-size: 10px !important; <%# "color :" + Eval("LinktypeForeColor").ToString() %>' target="CostingForm" href="../Sales/CostingSheetNew.aspx?sn=<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber %>&SingleVersion=1">
                            ...
                            <asp:Label ID="lblPriceSymbol" Style="color: #807F80; font-size: 9px !important;" runat="server"></asp:Label>
                            <asp:Label ID="lblikandiGross" ToolTip="BIPL Revenue" Style="color: #807F80; font-size: 9px !important;" runat="server"></asp:Label>
                            <asp:Label ID="lblActualProfitMargin" Text='<%# Eval("ActualProfitMargin")%>' Style="font-size: 9px !important; color: #807F80;" runat="server"></asp:Label>
                            <div style="clear: both;">
                                <br />
                                <img id="imgBiplPrice" runat="server" src="../../App_Themes/ikandi/images/price.png" onclick="ShowBiplPriceUpdatePopup(this);" style="margin-top: 50px; width: 20px;" alt="" />
                            </div>
                            <%--<asp:ScriptManager id="script1" runat="server"></asp:ScriptManager>--%>
                            <%--<asp:UpdatePanel ID="upbiplprice" runat="server" >--%>
                            <%-- <ContentTemplate>--%>
                            <%--</ContentTemplate>
                      </asp:UpdatePanel>--%>
                        </div>
                        <div style="width: 100% !important; height: 20px; text-align: center;">
                            <asp:Label ID="lblIkandiPriceTag" Style="font-size: 9px !important;" runat="server"></asp:Label>&nbsp;
                            <asp:Label ID="lblIkandiDiscount" ToolTip="Ikandi Gross Price" Style="font-size: 9px !important; color: #807F80 !important;" runat="server"></asp:Label>
                            <%--<asp:Label ID="lblSeprator" runat="server" Text="|"></asp:Label>--%>
                            <asp:Label ID="lblMargin" ToolTip="Ikandi Profit Margin" runat="server" Style="font-size: 8px !important; color: #807F80 !important;"></asp:Label>
                            <span style="display: none;">
                                <asp:Label ID="lblBusinessTag" Style="font-size: 8px !important; color: #807F80 !important;" runat="server"></asp:Label>&nbsp;<asp:Label ID="lblBusiness" ToolTip="Ikandi Business" Style="font-size: 8px !important; color: #807F80 !important;" runat="server"></asp:Label>
                            </span>
                        </div>
                        <div style="width: 100% !important; height: 20px; text-align: center;">
                            <asp:Label ID="lblWeight" Style="font-size: 9px !important;" Text="" runat="server"></asp:Label>
                            &nbsp;
                            <asp:TextBox ID="txtWeight" MaxLength="4" onchange="javascript:return UpdateWeight(this);" Width="20px" Style="font-size: 8px !important; background-color: #f9f9fa; text-align: right;" Visible='<%#Eval("bCostingWeight") %>' Enabled='<%#Eval("bCostingWeight_Permission") %>' onkeypress="javascript:return isNumber(event);" runat="server" Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).Costing.Weight %>'></asp:TextBox>&nbsp;
                            <asp:Label ID="lblUnitCostingWeight" Style="font-size: 9px !important; color: Gray; text-transform: lowercase !important" Text="GMS" Visible='<%#Eval("bCostingWeight") %>' runat="server"></asp:Label>
                    ...
                    <div style="width: 100%; padding-top: 5px; padding-left: 5px; display: none;">
                        <div style="width: 240px; float: left;">
                            <div style="float: left; text-align: center; width: 80px;">
                                <asp:Label ID="lblplannedex" ToolTip="Pre ExFactory" Style="font-size: 8px !important; color: #807F80 !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PlannedEx")) == Convert.ToDateTime("1/1/1900")) ? "" : "(" + (Convert.ToDateTime(Eval("PlannedEx"))).ToString("dd MMM") +")"%>' Visible='<%# Eval("bShipmentOfferDateRead") %>' Enabled='<%# Eval("bShipmentOfferDatewrite") %>'></asp:Label>
                    ...
                    <div style="font-size: 9px; color: #000000; text-align: center; width: 186px; display: none;">
                        ...
                        <asp:Label ID="lblpopending" Visible='<%#Eval("bBasicInfoRemarkRead") %>' Text='<%# Eval("Pricevariation") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("PricevariationColor")) %>' Style="font-size: 8px !important;" runat="server"></asp:Label>
                        <%--END--%>
                        <asp:Label ID="lbladd" Text="  " Style="font-size: 8px !important; color: #807F80 !important;" runat="server"></asp:Label>
                    </div>
                    <div runat="server" id="divAgreement" style="font-size: 9px; width: 186px; padding-top: 5px; text-align: center;">
                        <asp:Label ID="lblPendingAgrement" Text='BIPL Agreement pending' Style="font-size: 8px !important; font-weight: bold;" runat="server"></asp:Label>
                    </div>
                    <div style="height: 16px;">
                        <div style="font-size: 9px; color: rgb(128, 127, 128) !important; <%# "display :" + Eval("IsTestReportvisible").ToString() %>; padding-top: 5px;" class="photoshot">
                            Photoshot:<asp:CheckBox ID="chkPhotoshot" Checked='<%#Eval("PhotoShoot") %>' Enabled='<%# ((bool)Eval("PhotoShoot"))==true? false : true %>' runat="server" Style="vertical-align: middle; position: relative; top: 4px;" onclick="javascript:return UpdatePhotoShot(this,'');" />
                            <asp:TextBox ID="TxtPhotoshot" Width="80px" class="th" Enabled='<%# ((bool)Eval("PhotoShoot"))==true? false : true %>' Style="font-size: 8px !important; text-transform: capitalize !important; padding: 3px; border: 1px solid #ccc;" runat="server" Text='<%# (Convert.ToDateTime(Eval("IsPhotoShoot")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("IsPhotoShoot")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("IsPhotoShoot")) == Convert.ToDateTime("01-01-1900")) ? (Convert.ToDateTime(Eval("IsPhotoShoot")) == Convert.ToDateTime("01-01-1900")||Convert.ToDateTime(Eval("IsPhotoShoot")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("IsPhotoShoot")).ToString("dd MMM (ddd)")  : Convert.ToDateTime(Eval("IsPhotoShoot")).ToString("dd MMM (ddd)") %>' onchange="javascript:return UpdatePhotoShot(this,'');"></asp:TextBox>
                        </div>
                    </div>
                    <asp:HiddenField ID="hdnOrderdetailsids" runat="server" Value='<%# Eval("OrderDetailID")%>' />
                    <%--end by abhishek on 15/3/2016--%>
                    <div style="font-size: 9px; color: #0000ee; width: 186px; line-height: 13px; padding-top: 5px; min-height: 25px; margin-top: 55px; position: relative;">
                        <asp:Label ID="lbldelaytaskname" ToolTip="Basic Section Delay Task" runat="server" Text='<%# Eval("DelayTask")%>'></asp:Label>
                        <div id="divbiplPrice" class="BiplPrice" runat="server" style="display: none; position: absolute; left: 64%; box-shadow: 8px 8px 10px #888888; padding: 5px 20px; background-color: white; z-index: 3; bottom: -87px; width: 165px; z-index: 3; font-size: 10px">
                            <img height="16px" width="11px" class="arrow1" alt="" src="../../App_themes/ikandi/images/bg_quickview_left_arrow.gif">
                            <h5 style="text-align: center; background-color: #39589c !important; color: #98a9ca; font-size: 12px; padding: 4px; font-family: system-ui;">
                                Update BIPL Price <a onclick="$(this).parent().parent().hide();" style="position: absolute; text-align: right; color: #98a9ca; right: 25px; font-size: 12px;">X </a>
                            </h5>
                            <table>
                                <tr>
                                    <td style="font-size: 12px; font-family: sans-serif; font-weight: 600; padding: 4px!important; padding-left: 5px!important; color: #98a9ca;">
                                        Bipl Price:
                                    </td>
                                    <td style="border-color: transparent; font-size: 12px; font-family: sans-serif; font-weight: 600; line-height: 20px; padding-left: 5px!important; color: #000; width: 65px;">
                                        <span class="currency">
                                            <%# iKandi.Common.Constants.GetCurrencySymbalByCurrencyType(Convert.ToInt32((Eval("ParentOrder") as iKandi.Common.Order).Costing.ConvertTo)) %>
                                        </span>
                                ...
                                <tr>
                                    <td style="font-size: 12px; font-family: sans-serif; padding: 4px!important; text-align: center; font-weight: 600; color: #98a9ca;">
                                        Change To:
                                    </td>
                                    <td class="Rupees1" style="font-size: 12px; font-family: sans-serif; font-weight: 600; color: #000;">
                                        <span class="currency" style="margin-left: 5px;line-height: 21px;">
                                            <%# iKandi.Common.Constants.GetCurrencySymbalByCurrencyType(Convert.ToInt32((Eval("ParentOrder") as iKandi.Common.Order).Costing.ConvertTo)) %>
                                        </span>
                                        <asp:TextBox ID="txtchangeBiplPrice" runat="server" MaxLength="5" CssClass="numeric-field-with-two-decimal-places" Style="width: 90%;"></asp:TextBox>
                                        <lable style="display: none"></lable>
                                    </td>
                                </tr>
                                <tr>
                                    <td style="border: none!important; padding: 10px 0!important;">
                                        <a id="btnsave" runat="server" onclick="UpdateBiplPrice(this);" style="background-color: #13a747; color: white; font-size: 12px; padding: 4px 7px; font-weight: 600; border-radius: 2px;">Save</a>
                                        <sapn id="spanPriceUpdateMsg" runat="server" style="color: green; position: absolute; left: 35%;"></sapn>
                                    </td>
                                </tr>
                            </table>
                        </div>
                    ...
                    <div style="font-size: 9px; color: #0000ee; width: 186px; padding-top: 5px; display: none;">
                        <%--Updated By Ashish on 28/3/2015--%>
                        <asp:Label ID="lblCQDA" Text='<%# Eval("CQDA") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("CQDForeColor")) %>' Style="font-size: 8px !important;" runat="server"></asp:Label>
                        <%--END--%>
                    </div>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0" border="0" style='<%# "border:none !important; fore-color :" + Eval("ExFactoryColor").ToString() %>'>
                            <tr>
                                <td valign="top" align="left" style='<%# "border:none !important; width:100%;  text-align:left; fore-color :" + Eval("ExFactoryColor").ToString() %>'>
                                    <asp:Label ID="lblshippingRemarks" Style="font-size: 8px !important; text-transform: capitalize !important; color: #807F80 !important;" runat="server"></asp:Label>
                                </td>
                ...
                <ItemStyle Width="170px" CssClass="newcss2 PaddLeft1"></ItemStyle>
            </asp:TemplateField>
            <asp:TemplateField FooterStyle-Width="375px" ItemStyle-HorizontalAlign="Center">
                <HeaderTemplate>
                    <table width="100%" cellpadding="0" cellspacing="0" border="0" class="head-table">
                        <tr>
                ...
                <ItemTemplate>
                    <div style='text-align: center; padding-top: 5px; padding-bottom: 5px; width: 100%; <%# "background-color :" + Eval("BIHBackColor").ToString() %>'>
                        <a href='/Internal/Fabric/FabricOrderPrintComments.aspx?orderid=<%# Eval("OrderID")%>' target="_blank" title="Fabric Order Form">
                            <asp:Label ID="LabelBIHname" Style="font-size: 11px; font-family: Arial;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BIHForColor")) %>' Visible='<%# Eval("FBIHDateRead") %>' Text="B.I.H : "></asp:Label>
                            <asp:Label ID="lblBulkInhouseTgt" Style="font-size: 11px; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BIHForColor")) %>' Text='<%# (Convert.ToDateTime(Eval("BulkTarget")) == Convert.ToDateTime("1/1/1900")) ? "" : Convert.ToDateTime(Eval("BulkTarget")).ToString("dd MMM yy (ddd)")%>' Visible='<%# Eval("FBIHDateRead")%>'></asp:Label>&nbsp<span style="font-size: 8px;"></span></a>
                    ...
                    <div style="text-align: center; width: 100%; min-height: 252px;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr id="trFirstFabric" visible="false" runat="server">
                                <td align="left" id="td1f1" runat="server" height="15px" style="border-bottom: none !important; border-right: none !important; min-width: 96px; max-width: 96px; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric1NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric1name" style="text-align: left; font-weight: bold; font-size: 8px; cursor: pointer; word-break: break-all; color: Blue" title='<%# Eval("Fabric1CCGSM")%>'>
                                            <%# Eval("Fabric1")%>
                                        </span>
                                        <asp:Label ID="lblFab1" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric1NameForColor")) %>' CssClass="FabricCls1" Text='<%# Eval("Fabric1")%>'></asp:Label>
                                ...
                                <td align="center" width="10%" id="td2f1" runat="server" visible="false" style="border-bottom: none !important; border-right: none !important;">
                                    <asp:Label ID="lblFabric1OrderAverage" runat="server" Style="font-size: 8px !important; color: #807F80 !important;" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric1OrderAverage")%>'></asp:Label>
                                </td>
                                <td align="center" id="td2p1" runat="server" style="border-bottom: none !important; color: #807F80 !important; text-align: center; width: 45px; padding-top: 2px !important;">
                                    <asp:Label ID="lblFabric1STCAverage" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' ReadOnly="true" Text='<%# Eval("Fabric1STCAverage")%>' Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth1" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' Visible="false"></asp:Label>
                                ...
                                <td style="min-width: 90px; max-width: 90px; position: relative" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName1" runat="server" Text='<%# Eval("FabricStages1")%>'></asp:Label>
                                        <%-- <asp:HiddenField ID="hdnStageVal1" runat="server" Value='<%# Eval("FabricStages1_ToolTip")%>' />              --%>
                                        <asp:Label ID="Label1" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages1_ToolTip")%>'></asp:Label>
                                    </div>
                                    <%--   <a href='../../Internal/Fabric/FabricAMPerformanceReport.aspx?FabricDetails=<%# Eval("Fabric1Details")%>&TradeName=<%# Eval("FabQuality_ID1")%>&OrderDetailID=<%# Eval("OrderDetailID")%>'><img src="../../images/viewicon.png" style="width:20px;cursor: pointer;" /></a>--%>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick=" FabricAmPerFormanceRe('<%# Eval("Fabric1Details")%>','<%# Eval("FabQuality_ID1")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric1")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <td align="center" id="td3f1" runat="server" style="border-bottom: none !important; width: 40px; border-right: none !important; border-left: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent1" runat="server">
                                        <asp:Label ID="lblPercent1" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' Style="font-size: 8px; text-align: center;" runat="server" Visible='<%# Eval("FPerInhouseRead")%>' title='<%# " ("+Eval("QuantityAvl1").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric1STCAverage").ToString() +")  " %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric1Percent %>'></asp:Label>
                                    </a>
                                </td>
                                <td align="center" id="td4f1" runat="server" style="border-bottom: none !important; border-right: 1px solid #E6E6E6; padding-top: 4px; border-left: 1px solid #E6E6E6; width: 40px;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor1").ToString()%>'>
                                        <%--<asp:TextBox ID="lblQuantityAvl1" runat="server" ToolTip='<%# Eval("QuantityAvl1")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' onchange="javascript:return ManageOrderFabricInHouseHistory(this,1);" onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,1)" onclick="SetFinalFabricOrderActualValue(this,1)"  CssClass="numeric-field-without-decimal-places" style="text-align:center; width: 30px; font-size:8px !important;  background:transparent!important;"  Text='<%# Eval("FinalOrderFabric1_k")%>' Visible='<%# Eval("FRecdRead")%>'  Enabled='<%# Eval("FRecdWrite")%>' ></asp:TextBox>--%>
                                        <asp:TextBox ID="lblQuantityAvl1" runat="server" ToolTip='<%# Eval("QuantityAvl1")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,1);" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; width: 30px; height: 10px; height: 12px; font-size: 8px !important; background: transparent!important;" Text='<%# Eval("FinalOrderFabric1_k")%>' Visible='<%# Eval("FRecdRead")%>' ReadOnly="true" Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                ...
                                <td align="center" id="tdfab1Fbricinhouse" runat="server" style="border-bottom: none !important; border-right: 1px solid #E6E6E6; min-width: 70px; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor1").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="txtinhouseqntyfab1" ReadOnly="true" ToolTip='<%# Eval("fab1CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' onchange="javascript:return ManageOrderFabricInHouseHistory_checked(this,1);" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; width: 24px; font-size: 8px !important; height: 10px; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab1InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,1);"></asp:TextBox>
                                ...
                                <td align="center" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric1Required_ToolTip").ToString()+" " %>' id="td5f1" runat="server" style="min-width: 30px; border-bottom: none !important; border-left: none !important; border-right: 0px !important;">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric1" ToolTip='<%# Eval("Fabric1Required_ToolTip")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' runat="server" Style="font-size: 8px !important;" Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric1")%>'></asp:Label>
                            ...
                            <tr id="trfirstprint" visible="false" runat="server">
                                <td id="td1p1" runat="server" align="left" height="15px" style="width: 130px; border-right: none !important; border-bottom: 1px solid #e6e6e6; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric1Details")%>&TradeName=<%# Eval("Fabric1")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric1StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric1Details")%>&TradeName=<%# Eval("Fabric1")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric1StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric1StageSelect").ToString().Trim() == "False" )?"Stage Selection Not Done":"Raise & Revise Po" %>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric1Details" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval1ForColor")) %>' Style="font-size: 8px; font-weight: bold; color: #000" Text='<%# Eval("Fabric1Details")%>'></asp:Label>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor1" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus1ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F5BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F5BulkStatus%>'></asp:Label>
                                </td>
                                <%-- this code comment by bharat on 7-june--%>
                                ...
                                <td align="left" id="td1" runat="server" style="margin: 0px !important; padding: 0px !important; border-top: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6; font-size: 8px; text-transform: capitalize; line-height: 10px; background-color: #F9F9FA;" width="184px">
                                    <div style="width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <%--Added By Ashish on 24/3/2015--%>
                                        <asp:TextBox ID="lblSummary1" runat="server" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" CssClass="do-not-allow-typing" Width="45" Text='<%# Eval("TotalSummary1")%>'></asp:TextBox>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA1BackColor").ToString()%>'>
                                        <asp:TextBox ID="txtStrikeof1" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor1"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor1"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff1');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff1ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff1ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff1ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff1ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff1ETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("StrikeOff1ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA1BackColor").ToString()%>'>
                                        <%--<a onclick="javascript:return showEtaPopupFABRIC('FABSTR','Fabric','Fab1','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID%>','<%# ((string)Eval("Fabric1")).Replace(@"""","")%>','<%# Eval("Fabric1Details")%>','<%# (Convert.ToDateTime(Eval("fabric1ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric1ETA")).ToString("dd MMM yy (ddd)")%>','<%# (Convert.ToDateTime(Eval("Fabric1ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric1ENDETA")).ToString("dd MMM yy (ddd)")%>','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>','<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric1Percent %>','<%#Eval("OrderDetailID") %>','<%# Eval("FFabStartETAWrite")%>',60);"
                                            href="#">--%>
                                        <asp:TextBox ID="txtFab1StartEta" Enabled="false" ReadOnly="true" Visible='<%# Eval("FFabStartETARead")%>' CssClass="do-not-allow-typing" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA1ForColor")) %>' runat="server" Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric1ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric1ETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        <%-- </a>--%>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA1BackColor").ToString() %>'>
                                        <%--  <a onclick="javascript:return showEtaPopupFABRIC('','Fabric','Fab1','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID%>','<%# ((string)Eval("Fabric1")).Replace(@"""","")%>','<%# Eval("Fabric1Details")%>','<%# (Convert.ToDateTime(Eval("fabric1ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric1ETA")).ToString("dd MMM yy (ddd)")%>','<%# (Convert.ToDateTime(Eval("Fabric1ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric1ENDETA")).ToString("dd MMM yy (ddd)")%>','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>','<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric1Percent %>','<%#Eval("OrderDetailID") %>','<%# Eval("FFabEndETAWrite")%>',60);"
                                            href="#">--%>
                                        <asp:TextBox ID="txtFab1EndEta" ReadOnly="true" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA1ForColor")) %>' runat="server" Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric1ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric1ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        <%-- </a>--%>
                                    </div>
                                    <div style="clear: both;">
                                    </div>
                            ...
                            <tr id="trsecFabric" visible="false" runat="server">
                                <td align="left" id="td4f2" runat="server" height="15px" style="border-top: none !important; border-bottom: none !important; border-right: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric2NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric2name" style="text-align: left; font-size: 8px; font-weight: bold; cursor: pointer; color: Blue; word-break: break-all;" title='<%# Eval("Fabric2CCGSM")%>'>
                                            <%# Eval("Fabric2")%></span>
                                        <asp:Label ID="lblFab2" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric2NameForColor")) %>' Text='<%# Eval("Fabric2")%>' CssClass="FabricCls1"></asp:Label>
                                ...
                                <td id="td5f2" runat="server" visible="false" style="border-bottom: none !important; border-top: none !important; border-right: none !important;">
                                    <asp:Label ID="lblFabric2OrderAverage" runat="server" Style="font-size: 8px !important; color: #807F80 !important;" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric2OrderAverage")%>'></asp:Label>
                                </td>
                                <td id="td2p2" runat="server" style="border-bottom: none !important; border-top: none !important; color: #807F80 !important; padding-top: 2px !important; text-align: center;">
                                    <asp:Label ID="lblFabric2STCAverage" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ReadOnly="true" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent2ForColor")) %>' Text='<%# Eval("Fabric2STCAverage")%>' Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth2" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent2ForColor")) %>' Visible="false"></asp:Label>
                                ...
                                <td style="min-width: 90px; border-top: 0px !important; position: relative;" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName2" runat="server" Text='<%# Eval("FabricStages2")%>'></asp:Label>
                                        <asp:Label ID="Label3" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages2_ToolTip")%>'></asp:Label>
                                    </div>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick="FabricAmPerFormanceRe('<%# Eval("Fabric2Details")%>','<%# Eval("FabQuality_ID2")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric2")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <%-- <td width="20px">
                              <asp:HyperLink ID="viewolay2" ToolTip="VIEW CAD File" runat="server" style="display:none;"   Target="_blank" ImageUrl="~/App_Themes/ikandi/images/info.jpg" Text=""></asp:HyperLink>
                                ...
                                <td id="td6f2" runat="server" style="border-bottom: none !important; border-top: none !important; border-right: none !important; border-left: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent2" runat="server">
                                        <asp:Label ID="lblPercent2" runat="server" Style="font-size: 8px;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent2ForColor")) %>' title='<%# " ("+Eval("QuantityAvl2").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric2STCAverage").ToString() +")  " %>' Visible='<%# Eval("FPerInhouseRead")%>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric2Percent %>'></asp:Label></a>
                                </td>
                                <td id="td7f2" runat="server" style="border-bottom: none !important; border-top: none !important; padding-top: 4px; border-right: 1px solid #E6E6E6; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor2").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="lblQuantityAvl2" ToolTip='<%# Eval("QuantityAvl2")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,2);" ReadOnly="true" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent2ForColor")) %>' onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,2)" CssClass="numeric-field-without-decimal-places CursorPint" Style="font-size: 8px !important; width: 85%; height: 12px; background: transparent" runat="server" Text='<%# Eval("FinalOrderFabric2_k")%>' Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                ...
                                <td align="center" id="tdfab2Fbricinhouse" runat="server" style="border-bottom: none !important; border-right: 1px solid #E6E6E6; border-top: 0px !important; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor2").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="txtinhouseqntyfab2" ReadOnly="true" ToolTip='<%# Eval("fab2CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' onchange="javascript:return ManageOrderFabricInHouseHistory_checked(this,2);" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; height: 10px; width: 24px; font-size: 8px !important; height: 10px; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab2InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,2);"></asp:TextBox>
                                ...
                                <td id="td8f2" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric2Required_ToolTip").ToString()+" " %>' runat="server" style="border-bottom: none !important; border-top: none !important; border-left: none !important; border-right: 0px !important;">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric2" ToolTip='<%# Eval("Fabric2Required_ToolTip")%>' runat="server" Style="font-size: 8px !important;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent2ForColor")) %>' Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric2")%>'></asp:Label>
                                    </div>
                            ...
                            <tr id="trsecPrint" visible="false" runat="server">
                                <td id="td1p2" runat="server" align="left" height="21px" style="border-right: none !important; border-bottom: 1px solid #e6e6e6; width: 155px; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric2Details")%>&TradeName=<%# Eval("Fabric2")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric2StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric2Details")%>&TradeName=<%# Eval("Fabric2")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric2StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric2StageSelect").ToString().Trim() == "False" )?"Stage Selection Not Done":"Raise & Revise Po" %>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric2Details" Style="font-size: 8px; font-weight: bold; color: #000;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval2ForColor")) %>' Text='<%# Eval("Fabric2Details")%>'></asp:Label>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor2" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus2ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F6BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F6BulkStatus%>'></asp:Label>
                                </td>
                                <td id="td3p2" runat="server" align="left" style="margin: 0px !important; padding: 0px !important; text-transform: capitalize; border-top: 1px solid #e6e6e6; border-left: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6; font-size: 8px; background-color: transparent;">
                                    <div style="width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <%--Added By Ashish on 24/3/2015--%>
                                        <asp:TextBox ID="lblSummary2" Width="45" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' CssClass="do-not-allow-typing" Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" runat="server" Text='<%# Eval("TotalSummary2")%>'></asp:TextBox>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <%--Added By Ashish on 12/1/2014--%>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA2BackColor").ToString() %>'>
                                        <%-- <span id="divFab2" runat="server">--%>
                                        <asp:TextBox ID="txtStrikeof2" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor2"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor2"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff2');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff2ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff2ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff2ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff2ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff2ETA")).ToString("dd MMM (ddd)")  : Convert.ToDateTime(Eval("StrikeOff2ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA2BackColor").ToString() %>'>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab2StartEta" Enabled="false" Visible='<%# Eval("FFabStartETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA2ForColor")) %>' CssClass="do-not-allow-typing" Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric2ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric2ETA")).ToString("dd MMM")%>'></asp:TextBox></a>
                                        <%--END--%>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA2BackColor").ToString() %>'>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab2EndEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA2ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric2ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric2ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        <%--   </a>--%>
                                    </div>
                                    <%--  </span>--%>
                                </td>
                            ...
                            <tr id="trthirdFabric" visible="false" runat="server">
                                <td id="td7f3" runat="server" align="left" height="15px" style="border-right: none !important; border-top: none !important; border-bottom: 1px solid #e6e6e6; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric3NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric3name" style="text-align: left; font-size: 8px; cursor: pointer; color: Blue; font-weight: bold; word-break: break-all;" title='<%# Eval("Fabric3CCGSM")%>'>
                                            <%# Eval("Fabric3")%></span>
                            ...
                            href='<%#(Eval("Fabric3Details").ToString().IndexOf("PRD:") > -1)? "/Internal/Fabric/FabricApprovals.aspx?styleid="+(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID+"&clientid="+(Eval("ParentOrder") as iKandi.Common.Order).Style.client.ClientID+"&fabric="+Server.UrlEncode(Eval("Fabric3").ToString().Replace(@"""", @"&quot;").Replace("'", "&#39;").Replace("&#39;", @"&rsquo;"))+"&orderid="+"&fabricdetails="+Server.UrlEncode(Eval("Fabric3Print").ToString().Replace("PRD:","").Replace(@"""", @"&quot;").Replace("'", "&#39;").Replace("&#39;", @"&rsquo;")):"/Internal/Fabric/FabricApprovals.aspx?styleid="+(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID+"&clientid="+(Eval("ParentOrder") as iKandi.Common.Order).Style.client.ClientID+"&fabric="+Server.UrlEncode(Eval("Fabric3").ToString().Replace(@"""", @"&quot;").Replace("'", "&#39;").Replace("&#39;", @"&rsquo;"))+"&orderid="+Eval("OrderID")         +"&CCGSM11="+Server.UrlEncode(Eval("CCGSM3").ToString().Replace(@"""", @"&quot;").Replace("'", "&#39;").Replace("&#39;", @"&rsquo;"))                            +"&fabricdetails="+Server.UrlEncode(Eval("Fabric3Print").ToString().Replace(@"""", @"&quot;").Replace("'", "&#39;").Replace("&#39;", @"&rsquo;")) %>'>
                                        ...
                                        <asp:Label ID="lblFab3" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric3NameForColor")) %>' Text='<%# Eval("Fabric3")%>' CssClass="FabricCls1"></asp:Label>
                                ...
                                <td id="td8f3" runat="server" visible="false" align="center" style="border-bottom: none !important; border-top: none !important; border-right: none !important;">
                                    <asp:Label ID="lblFabric3OrderAverage" Style="font-size: 8px !important; cursor: pointer; color: #807F80 !important;" runat="server" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric3OrderAverage")%>'></asp:Label>
                                </td>
                                <td id="td2p3" runat="server" align="center" style="border-right: none !important; color: #807F80 !important; border-bottom: none !important; border-top: none !important; color: #807F80 !important; border-left: 1px solid #e6e6e6; padding-top: 2px !important; text-align: center;">
                                    <asp:Label ID="lblFabric3STCAverage" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ReadOnly="true" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent3ForColor")) %>' Text='<%# Eval("Fabric3STCAverage")%>' Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth3" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent3ForColor")) %>' Visible="false"></asp:Label>
                                    <%--Added By Ashish on 1/1/2015--%>
                              ...
                              <asp:HyperLink ID="viewolay3" ToolTip="VIEW CAD File" runat="server"  style="display:none;"  Target="_blank" ImageUrl="~/App_Themes/ikandi/images/info.jpg" Text=""></asp:HyperLink>
                                ...
                                <td style="min-width: 90px; border-top: 0px !important; position: relative" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName3" runat="server" Text='<%# Eval("FabricStages3")%>'></asp:Label>
                                        <asp:Label ID="Label4" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages3_ToolTip")%>'></asp:Label>
                                    </div>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick="FabricAmPerFormanceRe('<%# Eval("Fabric3Details")%>','<%# Eval("FabQuality_ID3")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric3")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <td id="td9f3" runat="server" align="center" style="border-bottom: none !important; border-right: none !important; border-left: none !important; border-top: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent3" runat="server">
                                        <asp:Label ID="lblPercent3" Style="font-size: 8px;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent3ForColor")) %>' title='<%# " ("+Eval("QuantityAvl3").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric3STCAverage").ToString() +")  " %>' runat="server" Visible='<%# Eval("FPerInhouseRead")%>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric3Percent %>'></asp:Label></a>
                                </td>
                                <td id="td10f3" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-left: 1px solid #E6E6E6; border-right: 1px solid #E6E6E6; color: #807F80 !important;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor3").ToString()%>'>
                                     ...
                                     Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' ></asp:TextBox>--%>
                                        <asp:TextBox ID="lblQuantityAvl3" ReadOnly="true" ToolTip='<%# Eval("QuantityAvl3")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,3);" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent3ForColor")) %>' onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,3)" CssClass="numeric-field-without-decimal-places CursorPint" Style="font-size: 8px !important; width: 85%; height: 10px; background: transparent" runat="server" Text='<%# Eval("FinalOrderFabric3_k")%>' Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                ...
                                <td align="center" id="tdfab3Fbricinhouse" runat="server" style="border-bottom: none !important; border-right: 1px solid #E6E6E6; border-top: 0px !important; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor3").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="txtinhouseqntyfab3" ReadOnly="true" ToolTip='<%# Eval("fab3CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; height: 10px; width: 24px; font-size: 8px !important; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab3InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,3);"></asp:TextBox>
                                ...
                                <td id="td11f3" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric3Required_ToolTip").ToString()+" " %>' runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-left: none !important; border-right: 0px !important;">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric3" ToolTip='<%# Eval("Fabric3Required_ToolTip")%>' Style="font-size: 8px !important;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent3ForColor")) %>' Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric3")%>'></asp:Label>
                                    </div>
                            ...
                            <tr id="trthirdprint" visible="false" runat="server">
                                <td id="td1p3" runat="server" align="left" height="15px" style="border-left: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6; border-top: none !important; border-right: none !important; width: 155px; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric3Details")%>&TradeName=<%# Eval("Fabric3")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric3StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric3Details")%>&TradeName=<%# Eval("Fabric3")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric3StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric3StageSelect").ToString().Trim() == "False" ) ?"Stage Selection Not Done":"Raise & Revise Po" %>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric3Details" Style="font-size: 8px; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval3ForColor")) %>' Text='<%# Eval("Fabric3Details")%>'></asp:Label>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor3" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus3ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F7BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F7BulkStatus%>'></asp:Label>
                                </td>
                                <td id="td3p3" runat="server" align="left" style="margin: 0px !important; padding: 0px !important; text-transform: capitalize; border-top: 1px solid #e6e6e6; border-left: 1px solid #e6e6e6; border-bottom: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; font-size: 8px; background-color: transparent;">
                                    <div style="width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <%--Added By Ashish on 24/3/2015--%>
                                        <asp:TextBox ID="lblSummary3" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' CssClass="do-not-allow-typing" Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" Width="45" runat="server" Text='<%# Eval("TotalSummary3")%>'></asp:TextBox>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <%--<asp:Label ID="lblPercent3" runat="server" Text='<%# Eval("Percent3")%>'></asp:Label></td>--%>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA3BackColor").ToString() %>'>
                                        <%--  <span id="divFab3" runat="server">--%>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <%-- //added by sushil on date 30/3/2015--%>
                                        <asp:TextBox ID="txtStrikeof3" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor3"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor3"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff3');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff3ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff3ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff3ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff3ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff3ETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("StrikeOff3ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA3BackColor").ToString() %>'>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab3StartEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabStartETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA3ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric3ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric3ETA")).ToString("dd MMM")%>'></asp:TextBox></a>
                                        <%--END--%>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 15px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA3BackColor").ToString() %>'>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab3EndEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA3ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric3ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric3ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        <%-- </a>--%>
                                    </div>
                                    <%--   </span>--%>
                                </td>
                            ...
                            <tr id="trfourFabric" visible="false" runat="server">
                                <td id="td10f4" runat="server" height="15px" style="border-bottom: #e6e6e6 1px solid; border-right-style: none !important; border-top-style: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric4NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric4name" style="text-align: left; font-size: 8px; cursor: pointer; color: Blue; font-weight: bold; word-break: break-all;" title='<%# Eval("Fabric4CCGSM")%>'>
                                            <%# Eval("Fabric4")%></span>
                                        ...
                                        <asp:Label ID="lblFab4" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric4NameForColor")) %>' Text='<%# Eval("Fabric4")%>' CssClass="FabricCls1"></asp:Label>
                                ...
                                <td id="td11f4" runat="server" visible="false" align="center" style="border-top: none !important; border-right: none !important; border-bottom: none !important;">
                                    <asp:Label ID="lblFabric4OrderAverage" Style="font-size: 8px !important; cursor: pointer; color: #807F80 !important;" runat="server" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric4OrderAverage")%>'></asp:Label>
                                </td>
                                <td id="td2p4" runat="server" align="center" style="border-bottom-style: none !important; border-left: #e6e6e6 1px solid; border-top-style: none !important; color: #807f80 !important; padding-top: 2px !important; text-align: center;">
                                    <asp:Label ID="lblFabric4STCAverage" runat="server" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent4ForColor")) %>' ReadOnly="true" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric4STCAverage")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth4" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent4ForColor")) %>' Visible="false"></asp:Label>
                                    <%--Added By Ashish on 1/1/2015--%>
                              ...
                              <asp:HyperLink ID="viewolay4" ToolTip="VIEW CAD File" runat="server" style="display:none;" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/info.jpg" Text=""></asp:HyperLink>
                                ...
                                <td style="min-width: 90px; border-top: 0px !important; position: relative;" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName4" runat="server" Text='<%# Eval("FabricStages4")%>'></asp:Label>
                                        <asp:Label ID="Label5" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages4_ToolTip")%>'></asp:Label>
                                    </div>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick="FabricAmPerFormanceRe('<%# Eval("Fabric4Details")%>','<%# Eval("FabQuality_ID4")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric4")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <td id="td12f4" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: none !important; border-left: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent4" runat="server">
                                        <asp:Label ID="lblPercent4" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent4ForColor")) %>' title='<%# " ("+Eval("QuantityAvl4").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric4STCAverage").ToString() +")  " %>' Style="font-size: 8px;" Visible='<%# Eval("FPerInhouseRead")%>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric4Percent %>'></asp:Label></a>
                                </td>
                                <td id="td13f4" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: 1px solid #E6E6E6; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor4").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="lblQuantityAvl4" ReadOnly="true" ToolTip='<%# Eval("QuantityAvl4")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,4);" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent4ForColor")) %>' onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,4)" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; font-size: 8px !important; width: 85%; height: 10px; padding-top: 4px; background: transparent" runat="server" Text='<%# Eval("FinalOrderFabric4_k")%>' Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                        <asp:HiddenField ID="hdnQuantityAvl4" runat="server" Value='<%# Eval("QuantityAvl4")%>' />
                                        <asp:HiddenField ID="hdnFinalOrderFabric4_k" runat="server" Value='<%# Eval("FinalOrderFabric4_k")%>' />
                                    </div>
                                </td>
                                <td align="center" id="tdfab4Fbricinhouse" runat="server" style="border-bottom: none !important; border-top: 0px !important; border-right: 1px solid #E6E6E6; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor4").ToString()%>'>
                                        ...
                                        <asp:TextBox ID="txtinhouseqntyfab4" ReadOnly="true" ToolTip='<%# Eval("fab4CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent1ForColor")) %>' CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; height: 10px; width: 24px; font-size: 8px !important; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab4InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,4);"></asp:TextBox>
                                ...
                                <td id="td14f4" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric4Required_ToolTip").ToString()+" " %>' runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-left: none !important; border-right: 0px !important">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric4" ToolTip='<%# Eval("Fabric4Required_ToolTip")%>' Style="font-size: 8px !important;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent4ForColor")) %>' Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric4")%>'></asp:Label>
                                    </div>
                            ...
                            <tr id="trfourprint" runat="server" visible="false">
                                <td id="td1p4" runat="server" align="left" height="21px" style="border-top: none !important; border-right: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric4Details")%>&TradeName=<%# Eval("Fabric4")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric4StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric4Details")%>&TradeName=<%# Eval("Fabric4")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric4StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric4StageSelect").ToString().Trim() == "False" ) ?"Stage Selection Not Done":"Raise & Revise Po" %>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric4Details" Style="font-size: 8px; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval4ForColor")) %>' Text='<%# Eval("Fabric4Details")%>'></asp:Label>
                                ...
                                (<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F8BulkStatus%>)</label>--%>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor4" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus4ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F8BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F8BulkStatus%>'></asp:Label>
                                </td>
                                <td id="td3p4" runat="server" align="left" style="margin: 0px !important; padding: 0px !important; text-transform: capitalize; border-top: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; font-size: 8px; background-color: transparent;">
                                    <div style="border-right: 1px solid #E6E6E6; width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <%--Added By Ashish on 24/3/2015--%>
                                        <asp:TextBox ID="lblSummary4" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' CssClass="do-not-allow-typing" Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" Width="45" runat="server" Text='<%# Eval("TotalSummary4")%>'></asp:TextBox>
                                        <%--END--%>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA4BackColor").ToString() %>'>
                                        <%--<span id="divFab4" runat="server">--%>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <%-- //added by sushil on date 30/3/2015--%>
                                        <asp:TextBox ID="txtStrikeof4" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor4"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor4"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff4');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff4ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff4ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff4ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff4ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff4ETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("StrikeOff4ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA4BackColor").ToString() %>'>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab4StartEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabStartETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA4ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric4ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric4ETA")).ToString("dd MMM")%>'></asp:TextBox></a>
                                        <%--END--%>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA4BackColor").ToString() %>'>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        ...
                                        href="#">--%>
                                        <asp:TextBox ID="lblFab4EndEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA4ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric4ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric4ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        <%--END--%>
                                        </a>
                            ...
                            <%--      code added by bharat on 7-june --%>
                            <tr id="trfiveFabric" visible="false" runat="server">
                                <td id="td10f5" runat="server" height="15px" style="border-bottom: #e6e6e6 1px solid; border-right-style: none !important; border-top-style: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric5NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric5name" style="text-align: left; font-size: 8px; cursor: pointer; color: Blue; font-weight: bold; word-break: break-all;" title='<%# Eval("Fabric5CCGSM")%>'>
                                            <%# Eval("Fabric5")%></span>
                                        <asp:Label ID="lblFab5" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric5NameForColor")) %>' Text='<%# Eval("Fabric5")%>' CssClass="FabricCls1"></asp:Label>
                                ...
                                <td id="td11f5" runat="server" visible="false" align="center" style="border-top: none !important; border-right: none !important; border-bottom: none !important;">
                                    <asp:Label ID="lblFabric5OrderAverage" Style="font-size: 8px !important; cursor: pointer; color: #807F80 !important;" runat="server" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric5OrderAverage")%>'></asp:Label>
                                </td>
                                <td id="td2p5" runat="server" align="center" style="border-bottom-style: none !important; border-left: #e6e6e6 1px solid; border-top-style: none !important; color: #807f80 !important; padding-top: 2px !important; text-align: center;">
                                    <asp:Label ID="lblFabric5STCAverage" runat="server" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' ReadOnly="true" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric5STCAverage")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth5" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' Visible="false"></asp:Label>
                                </td>
                                <td style="min-width: 90px; border-top: 0px !important; position: relative;" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName5" runat="server" Text='<%# Eval("FabricStages5")%>'></asp:Label>
                                        <asp:Label ID="Label6" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages5_ToolTip")%>'></asp:Label>
                                    </div>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick="FabricAmPerFormanceRe('<%# Eval("Fabric5Details")%>','<%# Eval("FabQuality_ID5")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric5")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <td id="td12f5" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: none !important; border-left: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent5" runat="server">
                                        <asp:Label ID="lblPercent5" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' title='<%# " ("+Eval("QuantityAvl5").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric5STCAverage").ToString() +")  " %>' Style="font-size: 8px;" Visible='<%# Eval("FPerInhouseRead")%>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric5Percent %>'></asp:Label></a>
                                </td>
                                <td id="td13f5" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: 1px solid #E6E6E6; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor5").ToString()%>'>
                                        <asp:TextBox ID="lblQuantityAvl5" ReadOnly="true" ToolTip='<%# Eval("QuantityAvl5")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,5);" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,5)" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; font-size: 8px !important; width: 85%; height: 10px; padding-top: 4px; background: transparent" runat="server" Text='<%# Eval("FinalOrderFabric5_k")%>' Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                ...
                                <td align="center" id="tdfab5Fbricinhouse" runat="server" style="border-bottom: none !important; border-top: 0px !important; border-right: 1px solid #E6E6E6; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor5").ToString()%>'>
                                        <asp:TextBox ID="txtinhouseqntyfab5" ReadOnly="true" ToolTip='<%# Eval("fab5CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; height: 10px; width: 24px; font-size: 8px !important; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab5InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,5);"></asp:TextBox>
                                ...
                                <td id="td14f5" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric5Required_ToolTip").ToString()+" " %>' runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-left: none !important; border-right: 0px !important">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric5" ToolTip='<%# Eval("Fabric5Required_ToolTip")%>' Style="font-size: 8px !important;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent5ForColor")) %>' Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric5")%>'></asp:Label>
                                    </div>
                            ...
                            <tr id="trfiveprint" visible="false" runat="server">
                                <td id="td1p5" runat="server" align="left" height="21px" style="border-top: none !important; border-right: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric5Details")%>&TradeName=<%# Eval("Fabric5")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric5StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric5Details")%>&TradeName=<%# Eval("Fabric5")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric5StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric5StageSelect").ToString().Trim() == "False" ) ?"Stage Selection Not Done":"Raise & Revise Po" %>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric5Details" Style="font-size: 8px; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval5ForColor")) %>' Text='<%# Eval("Fabric5Details")%>'></asp:Label>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor5" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus5ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F9BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F9BulkStatus%>'></asp:Label>
                                </td>
                                <td id="td3p5" runat="server" align="left" style="margin: 0px !important; padding: 0px !important; text-transform: capitalize; border-top: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; font-size: 8px; background-color: transparent;">
                                    <div style="border-right: 1px solid #E6E6E6; width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <asp:TextBox ID="lblSummary5" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' CssClass="do-not-allow-typing" Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" Width="45" runat="server" Text='<%# Eval("TotalSummary5")%>'></asp:TextBox>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA5BackColor").ToString() %>'>
                                        <asp:TextBox ID="txtStrikeof5" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor5"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor5"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff5');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff5ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff5ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff5ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff5ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff5ETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("StrikeOff5ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA5BackColor").ToString() %>'>
                                        <asp:TextBox ID="lblFab5StartEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabStartETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA5ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric5ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric5ETA")).ToString("dd MMM")%>'></asp:TextBox></a>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA5BackColor").ToString() %>'>
                                        <asp:TextBox ID="lblFab5EndEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA5ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric5ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric5ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        </a>
                                    </div>
                                </td>
                            </tr>
                            <tr id="trSixFabric" visible="false" runat="server">
                                <td id="td10f6" runat="server" height="15px" style="border-bottom: #e6e6e6 1px solid; border-right-style: none !important; border-top-style: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <div style='border-bottom: none !important; border-right: none !important; <%# "background-color :" + Eval("Fabric6NameBackColor").ToString() %>'>
                                        <span runat="server" id="fabric6name" style="text-align: left; font-size: 8px; cursor: pointer; color: Blue; font-weight: bold; word-break: break-all;" title='<%# Eval("Fabric6CCGSM")%>'>
                                            <%# Eval("Fabric6")%></span>
                                        <asp:Label ID="lblFab6" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Fabric6NameForColor")) %>' Text='<%# Eval("Fabric6")%>' CssClass="FabricCls1"></asp:Label>
                                ...
                                <td id="td11f6" runat="server" visible="false" align="center" style="border-top: none !important; border-right: none !important; border-bottom: none !important;">
                                    <asp:Label ID="lblFabric6OrderAverage" Style="font-size: 8px !important; cursor: pointer; color: #807F80 !important;" runat="server" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric6OrderAverage")%>'></asp:Label>
                                </td>
                                <td id="td2p6" runat="server" align="center" style="border-bottom-style: none !important; border-left: #e6e6e6 1px solid; border-top-style: none !important; color: #807f80 !important; padding-top: 2px !important; text-align: center;">
                                    <asp:Label ID="lblFabric6STCAverage" runat="server" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' ReadOnly="true" Visible='<%# Eval("FOrdRead")%>' Enabled='<%# Eval("FOrdWrite")%>' Text='<%# Eval("Fabric6STCAverage")%>'></asp:Label>
                                    <asp:Label ID="lblCutwidth6" Style="font-size: 8px; cursor: pointer; background-color: transparent; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' Visible="false"></asp:Label>
                                </td>
                                <td style="min-width: 90px; border-top: 0px !important; position: relative" rowspan="2">
                                    <div class="Stagetooltip">
                                        <asp:Label ID="lblStageName6" runat="server" Text='<%# Eval("FabricStages6")%>'></asp:Label>
                                        <asp:Label ID="Label7" class="lblStage1Val" runat="server" Text='<%# Eval("FabricStages6_ToolTip")%>'></asp:Label>
                                    </div>
                                    <span style="right: 0; position: absolute; bottom: -2px; cursor: pionter" onclick="FabricAmPerFormanceRe('<%# Eval("Fabric6Details")%>','<%# Eval("FabQuality_ID6")%>','<%# Eval("OrderDetailID")%>','<%# Eval("Fabric6")%>')" title="Fabric AM Performance Report">
                                        <img src="../../images/viewicon.png" style="width: 20px; cursor: pointer;" />
                                    </span>
                                </td>
                                <td id="td12f6" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: none !important; border-left: none !important; text-align: center; padding-top: 2px !important;">
                                    <a id="lnkPercent6" runat="server">
                                        <asp:Label ID="lblPercent6" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' title='<%# " ("+Eval("QuantityAvl6").ToString() +" * 100)/("+ Eval("Quantity").ToString() +" * "+ Eval("Fabric6STCAverage").ToString() +")  " %>' Style="font-size: 8px;" Visible='<%# Eval("FPerInhouseRead")%>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricInhouseHistory.Fabric6Percent %>'></asp:Label></a>
                                </td>
                                <td id="td13f6" runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-right: 1px solid #E6E6E6; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor4").ToString()%>'>
                                        <asp:TextBox ID="lblQuantityAvl6" ReadOnly="true" ToolTip='<%# Eval("QuantityAvl6")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,6);" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' onblur="javascript:Set_defualtFinalFabricOrderActualValue(this,6)" CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; width: 85%; height: 10px; font-size: 8px !important; padding-top: 4px; background: transparent" runat="server" Text='<%# Eval("FinalOrderFabric6_k")%>' Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>'></asp:TextBox>
                                ...
                                <td align="center" id="tdfab6Fbricinhouse" runat="server" style="border-bottom: none !important; border-top: 0px !important; border-right: 1px solid #E6E6E6; padding-top: 4px; border-left: 1px solid #E6E6E6;">
                                    <div style='width: 100%; height: 15px; float: left; text-align: center; <%# "background-color :" + Eval("FabricAvgColor4").ToString()%>'>
                                        <asp:TextBox ID="txtinhouseqntyfab6" ReadOnly="true" ToolTip='<%# Eval("fab6CheckInHouse")%>' runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' CssClass="numeric-field-without-decimal-places CursorPint" Style="text-align: center; height: 10px; width: 24px; font-size: 8px !important; background: transparent!important;" Visible='<%# Eval("FRecdRead")%>' Enabled='<%# Eval("FRecdWrite")%>' Text='<%# Eval("Fab6InHouseChecked_k")%>' onclick="javascript:return ManageOrderFabricInHouseHistory(this,6);"></asp:TextBox>
                                ...
                                <td id="td14f6" title='<%# "Fnl Rqrd with Res.shr. " + Eval("Fabric6Required_ToolTip").ToString()+" " %>' runat="server" align="center" style="border-bottom: none !important; border-top: none !important; border-left: none !important; border-right: 0px !important">
                                    <div style="padding-top: 2px; text-align: center;">
                                        <asp:Label ID="lblFinalOrderFabric6" ToolTip='<%# Eval("Fabric6Required_ToolTip")%>' Style="font-size: 8px !important;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("Percent6ForColor")) %>' Visible='<%# Eval("FFabTotalRead")%>' Enabled='<%# Eval("FFabTotalWrite")%>' Text='<%# Eval("FinalOrderFabric6")%>'></asp:Label>
                                    </div>
                            ...
                            <tr id="trsixprint" visible="false" runat="server">
                                <td id="td1p6" runat="server" align="left" height="21px" style="border-top: none !important; border-right: none !important; border-left: 0px !important; padding-left: 1px !important;">
                                    <a href='../../Internal/Fabric/PendingOrderSummary.aspx?FabricDetails=<%# Eval("Fabric6Details")%>&TradeName=<%# Eval("Fabric6")%>&OrderID=<%# Eval("OrderID")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric6StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-open-in-popup-26.png": "../../App_Themes/ikandi/images/icons8-open-in-popup-27.png" %>' alt="Image missing" />
                                    </a><a href='../../Internal/Fabric/FabricViewAll.aspx?FabricDetails=<%# Eval("Fabric6Details")%>&TradeName=<%# Eval("Fabric6")%>' target="_blank" title="Pending Orders Screen (From Order Form To Supplier Negotiation)">
                                        <img src='<%#(Eval("Fabric6StageSelect").ToString().Trim() == "False" ) ? "../../App_Themes/ikandi/images/icons8-r-24Blu.png": "../../App_Themes/ikandi/images/icons8-r-24Grn.png" %>' alt="Image missing" title='<%#(Eval("Fabric5StageSelect").ToString().Trim() == "False" ) ?"Stage Selection Not Done":"Raise & Revise Po"%>' style="height: 12px; width: 12px" />
                                    </a>
                                    <asp:Label ID="lblFabric6Details" Style="font-size: 8px; font-weight: bold;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BulkApproval6ForColor")) %>' Text='<%# Eval("Fabric6Details")%>'></asp:Label>
                                    <br />
                                    <asp:Label ID="lblfabricApprovalColor6" Font-Size="8px" Font-Bold="true" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TractStatus6ForColor")) %>' CssClass='<%#((Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F10BulkStatus.ToString().Trim() == "" ) ? "hide_me": "" %>' Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).FabricApprovalDetails.F10BulkStatus%>'></asp:Label>
                                </td>
                                <td id="td3p6" runat="server" align="left" style="margin: 0px !important; padding: 0px !important; text-transform: capitalize; border-top: 1px solid #e6e6e6; border-right: 1px solid #e6e6e6; font-size: 8px; background-color: transparent;">
                                    <div style="border-right: 1px solid #E6E6E6; width: 47px; float: left; height: 21px; padding-top: 5px;">
                                        <asp:TextBox ID="lblSummary6" Visible='<%#Eval("FFabSummaryRead") %>' Enabled='<%#Eval("FFabSummaryWrite") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SummryColor")) %>' CssClass="do-not-allow-typing" Style="text-transform: capitalize; font-size: 8px; background-color: transparent;" Width="45" runat="server" Text='<%# Eval("TotalSummary6")%>'></asp:TextBox>
                                        <%--END--%>
                                    </div>
                                </td>
                                <td colspan="2">
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA6BackColor").ToString() %>'>
                                        <asp:TextBox ID="txtStrikeof6" Width="50px" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfBackColor6"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StrikeOfForeColor6"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'StrikeOff6');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("StrikeOff6ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff6ETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("StrikeOff6ETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("StrikeOff6ETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("StrikeOff6ETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("StrikeOff6ETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </div>
                                </td>
                                <td>
                                    <div style='width: 53px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("StartETA6BackColor").ToString() %>'>
                                        <asp:TextBox ID="lblFab6StartEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabStartETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("StartETA6ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("fabric6ETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("fabric6ETA")).ToString("dd MMM")%>'></asp:TextBox></a>
                                    </div>
                                </td>
                                <td style="border-right: 0px !important;">
                                    <div style='width: 54px; height: 21px; padding-top: 5px; float: left; text-align: center; <%# "background-color :" + Eval("ENDETA6BackColor").ToString() %>'>
                                        <asp:TextBox ID="lblFab6EndEta" Enabled="false" CssClass="do-not-allow-typing" Visible='<%# Eval("FFabEndETARead")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ENDETA6ForColor")) %>' Style="text-align: center; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Width="52px" Text='<%# (Convert.ToDateTime(Eval("Fabric6ENDETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("Fabric6ENDETA")).ToString("dd MMM")%>'></asp:TextBox>
                                        </a>
                                    </div>
                                </td>
                            </tr>
                    ...
                    <div style="font-size: 9px; color: #0000ee; width: 100%; padding-top: 5px; min-height: 26px; text-align: left;">
                        <asp:Label ID="lbldfabricelaytaskname" runat="server" ToolTip="Fabric Section Delay Task" Text='<%# Eval("FabricDelayTask")%>'></asp:Label>
                    </div>
                    <%--end by abhishek--%>
                    <div style="text-align: left; vertical-align: bottom; bottom: 0px; border: none !important; width: 100%;">
                        <table width="100%" border="0" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="3" style="border: none !important;">
                                    <div style="width: 100%;">
                                        <div style="padding-right: 5px; display: none; text-align: left; float: left;">
                                            <asp:Label ID="lblFabUserName" Style="font-size: 8px !important; color: #606060 !important;" runat="server"></asp:Label>
                                        </div>
                                        <div style="width: 58%; display: none; text-align: left; float: left;">
                                            <asp:Label ID="lblFabRemark" Style="font-size: 8px !important; text-transform: capitalize !important; color: #807F80 !important;" runat="server"> </asp:Label>
                                        </div>
                                        <div style="text-align: right; float: right; display: none;" id="spanFabTracking" runat="server">
                ...
                <ItemStyle Width="426px"></ItemStyle>
            </asp:TemplateField>
            <asp:TemplateField ItemStyle-VerticalAlign="Middle">
                ...
                <ItemTemplate>
                    <div style="text-align: center; width: 100%;">
                        <div>
                            <div id="dvBIHAccessories" runat="server" style="text-align: center; padding-top: 5px; padding-bottom: 5px; width: 100%;">
                                <a href='/Internal/Accessory/AccessoryOrderSummaryPrint.aspx?orderid=<%# Eval("OrderID")%>' target="_blank" title="Accessory Order Form">
                                    <asp:Label ID="LabelAccBIHname" Style="font-size: 11px;" runat="server" ToolTip="Accessory Order Form" Visible='<%# Eval("FBIHDateRead") %>' Text="B.I.H : "></asp:Label>
                                    <asp:Label ID="lblACCBulkInhouseTgt" Style="font-size: 11px; font-weight: bold; font-family: Arial;" runat="server" Text='<%# (Convert.ToDateTime(Eval("BulkAccsesoryTarget")) == Convert.ToDateTime("1/1/1900")) ? "" : Convert.ToDateTime(Eval("BulkAccsesoryTarget")).ToString("dd MMM yy (ddd)")%>' Visible='<%# Eval("FBIHDateRead")%>'></asp:Label>&nbsp<span style="font-size: 8px;"></span></a>
                            </div>
                        </div>
                        <div style="min-height: 252px; width: 100%;">
                            <asp:Repeater ID="repAccess" runat="server" OnItemDataBound="repAccess_ItemDataBound">
                                <ItemTemplate>
                                    <table border="0" style="width: 100%;" cellpadding="0" cellspacing="0">
                                        <tr>
                                            <td style="min-width: 125px; max-width: 125px; border-left: 0px !important; padding-left: 1px !important; border-bottom: 1px solid #e0e0e0 !important; <%# "background-color :" + Eval("AccessNameBackColor").ToString() %>">
                                                <asp:Label ID="lblAccessQuality" Font-Bold="true" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("AccessNameForColor")) %>' runat="server" Text=""></asp:Label>
                                                <div>
                                                    <a href='../../Internal/Accessory/PendingAccessorySummary.aspx?OrderId=<%# Eval("OrderId")%>&AccessoryMasterId=<%# Eval("AccessoryMasterId")%>&Size=<%# Eval("Size")%>&ColorPrint=<%# Eval("Color_Print")%>' target="_blank" title="Pending Accessory Orders Screen">
                                                        <img id="imgPending" runat="server" src="../../App_Themes/ikandi/images/icons8-open-in-popup-26.png" alt="Image missing" />
                                                    </a><a href='../../Internal/Accessory/AccessoryOrderPlacement.aspx?AccessoryName=<%# Eval("AccessoriesName")%>&stage1=<%# Eval("Stage1")%>' target="_blank" title="Raise & Revise Accessory Po">
                                                        <img id="img1" runat="server" src="../../App_Themes/ikandi/images/icons8-r-24Blu.png" alt="Image missing" style="width: 12px; height: 12px" />
                                                    </a>
                                                    <asp:Label ID="lblAccessColorPrint" CssClass="positiorelative" Font-Bold="true" Text='<%# Eval("Color_Print")%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("AccessPrintForColor")) %>' runat="server"></asp:Label>
                                                </div>
                                            ...
                                            <td style="min-width: 90px; max-width: 90px; border-bottom: 1px solid #e0e0e0 !important; vertical-align: middle !important;">
                                                <div class="Stagetooltip">
                                                    <asp:Label ID="lblAccessGriege" runat="server" Text='<%# Eval("Griege_Finish_Stage")%>'></asp:Label></br>
                                                    <asp:Label ID="lblAccessProcess" Text='<%# Eval("Process_Stage")%>' runat="server"></asp:Label>
                                                    <asp:Label ID="lblStageTooltip" Text='<%# Eval("Griege_Finish_Stage_tooltip")%>' class="lblStage1Val" runat="server"></asp:Label>
                                                </div>
                                                <img src="../../images/viewicon.png" style="width: 17px; cursor: pointer; position: relative; bottom: -4px; float: right;" onclick="AccessoryAmPerformanceReport('<%# Eval("OrderDetailWorkingDetailID")%>','<%# Eval("OrderDetailsID")%>','<%# Eval("AccessoriesName")%>','<%# ((String)Eval("Size")).Replace("\"","") %>', '<%# Eval("Color_Print")%>')" title="Accessory AM Performance Report" />
                                            </td>
                                            <td style="min-width: 27px; border-bottom: 1px solid #e0e0e0 !important; vertical-align: middle!important; text-align: center; <%# "background-color :" + Eval("AccessPercentInhouseBackColor").ToString() %>">
                                                <asp:Label ID="lblAccessInHouse" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("AccessPercentInhouseForColor")) %>' Text="" runat="server"></asp:Label>
                                            </td>
                                            <td id="tdAccessOrderOn" runat="server" style="min-width: 40px; vertical-align: middle!important; border-bottom: 1px solid #e0e0e0 !important; text-align: center;">
                                                <asp:Label ID="lblAccessOrderOn" Text="" runat="server"></asp:Label>
                                            </td>
                                            <td style="min-width: 50px; vertical-align: middle !important; border-bottom: 1px solid #e0e0e0 !important; text-align: center;">
                                                <asp:Label ID="lblAccessRecQty" CssClass="CursorPint" onclick="javascript:return frmOpenInHouseAcc_Issue(this);" Text="" runat="server"></asp:Label>
                                                <asp:Label ID="lblAccessIssuedQty" Font-Bold="true" ForeColor="Blue" runat="server"></asp:Label>
                                                <asp:TextBox ID="txtQuantityAvail" onchange="javascript:return CalculationonAcc(this);" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("AccessCaptionForColor")) %>' Style="background-color: transparent; font-size: 8px;" runat="server" onblur="javascript:Set_defualtFinalAccsessoryOrderActualValue(this)" onclick="SetFinalAccsessoryOrderActualValue(this)" MaxLength="10"></asp:TextBox>
                                            ...
                                            <td style="min-width: 30px; vertical-align: middle !important; border-bottom: 1px solid #e0e0e0 !important; text-align: center;">
                                                <asp:Label ID="lblAccessTotalQty" Text="" runat="server"></asp:Label>
                                            </td>
                                            <td style="min-width: 40px; vertical-align: middle; border-bottom: 1px solid #e0e0e0 !important; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("AccessETABackColor").ToString() %>">
                                                <asp:Label ID="lblAccesActuakDate" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("AccessETAForColor")) %>' Text="" runat="server"></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </ItemTemplate>
                        ...
                        <div style="font-size: 9px; color: #0000ee; width: 100%; text-align: left; padding-top: 5px; min-height: 26px;">
                            <asp:Label ID="lblAccessoriesDelaytask" ToolTip="Accessories Section Delay Task" runat="server" Text='<%# Eval("AccessoriesDelayTask")%>'></asp:Label>
                        </div>
                        <div style="width: 100%;">
                            <table width="100%" border="0" cellpadding="0" cellspacing="0" style="border: none; font-size: 10px;">
                                <tr>
                                    <td style="width: 33%; border: none !important; display: none">
                                        <asp:Label ID="lblRName" Style="font-size: 8px !important; color: #807F80 !important;" runat="server"></asp:Label>
                                    </td>
                                    <td align="left" style="width: 77%; text-align: left; border: none !important; display: none">
                                        <asp:Label ID="lblAccessoriesRemark" Style="font-size: 8px !important; color: #807F80 !important; text-transform: capitalize !important;" runat="server"> </asp:Label>
                                    </td>
                                    <td style="width: 7%; border: none !important; text-align: right">
                                        ...
                                        <a id="lnkAccesspopup" runat="server">
                                            <img alt="Shipping Remarks" title="CLICK TO SEE REMARKS POPUP" src="../../App_Themes/ikandi/images/zoom_icon.gif" style="cursor: pointer;" border="0" /></a>
                                        <%-- //end by abhishek --%>
                ...
                <ItemTemplate>
                    <div style='width: 100%; float: left; text-align: center; line-height: 25px; <%# "background-color :" + Eval("PCDBackColor").ToString() %>'>
                        ...
                        <div style="cursor: pointer;" onclick="ShowCuttinglistprint(this,'<%#(Eval("OrderDetailID"))%>','<%#(Eval("Mode"))%>','<%#(Eval("Mode"))%>')">
                            ...
                            <asp:Label ID="Labelpcdname" Style="font-size: 11px; cursor: pointer;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("PCDForeColor")) %>' Visible='<%# Eval("FitsPCDRead") %>' Text="PCD : "></asp:Label>
                            <asp:Label ID="lblpcd" Style="font-size: 11px; font-weight: bold; font-family: Arial; cursor: pointer;" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("PCDForeColor")) %>' Visible='<%# Eval("FitsPCDRead") %>' Text='<%# (Convert.ToDateTime(Eval("PCDDate")) == Convert.ToDateTime("1/1/1900") || Convert.ToDateTime(Eval("PCDDate")) == Convert.ToDateTime("01/01/0001")) ? "" : (Convert.ToDateTime(Eval("PCDDate"))).ToString("dd MMM yy (ddd)")%>'></asp:Label>
                            <%-- </a>--%>
                        </div>
                    ...
                    <div style="width: 100%; float: left; height: 20px;">
                        ...
                        <div class="newtext7" style="width: 52%; float: left; text-align: left;">
                            <span style="font-size: 8px !important; color: #666 !important; text-transform: !important;">
                                <asp:Label ID="Labelsamcap" ToolTip="Costing SAM" runat="server" Text='<%#Eval("Samcap") %>' Visible='<%# Eval("FitsCostingSAMRead") %>' Enabled='<%# Eval("FitsCostingSAMWrite") %>'></asp:Label></span> <a href="javascript:void(0)" onclick="showOBSheet('<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID.ToString() %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.sCodeVersion.ToString() %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Fits.StyleCodeVersion %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.client.ClientID %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.cdept.DeptID %>','<%#(Eval("OrderID"))%>','Yes')">
                                    <asp:Label ID="Label15" ToolTip="OB Sheet" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SamOBValColor")) %>' Style="font-size: 8px !important; font-weight: bold;" Text='<%#Eval("Samval") %>' Visible='<%# Eval("FitsCostingSAMRead") %>' Enabled='<%# Eval("FitsCostingSAMWrite") %>'></asp:Label>
                                </a><span style="font-size: 8px !important; color: #666 !important; text-transform: Uppercase !important;">&nbsp;
                                    <asp:Label ID="Label11" runat="server" Text="OB:" Visible='<%# Eval("FitsOBRead") %>' Enabled='<%# Eval("FitsOBWrite") %>'></asp:Label>
                                </span>
                            <asp:Label ID="lblOB" ToolTip="OB (Planned OB/Actual OB)" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SamOBValColor")) %>' Style="font-size: 8px !important; font-weight: bold;" Text='<%#Eval("OBval") %>' Visible='<%# Eval("FitsOBRead") %>' Enabled='<%# Eval("FitsOBWrite") %>'></asp:Label>
                        </div>
                        <div class="newtext7" style="width: 47%; float: left; text-align: right;">
                            <%--<asp:Label ID="lblst" runat="server" Text="St:" Style="color: gray; font-size: 8px" onclick="GetCMTInfo('<%#Eval("OrderDetailID")%>')" ></asp:Label> --%>
                            <a href="javascript:void(0)" class="" title="CLICK TO ST" onclick="GetCMTInfo('<%#Eval("OrderDetailID")%>')">
                                <asp:Label ID="lblst" runat="server" Text="St:" Style="color: gray; font-size: 8px; color: Blue;"></asp:Label>
                            </a>
                            ...
                            <asp:TextBox ID="txtProPlaningETA" onchange="javascript:return UpdatePatternSampleDateForMO(this,'RPODUCTIONPLANINGETA');" Style="font-size: 8px !important background-color: #F9F9FA !important; width: 65px; border: 1px solid grey; text-transform: capitalize !important;" runat="server" CssClass="th do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("ProductionPlanningETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("ProductionPlanningETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("ProductionPlanningETA")).ToString("dd MMM yy (ddd)") %>'></asp:TextBox>
                    ...
                    <div style='text-align: center; width: 100%; float: left; line-height: 13px; <%# "background-color :" + Eval("FitsPandingColor").ToString() %>'>
                        <asp:Label ID="lblFitsStatus" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("LinktypeForeColorforfitspending")) %>' Style="text-transform: capitalize !important; font-size: 8px !important; font-weight: bold; letter-spacing: -0.5px; cursor: pointer;" runat="server" Visible='<%# Eval("FitsStatusRead")%>'></asp:Label>
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <asp:TextBox ID="txtFitsETA" runat="server" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsPandingColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("LinktypeForeColorforfitspending")) %>' Visible='<%# Eval("FitsETADateRead")%>' Enabled='<%# Eval("FitsETADateWrite")%>' CssClass="do-not-allow-typing" Style="width: 50px; font-size: 8px; display: none; text-transform: capitalize; border: 1px solid #d6d7d8; background: none; color: #000;" Text='<%# (Convert.ToDateTime(Eval("FitsETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("FitsETA")).ToString("dd MMM")%>'></asp:TextBox>
                    </div>
                    <div style="text-align: center; width: 100%; font-size: 8px; line-height: 10px; min-height: 215px;">
                        <table width="100%" cellpadding="0" cellspacing="0" style="border-collapse: collapse;">
                            <tr id="apprShow" runat="server">
                                <td id="tdHandover" runat="server" style="color: #807F80 !important; border-left: 0px !important; text-align: left; line-height: 21px;">
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblHandOverTargetDate" ToolTip="Hand Over TargetDate" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("HandOverTargetDate")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("HandOverTargetDate"))).ToString("dd MMM")%>'></asp:Label>
                                        </div>
                                        <asp:TextBox ID="txHandoverActual" Enabled='<%# Eval("FitsProdActualDateWrite")%>' Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("HandOverActualDate")) == Convert.ToDateTime("1/1/0001")||Convert.ToDateTime(Eval("HandOverActualDate")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("HandOverActualDate")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("HandOverETABackColor").ToString() %>'>
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <asp:TextBox ID="txtHanoverETA" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("HandOverETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("HandOverETAForeColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'HandOver');" Width="70" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("HandOverETADate")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("HandOverETADate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("HandOverETADate")).ToString("dd MMM") %>'></asp:TextBox>
                                    <%--END--%>
                                </td>
                            </tr>
                            <tr id="apprShow1" runat="server">
                                <td id="tdPatternReady" runat="server" style="color: #807F80 !important; border-left: 0px !important; text-align: left; line-height: 21px;">
                                    <asp:Label ID="lblPatternReady" runat="server" Text="Pattern Ready"></asp:Label>
                                </td>
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblPatternReadyTargetDate" ToolTip="Pattern Ready TargetDate" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PatternReadyTargetDate")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("PatternReadyTargetDate"))).ToString("dd MMM")%>'></asp:Label>
                                        </div>
                                        <asp:TextBox ID="txtPatternReadyActualDate" Enabled='<%# Eval("FitsProdActualDateWrite")%>' Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("PatternReadyActualDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("PatternReadyActualDate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("PatternReadyActualDate")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("PatternReadyETABackColor").ToString() %>'>
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <asp:TextBox ID="txtPatternReadyETADate" onchange="javascript:return UpdateCuttingSheetDateForMO(this,'PatternReady');" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("PatternReadyETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("PatternReadyETAForeColor"))%>' Width="70" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PatternReadyETADate")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("PatternReadyETADate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("PatternReadyETADate")).ToString("dd MMM") %>'></asp:TextBox>
                                    <%--END--%>
                                </td>
                            </tr>
                            <tr id="apprShow2" runat="server">
                                <td id="tdSampleSent" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    <%--Added By Ashish on 23/3/2015--%>
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        ...
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblSamplesentTargetDate" ToolTip="Sample Sent TargetDate" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("SampleSentTargetDate")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("SampleSentTargetDate"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--end by abhishek 8/1/2015--%>
                                        </div>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="txtSampleSentActualDate" Enabled='<%# Eval("FitsProdActualDateWrite")%>' Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("SampleSentActualDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("SampleSentActualDate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("SampleSentActualDate")).ToString("dd MMM") %>'></asp:TextBox>
                                        <%--END--%>
                                    </span>
                                </td>
                                <td style='color: #00E; text-align: center; <%# "background-color :" + Eval("SampleSentETABackColor").ToString() %>'>
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <asp:TextBox ID="txtSampleSentETA" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SampleSentETABackColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'SampleSent');" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("SampleSentETAForeColor"))%>' Width="70" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("SampleSentETADate")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("SampleSentETADate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("SampleSentETADate ")).ToString("dd MMM") %>'></asp:TextBox>
                                    <%--END--%>
                                </td>
                            </tr>
                            <tr id="apprShow3" runat="server">
                                <td id="tdFitsCommentesUplaod" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    <%--Added By Ashish on 23/3/2015--%>
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <%-- edited by abhishek on 8/1/2015--%>
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblFitsCommentesUplaodTargetDate" ToolTip="Fits Commentes Upload TargetDate" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("FitsCommentesTargetDate")) == Convert.ToDateTime("1/1/0001")) ? "" : (Convert.ToDateTime(Eval("FitsCommentesTargetDate"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--end by abhishek 8/1/2015--%>
                                        </div>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="txtFitsCommentesUplaodActualDate" Enabled='<%# Eval("FitsProdActualDateWrite")%>' Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("FitsCommentesActualDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("FitsCommentesActualDate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("FitsCommentesActualDate")).ToString("dd MMM") %>'></asp:TextBox>
                                        <%--END--%>
                                    </span>
                                </td>
                                <td style='color: #00E; text-align: center; <%# "background-color :" + Eval("FitsCommentesETABackColor").ToString() %>'>
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <asp:TextBox ID="txtFitsCommentesUplaodETADate" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsCommentesETABackColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'FitsUploadCommentes');" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsCommentesETAForeColor"))%>' Width="70" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("FitsCommentesETADate")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("FitsCommentesETADate")) == Convert.ToDateTime("1/1/0001")) ? "" : Convert.ToDateTime(Eval("FitsCommentesETADate ")).ToString("dd MMM") %>'></asp:TextBox>
                                    <%--END--%>
                                </td>
                            </tr>
                            <tr>
                                <%--Added By Ashish on 12/1/2014 for define width in td--%><%-- color:#807F80 !important;--%>
                                <td id="tdSTC" runat="server" width="37%" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    <asp:Label ID="lblSTCName" runat="server" Text="STC" Visible='<%# Eval("FitsStcRead")%>'></asp:Label>
                                </td>
                                <td width="33%" style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <%--Edited by abhishek on 8/1/2015--%>
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblstctgt" ToolTip="Stc Target Date" Visible='<%# Eval("FitsStcTargetDateRead")%>' CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("STCtargetsDate")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("STCtargetsDate"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--End by abhishek on 8/1/2015--%>
                                        </div>
                                        <div style="height: 10px;">
                                            <asp:Label ID="txtrequested" Visible='<%# Eval("FitsStcActualDateRead")%>' Enabled='<%# Eval("FitsStcActualDateWrite")%>' Style="width: 98%; font-size: 8px !important;" Text='<%#(Eval("ParentOrder") as iKandi.Common.Order).Fits.SealDate.ToString("dd MMM (ddd)") == "01 Jan (Mon)"? "" :(Eval("ParentOrder") as iKandi.Common.Order).Fits.SealDate.ToString("dd MMM")%>' runat="server"></asp:Label>
                                            <%--END--%>
                                        </div>
                                </td>
                                <td width="30%" style='text-align: center; <%# "background-color :" + Eval("FitsSTCETABackColor").ToString() %>'>
                                    <div>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="lblSTCETA" runat="server" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsSTCETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsSTCETAForColor"))%>' Visible='<%# Eval("FitsSTCETARead")%>' CssClass="do-not-allow-typing" Style="width: 83px; font-size: 8px; text-transform: capitalize;" Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).Fits.SealDate.ToString("dd MMM (ddd)") == "01 Jan (Mon)" ? (Convert.ToDateTime(Eval("STCETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("STCETA")).ToString("dd MMM") : (Eval("ParentOrder") as iKandi.Common.Order).FitsTrack.fitRequestedOn.ToString("dd MMM")%>'></asp:TextBox>
                                        <%--END--%>
                                    </div>
                                    <span id="spanstcpending" style="display: none;" runat="server"><a id="lnksrtcpending" onclick="javascript:return showEtaPopup('STCRequest','FitsETA','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID%>','','','<%# (Convert.ToDateTime(Eval("STCETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("STCETA")).ToString("dd MMM")%>','','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>','','<%#Eval("OrderDetailID") %>',62);">
                                        <asp:TextBox ID="lblstcpending" Visible='<%# Eval("FitsSTCETARead")%>' Enabled='<%# Eval("FitsSTCETAWrite")%>' CssClass="do-not-allow-typing" Style="font-size: 8px !important; color: red !important; background-color: transparent;" runat="server" Width="70" Text='<%# Eval("STCpending")%>'></asp:TextBox></a> </span>
                                </td>
                            </tr>
                            <tr id="apprHide" runat="server">
                                <td id="tdPatternSample" runat="server" style="color: #807F80 !important; border-left: 0px !important; text-align: left; letter-spacing: -0.2px; line-height: 21px;">
                                    <asp:Label ID="lblPatternSampleName" runat="server" Text="Pattern Sample" Visible='<%# Eval("FitsPatternRead")%>'></asp:Label>
                                </td>
                                <td style="color: Black; text-align: center; width: 33%; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <%--Edited by abhishek on 8/1/2015--%>
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblpatterntar" Visible='<%# Eval("FitsPatternTargetDateRead")%>' ToolTip="Pattern Sample Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PatternSampleTarget")) == Convert.ToDateTime("01-01-0001")) ? "" : (Convert.ToDateTime(Eval("PatternSampleTarget"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--End by abhishek on 8/1/2015--%>
                                        </div>
                                        <asp:TextBox class="Pattern" ID="lblPatternSampleDate" Visible='<%# Eval("FitsPatternActualDateRead")%>' Enabled='<%# Eval("FitsPatternActualDateWrite")%>' onchange="javascript:return UpdatePatternSampleDateForMO(this,'Pattern');" Style="width: 98%; font-size: 8px !important; height: 10px; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="th do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("PatternSampleDate")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("PatternSampleDate")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("PatternSampleDate")).ToString("dd MMM") %>'></asp:TextBox>
                                        <%--END--%>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("FitsPatternETABackColor").ToString() %>'>
                                    <div>
                                        <asp:TextBox ID="PATTERNETA" runat="server" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsPatternETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsPatternETAForColor"))%>' Visible='<%# Eval("FitsPatternETARead")%>' Style="font-size: 8px; text-transform: capitalize;" CssClass="do-not-allow-typing" Width="83" Text='<%# (Convert.ToDateTime(Eval("PatternSampleDateETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("PatternSampleDateETA")).ToString("dd MMM")%>'></asp:TextBox>
                                    </div>
                                    <span id="spanPatternpending" style="display: none;" runat="server">
                                        ...
                                        <a onclick="javascript:return showEtaPopup('PatternETA','FitsETA','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID%>','','','<%# (Convert.ToDateTime(Eval("PatternSampleDateETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("PatternSampleDateETA")).ToString("dd MMM")%>','','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>','','<%#Eval("OrderDetailID") %>',63);">
                                            <asp:TextBox ID="lblpatternpending" CssClass="do-not-allow-typing" Style="font-size: 8px !important; color: red !important; background-color: transparent;" runat="server" Width="70" Text='<%# Eval("Patternpending")%>'></asp:TextBox>
                                            <%--END--%>
                                        </a></span>
                                </td>
                            </tr>
                            <tr id="apprHide1" runat="server">
                                ...
                                <td id="tdCuttingSheet" runat="server" style="color: #807F80 !important; border-left: 0px !important; text-align: left; line-height: 21px;">
                                    <asp:Label ID="lblCuttingSheet" runat="server" Text="Cutting Sheet" Visible='<%# Eval("FitsCuttingkRead")%>'></asp:Label>
                                </td>
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblcuttingtar" Visible='<%# Eval("FitsCuttingTargetDateRead")%>' ToolTip="Cutting Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("CuttingTarget")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("CuttingTarget")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("CuttingTarget"))).ToString("dd MMM")%>'></asp:Label>
                                        </div>
                                        <asp:TextBox ID="lblCuttingSheetDate" Visible='<%# Eval("FitsCuttingActualDateRead")%>' Enabled='<%# Eval("FitsCuttingActualDateWrite")%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'Cutting');" Style="width: 98%; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important; height: 10px;" runat="server" CssClass="th do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("CuttingReceivedDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("CuttingReceivedDate")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("CuttingReceivedDate")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("FitsCuttingETABackColor").ToString() %>'>
                                    <asp:TextBox ID="TextBox1" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsCuttingETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsCuttingETAForColor"))%>' Width="96%" onchange="javascript:return UpdateCuttingSheetDateForMO(this,'CuttingETA');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("CuttingReceivedDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("CuttingReceivedDateETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("CuttingReceivedDateETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    <asp:Label ID="lblcutpending" Visible='<%# Eval("FitsCuttingETARead")%>' Enabled='<%# Eval("FitsCuttingETAWrite")%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'CuttingETA');" Style="font-size: 8px !important; display: none; color: red !important;" runat="server" Width="70" Text='<%# Eval("Cuttingpending")%>'></asp:Label>
                                </td>
                            </tr>
                            <%-- END 11/2/2016 --%>
                            <tr id="apprHide2" runat="server">
                                <td id="tdProdFile" runat="server" style="color: #807F80 !important; padding-left: 0px !important; text-align: left; line-height: 21px;">
                                    <%--Added By Ashish on 23/3/2015--%>
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <%-- edited by abhishek on 8/1/2015--%>
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblprodtar" Visible='<%# Eval("FitsProdTargetDateRead")%>' ToolTip="Prod File Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("ProductionFileTarget")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("ProductionFileTarget"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--end by abhishek 8/1/2015--%>
                                        </div>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="lblProductionFileDate" Visible='<%# Eval("FitsProdActualDateRead")%>' Enabled='<%# Eval("FitsProdActualDateWrite")%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'Production');" Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" runat="server" CssClass="th do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("ProductionFileDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("ProductionFileDate")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("ProductionFileDate")).ToString("dd MMM") %>'></asp:TextBox>
                                        <%--END--%>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("FitsProdETABackColor").ToString() %>'>
                                    <%--Added By Ashish on 23/3/2015--%>
                                    <asp:TextBox ID="TextBox2" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsProdETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsProdETAForColor"))%>' Width="96%" onchange="javascript:return UpdateCuttingSheetDateForMO(this,'ProductionETA');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("ProductionFileDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("ProductionFileDateETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("ProductionFileDateETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    <%--END--%>
                                    <asp:Label ID="lblprodfilepending" onchange="javascript:return UpdateCuttingSheetDateForMO(this,'ProductionETA');" Style="font-size: 8px !important; color: red !important; display: none;" runat="server" Width="70" Text='<%# Eval("prodfilepending")%>'></asp:Label>
                                </td>
                            </tr>
                            <tr id="apprHide3" runat="server">
                                <td id="tdHoPPM" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    <%--Added By Ashish on 23/3/2015--%>
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <%--Edited by abhishek on 8/1/2015--%>
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblHOPPMTarget" Visible='<%# Eval("FitsHOPPMTargetDateRead")%>' ToolTip="HO PPM Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("HOPPMTargetETA")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("HOPPMTargetETA"))).ToString("dd MMM")%>'></asp:Label>
                                            <%--End by abhishek on 8/1/2015--%>
                                        </div>
                                        <asp:Label ID="lblHOPPMActual" Visible='<%# Eval("FitsHOPPMActualDateRead")%>' Enabled='<%# Eval("FitsHOPPMActualDateWrite")%>' ToolTip="HO PPM Actual Date" Style="width: 98%; height: 10px; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important;" Text='<%# (Convert.ToDateTime(Eval("HOPPMActionactualDate")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("HOPPMActionactualDate")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("HOPPMActionactualDate")).ToString("dd MMM") %>' runat="server"></asp:Label>
                                    </span>
                                </td>
                                <%--Added By Ashish on 12/1/2014 for span ETA--%>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("FitsHOPPMETABackColor").ToString() %>'>
                                    <span id="spanSTCAPPETA" runat="server">
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="txtETAHOPPM" Width="96%" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsHOPPMETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsHOPPMETAForColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'HPPPMETA');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("HOPPMETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("HOPPMETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("HOPPMETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("HOPPMETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("HOPPMETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("HOPPMETA")).ToString("dd MMM") %>'></asp:TextBox>
                                        <%--END--%>
                                    </span>
                                </td>
                            </tr>
                            <tr id="apprHide4" runat="server">
                                <td id="tdTopSent" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    ...
                                    <asp:Label ID="lblTopSent" runat="server" ToolTip="Assurance Form" Text="TOP Sent" Visible='<%# Eval("FitsTOPSentRead")%>'>
                            ...
                            runat="server"></asp:Label>--%>
                                    <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                        <asp:Label ID="Label10" Visible='<%# Eval("FitsTopSentTargetDateRead")%>' ToolTip="Top Sent Target Date" Style="font-size: 8px !important; font-weight: bold;" Text='<%# (Convert.ToDateTime(Eval("TOPTargetETA")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("TOPTargetETA"))).ToString("dd MMM")%>' runat="server"></asp:Label>
                                        <%--end by abhishek on 8/1/2015--%>
                                    </div>
                                    <div style="height: 10px;">
                                        <asp:Label ID="lblTopSendTarget" Visible='<%# Eval("FitsTopSentMActualDateRead")%>' Enabled='<%# Eval("FitsTopSentMActualDateWrite")%>' Style="width: 98%; height: 10px; font-size: 8px !important;" Text='<%# (Convert.ToDateTime((Eval("ParentOrder") as iKandi.Common.Order).InlinePPMOrderContract.TopSentActual) == Convert.ToDateTime("01-01-0001")) ? "" : (Eval("ParentOrder") as iKandi.Common.Order).InlinePPMOrderContract.TopSentActual.ToString("dd MMM")%>' runat="server"></asp:Label>
                                    </div>
                                    <%--END--%>
                                    <%-- </a>--%>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("FitsTOPSentETABackColor").ToString() %>'>
                                    <div>
                                        <%--Added By Ashish on 23/3/2015--%>
                                        <asp:TextBox ID="lblTOPETA" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsTOPSentETABackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("FitsTOPSentETAForColor"))%>' Visible='<%# Eval("FitsTOPSentETARead")%>' runat="server" Style="width: 83px; font-size: 8px; text-transform: capitalize;" CssClass="do-not-allow-typing" Text='<%# (Convert.ToDateTime((Eval("ParentOrder") as iKandi.Common.Order).InlinePPMOrderContract.TopSentActual) == Convert.ToDateTime("01-01-0001")) ? (Convert.ToDateTime(Eval("TOPETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("TOPETA")).ToString("dd MMM") : (Eval("ParentOrder") as iKandi.Common.Order).InlinePPMOrderContract.TopSentActual.ToString("dd MMM")%>'></asp:TextBox>
                                        <%--END--%>
                                    </div>
                                    <span visible="false" id="spantoppending" runat="server">
                                        ...
                                        <a onclick="javascript:return showEtaPopup('TOPETA','FitsETA','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID%>','','','<%# (Convert.ToDateTime(Eval("TOPETA")) == Convert.ToDateTime("01-01-0001")) ? "" : Convert.ToDateTime(Eval("TOPETA")).ToString("dd MMM")%>','','<%#(Eval("ParentOrder") as iKandi.Common.Order).Style.StyleNumber%>','','<%#Eval("OrderDetailID") %>',64);">
                                            <asp:TextBox ID="lbltoppending" CssClass="do-not-allow-typing" Style="font-size: 8px !important; color: red !important; background-color: transparent;" runat="server" Width="70" Text='<%# Eval("TOPpending")%>'></asp:TextBox>
                                            <%--END--%>
                                        </a></span>
                                </td>
                            </tr>
                            ...
                            <tr id="apprHide5" runat="server">
                                <td id="tdTestReport" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px; padding: 0px !important;">
                                    <%--<asp:HyperLink ID="hlnktestupload" runat="server" Style="cursor: pointer;" Target="_blank" Text="">
                           
                           </asp:HyperLink>--%>
                                    <a rel="shadowbox;" href="MoTestReportUpload.aspx?OrderId=<%# Eval("OrderID")%>&OrderDetailsId=<%# Eval("OrderDetailID")%>" onclick='return OpenTestReport(this);' style="cursor: pointer;">
                                        <asp:Label ID="lbltextreport" runat="server" ToolTip="Test Report files" Style="color: Gray;" Text="" Visible='<%# Eval("FitsHOPPMRead")%>'></asp:Label></a>
                                ...
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lbltestReportTagrgetsDates" Visible='<%# Eval("FitsHOPPMTargetDateRead")%>' ToolTip="Test Report Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("TestReportTargetETA")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("TestReportTargetETA")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("TestReportTargetETA")) == Convert.ToDateTime("01-01-0001")) ? "" : (Convert.ToDateTime(Eval("TestReportTargetETA"))).ToString("dd MMM")%>'></asp:Label>
                                        </div>
                                        <div style="height: 10px;">
                                            <asp:Label ID="lblTestReportActualDate" Visible='<%# Eval("FitsHOPPMActualDateRead")%>' Enabled='<%# Eval("TestReportWrite")%>' ToolTip="Test Report Actual Date" Style="width: 98%; font-size: 8px !important; background-color: #F9F9FA; text-transform: capitalize !important; height: 10px;" Text='<%# (Convert.ToDateTime(Eval("TestReportsDateActual")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("TestReportsDateActual")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("TestReportsDateActual")) == Convert.ToDateTime("1/1/1900")) ? (Convert.ToDateTime(Eval("TestReportsDateActual")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("TestReportsDateActual")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("TestReportsDateActual")).ToString("dd MMM")  : Convert.ToDateTime(Eval("TestReportsDateActual")).ToString("dd MMM") %>' runat="server"></asp:Label>
                                        </div>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("TestReportsBackColor").ToString() %>'>
                                    <span id="span1" runat="server">
                                        <asp:TextBox ID="TxtETATestReport" Width="96%" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TestReportsBackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("TestReportsForColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'TESTREPORTS');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("TestReportsDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("TestReportsDateETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("TestReportsDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("TestReportsDateETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("TestReportsDateETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("TestReportsDateETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            ...
                            <tr style='<%# "display :" + Eval("IsCdchartVisible").ToString() %>'>
                                <td id="tdcdchat" runat="server" style="color: #807F80 !important; text-align: left; line-height: 21px;">
                                    <asp:Label ID="lblcdchat" runat="server" ToolTip="CD chart" Text="Cd chart" Visible='<%# Eval("FitsHOPPMRead")%>'></asp:Label>
                                </td>
                                <td style="color: Black; text-align: center; padding: 0px !important; margin: 0px !important;">
                                    <span class="newtext2" style="text-align: center;">
                                        <div style="width: 100%; border-bottom: 1px solid #dddada; height: 12px;">
                                            <asp:Label ID="lblcdcharttargetdate" Visible='<%# Eval("FitsHOPPMTargetDateRead")%>' ToolTip="CD chart Target Date" CssClass="date_style  do-not-allow-typing" Style="font-size: 8px; font-weight: bold;" runat="server" Text='<%# (Convert.ToDateTime(Eval("CdchartTargetDateETA")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("CdchartTargetDateETA"))).ToString("dd MMM")%>'></asp:Label>
                                        </div>
                                        <asp:TextBox ID="TxtactualDate" Visible='<%# Eval("FitsHOPPMActualDateRead")%>' Enabled='<%# Eval("CDCharWrite")%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'CDChartActual');" Style="width: 98%; font-size: 8px !important; background-color: #F9F9FA !important; text-transform: capitalize !important; height: 10px;" runat="server" CssClass="th do-not-allow-typing" Text='<%# (Convert.ToDateTime(Eval("CdchartActualDateETA")) == Convert.ToDateTime("1/1/1900")||Convert.ToDateTime(Eval("CdchartActualDateETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("CdchartActualDateETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                                <td style='color: #00E; border-right: 0px !important; text-align: center; <%# "background-color :" + Eval("CDChartBackColor").ToString() %>'>
                                    <span id="span2" runat="server">
                                        <asp:TextBox ID="txtcdchartETA" Width="70" BackColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("CDChartBackColor"))%>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("CDChartForColor"))%>' onchange="javascript:return UpdateCuttingSheetDateForMO(this,'CDChartETA');" Style="font-size: 8px !important; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("CdchartDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("CdchartDateETA")) == Convert.ToDateTime("01/01/0001")) ? (Convert.ToDateTime(Eval("CdchartDateETA")) == Convert.ToDateTime("01-01-0001")||Convert.ToDateTime(Eval("CdchartDateETA")) == Convert.ToDateTime("01/01/0001")) ? "" : Convert.ToDateTime(Eval("CdchartDateETA")).ToString("dd MMM")  : Convert.ToDateTime(Eval("CdchartDateETA")).ToString("dd MMM") %>'></asp:TextBox>
                                    </span>
                                </td>
                            </tr>
                            <%--end by abhishek on 11/2/2016--%>
                    ...
                    <div style="font-size: 9px; color: #0000ee; width: 100%; min-height: 30px; line-height: 13px; text-align: left;">
                        <asp:Label ID="lbltechnicaldealytask" ToolTip="Technical Section Delay Task" runat="server" Text='<%# Eval("TechnicalDelayTask")%>'></asp:Label>
                    </div>
                    <div style="width: 100%; float: left; text-align: center; line-height: 55px; height: 55px; display: none;">
                        <a title="click to see QA Status popup" id="lnkQaStatus" class="lnkQaStatus" href="#" style="font-size: 9px;" onclick="QAStatus('<%# Eval("OrderDetailID") %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID %>','<%# Eval("FitsQAStatusWrite") %>')">
                            <asp:Label ID="lblQAStatus" runat="server" Style="font-size: 8px !important; color: #807F80 !important; padding-left: 4px;" Text='Please select QA Status-Code' Enabled='<%# Eval("FitsQAStatusWrite")%>'></asp:Label></a>
                    </div>
                        ...
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td align="center" style="border: none !important; text-align: center;">
                                    &nbsp;<span style="text-align: center; font-size: 8px;"><asp:Label ID="lblFitsDate" Style="color: #807F80 !important; font-size: 8px;" runat="server" Visible='<%# Eval("FitsStcRead")%>' Enabled='<%# Eval("FitsStcWrite")%>'></asp:Label>
                                    </span>
                            </tr>
                        </table>
                    </div>
                    <div style="padding-top: 5px; width: 100%; text-align: center; color: #0000ee; height: 30px; float: left; display: none;">
                        ...
                        <asp:Label ID="lblPlannedDate" ForeColor="#0000ee" Style="font-size: 9px;" runat="server" Visible="false" Text='Fit 2 Sent 10 Sep 13 (Tue)'></asp:Label>
                        &nbsp;&nbsp;</span>
                        <%--<span>
                    ...
                    <div style="text-align: center; width: 100%; float: left; display: none;">
                        <div style="width: 50%; float: left;">
                            <asp:Label ID="Label13" Style="color: #807F80 !important; font-size: 8px;" runat="server" Text='Planned Date:' Visible='<%# Eval("FitsPlannedDateRead")%>' Enabled='<%# Eval("FitsPlannedDateWrite")%>'></asp:Label>
                        </div>
                        <div style="width: 50%; padding-top: 2px; float: left;">
                            <asp:TextBox ID="txtPlannedDate" CssClass="date-picker" onchange="javascript:return UpdatePlanedDate(this);" Style="color: #807F80 !important; background-color: #f9f9fa !important; font-size: 8px; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PlanningDate")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("PlanningDate")) == Convert.ToDateTime("1/1/1900")) ? "" : Convert.ToDateTime(Eval("PlanningDate")).ToString("dd MMM")%>' Visible='<%# Eval("FitsPlannedDateRead")%>' Enabled='<%# Eval("FitsPlannedDateWrite")%>'></asp:TextBox>
                        </div>
                    </div>
                    <div style="text-align: center;">
                                        ...
                                        <td align="left" valign="top" class="newtext" style="border: none !important; text-align: left;">
                                            <div style="width: 100%; float: left;">
                                                <div class="newtext" style="width: 50%; float: left;">
                                                    <asp:Label ID="Label21" runat="server" Style="font-size: 8px !important; color: #807F80 !important;" Text='Pattern Sample'></asp:Label>
                                                </div>
                                                <div class="newtext12" style="width: 50%; float: left; text-align: right; text-transform: capitalize !important; padding-top: 3px;">
                                                </div>
                                            </div>
                                            <div style="width: 100%; float: left;">
                                                <div class="newtext" style="width: 50%; float: left;">
                                                    <asp:Label ID="Label17" runat="server" Style="font-size: 8px !important; color: #807F80 !important;" Text='Cutting Sheet Recvd'></asp:Label>
                                                </div>
                                                <div class="newtext12" style="width: 50%; float: left; text-align: right; text-transform: capitalize !important; padding-top: 3px;">
                                                </div>
                                            </div>
                                            <div style="width: 100%; float: left;">
                                                <div class="newtext" style="width: 50%; float: left;">
                                                    <asp:Label ID="Label19" runat="server" Style="font-size: 8px !important; color: #807F80 !important;" Text='Production File'></asp:Label>
                                                </div>
                                                <div class="newtext12" style="width: 50%; float: left; text-align: right; text-transform: capitalize !important; padding-top: 3px;">
                                                </div>
                                            </div>
                    ...
                    <div style="width: 100%; float: left;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            ...
                            <tr>
                                <td style="width: 90%; display: none; border: none !important; text-align: left;" align="left">
                                    <asp:Label ID="lblFitsName" Style="font-size: 8px !important; color: #807F80 !important;" runat="server"></asp:Label><asp:Label ID="lblFitsRemark" Style="font-size: 8px !important; color: #807F80 !important; text-transform: capitalize !important;" runat="server"></asp:Label>
                                </td>
                                <td style="width: 5%; border: none !important; text-align: right;">
                                    <a id="lnkFitsPopUpETAfil" runat="server" style="cursor: pointer;">
                                        <img src="../../images/task-eta-icon.png" style="width: 30px" /></a> <a id="lnkFitsPopUp" runat="server" style="cursor: pointer;">
                                            <img src="../../App_Themes/ikandi/images/zoom_icon1.gif" /></a>
            ...
            <asp:TemplateField HeaderStyle-Width="405px">
                ...
                <ItemTemplate>
                    <div style="width: 100%;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td height="15px" style='width: 110px; border-left: 0px !important; border: none !important; letter-spacing: -1px; text-align: left; padding: 0px !important; <%# "background-color :" + Eval("ExFactoryColor").ToString() %>'>
                                    ...
                                    <span id="exFactory" runat="server"><span style="font-size: 11px;">Ex Fac:
                                        <input type="text" onchange="javascript:return UpdateExFactoryForMO(this);" style="text-align: left; background-color: transparent; text-transform: capitalize; font-size: 11px !important; letter-spacing: -1px; width: 70px; font-weight: bold; vertical-align: inherit; <%# "color :" + Eval("ExFactoryForeColor").ToString() %>;" class='<%#iKandi.Web.Components.PermissionHelper.IsExfactoryWritePermittedOnColumn((int)iKandi.Common.AppModuleColumn.MANAGE_ORDERS_FILE_MARCHANDISING_EXFACTORY)? "th do-not-allow-typing":"date-picker bold_text do-not-allow-typing" %>' id="exfactory<%# Container.DataItemIndex + 1 %>" name="exfactory<%# Container.DataItemIndex + 1 %>" value='<%# (Convert.ToDateTime(Eval("ExFactory")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("ExFactory"))).ToString("dd MMM yy (ddd)")%>' title="Exfactory" />
                                    </span></span><span style="float: left; font-size: 11px !important; text-align: left; width: 100%;" id="divexFactory" runat="server">Ex Fac:
                                        <asp:Label ID="lblexFactory" ToolTip="Exfactory" runat="server" Style="text-align: left; background-color: transparent; text-transform: capitalize; color: black; font-size: 11px !important; width: 70px; letter-spacing: -1px; font-family: Arial;" Font-Bold="true" Text='<%# (Convert.ToDateTime(Eval("ExFactory")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("ExFactory"))).ToString("dd MMM yy (ddd)")%>'></asp:Label>
                                    </span>
                                </td>
                                <td align="right" style='border: none !important; padding: 0px !important; padding-right: 2px !important; margin: 0px !important; text-align: right; <%# "background-color :" + Eval("ExFactoryColor").ToString() %>'>
                                    <a title='<%# iKandi.BLL.CommonHelper.GetDeliveryModeToolTip(Convert.ToInt32(Eval("Mode"))) %>' href="javascript:void(0)" onclick="GetManageOrderiKandiQtyByMode('<%# Eval("Mode")%>','<%# Eval("bModewrite") %>')" style="display: none;">
                                        <asp:Label runat="server" ID="lblMode" Style="font-size: 8px !important;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("ExFactoryForeColor")) %>' Text=' <%# Eval("ModeName")%>' Visible='<%# Eval("bModeRead") %>'></asp:Label></a>
                                    <!----------Add By prabhaker on 30 mar 18---------------->
                                    <asp:DropDownList runat="server" ID="ddlModeChange" Style="width: 90px; border: 1px solid" onchange="javascript:showModePopUp(this)">
                                    </asp:DropDownList>
                                ...
                                <td align="right" style="border: none !important; text-align: right; padding: 0px !important; background-color: #f9f9fa;">
                                    ...
                                    <asp:TextBox ID="txtDC" CssClass='<%#iKandi.Web.Components.PermissionHelper.IsExfactoryWritePermittedOnColumn((int)iKandi.Common.AppModuleColumn.MANAGE_ORDERS_FILE_MARCHANDISING_EXFACTORY)? "th do-not-allow-typing":"date-picker bold_text do-not-allow-typing" %>' Visible='<%# Eval("bDCDateRead") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' onchange="javascript:return UpdateExFactoryForDC(this);" Style="font-size: 8px !important; font-weight: bold; width: 70px; text-transform: capitalize !important;" runat="server" Text='<%# (Convert.ToDateTime(Eval("DC")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("DC"))).ToString("dd MMM (ddd)")%>'></asp:TextBox>
                                    <%-- <asp:Label ID="lblDC" runat="server" Text="DC:" Visible='<%# Eval("bDCDateRead") %>' ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' ></asp:Label>&nbsp;
                                    --%>
                                    <asp:Label ID="Label2" ToolTip="Dc Date" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Style="font-size: 8px !important; display: none;" runat="server" Text='<%# (Convert.ToDateTime(Eval("DC")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("DC"))).ToString("dd MMM (ddd)")%>'></asp:Label>
                                </td>
                            </tr>
                        </table>
                    </div>
                    <div style="width: 100%; background-color: #f9f9fa !important;">
                        <table width="100%" cellpadding="0" cellspacing="0">
                            <tr>
                                <td colspan="2" style="border: none !important; text-align: left; background-color: #f9f9fa !important; display: none;">
                                    <asp:Label ID="lblOffer" runat="server" Text="Offer:" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Visible='<%#Eval("FitsPlannedDateRead") %>' Enabled='<%#Eval("FitsPlannedDateWrite") %>'></asp:Label>&nbsp; <span id="Div1" runat="server" class="shipmentdate" style="padding-top: 15px;">
                                        <asp:Label ID="txtShipmentOfferDate" ToolTip="Ex Factory Planned Date" Visible='<%#Eval("FitsPlannedDateRead") %>' Enabled='<%#Eval("FitsPlannedDateWrite") %>' size="100" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Style="text-align: right; width: 85px; font-size: 8px !important; text-transform: capitalize !important; background-color: transparent;" runat="server" Text='<%# (Convert.ToDateTime(Eval("PlannedEx")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("PlannedEx")) == Convert.ToDateTime("1/1/1900")) ? "" : Convert.ToDateTime(Eval("PlannedEx")).ToString("dd MMM") %>'></asp:Label>
                                    </span>
                                </td>
                                <td style="border: none !important; text-align: left; background-color: #f9f9fa !important; font-size: 9px;" colspan="3">
                                    <table border="0" cellpadding="0" cellspacing="0" width="100%" style="border: 0PX !important;">
                                        <tr>
                                            <td style="border: 0PX !important; width: 15%; text-align: center;">
                                                <a href="javascript:void(0)" style='text-transform: capitalize !important; font-size: 9px !important; <%# "color :" + Eval("LinktypeForeColor").ToString() %>' title="Production Matrix" onclick="SHOW_PRODUCTION_MATRIX('<%# Eval("OrderDetailID") %>','<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleCode.ToString() %>','<%# Eval("ProductionPlanWrite")%>')">Plan </a>
                                            </td>
                                            <td style="border: 0PX !important; width: 25%; text-align: center;">
                                                <a href="javascript:void(0)" id="anchoeDetail_Rescan" style="text-transform: capitalize !important; font-size: 9px !important;" title="CLICK TO SEE PRODUCTION DETAIL" runat="server">
                                            ...
                                            <td style="border: 0PX !important; text-align: center; width: 15%;">
                                                <a id="hypstatusmode" runat="server" class="hide_me"></a><a href="javascript:void(0)" style='text-transform: capitalize !important; font-size: 9px !important; <%# "color :" + Eval("LinktypeForeColor").ToString() %>' title="CLICK TO SEE WORKFLOW HISTORY" onclick="showWorkflowHistory2('<%# (Eval("ParentOrder") as iKandi.Common.Order).Style.StyleID %>','<%# Eval("OrderID") %>','<%# Eval("OrderDetailID") %>')">History</a>
                                            </td>
                                            <%--  //Ravi 14-04-2016--%>
                                            <%--  //Gajendra 09-05-2016--%>
                                            <td style="border: 0PX !important; width: 65px; display: none;">
                                                <asp:Label ID="lblStatusMode" runat="server" Style="text-transform: capitalize !important; font-size: 11px;" ForeColor="#0000ee" Visible="false" Text='<%# (Eval("ParentOrder") as iKandi.Common.Order).WorkflowInstanceDetail.StatusMode %>'></asp:Label>
                                            </td>
                                            <td style="border: 0PX !important; font-size: 9px; width: 30%; text-align: center;">
                                                ...
                                                <asp:HyperLink ID="lnkreallocation" ToolTip="Reallocation" Enabled="false" runat="server" Target="_blank" Style='<%# "color :" + Eval("LinktypeForeColor").ToString() %>' Text="Reallocation" CssClass="mo-reallocation-img"></asp:HyperLink>
                                            ...
                                            <td align="right" style="border: 0PX !important; font-size: 9px; width: 20%; text-align: center;">
                                                <a href="javascript:void(0)" runat="server" id="lnkopenShipedPopoup" title="Open shiped qnty popup" visible='<%#Eval("IsShipedRead") %>' enabled='<%#Eval("IsShipedWrite") %>'>Penalty </a>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                            ...
                            <tr>
                                <td style="border: none !important; text-align: left; background-color: #f9f9fa; width: 20%;">
                                    <span style="width: 60px !important"><a href="javascript:void(0)" class="" title="CLICK TO VIEW ORDER SIZE" onclick="showSizePopup('<%# Eval("OrderDetailID") %>','<%# Eval("bQuantitywrite") %>')">
                                        <asp:Label ID="lblQuantity" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("LinktypeForeColor")) %>' Style="font-weight: bold; font-size: 10px;" Visible='<%# Eval("bQuantityRead") %>' Text='<%# Eval("Quantity")%>' CssClass="number-with-commas mainQty"></asp:Label>
                                    </a>
                                        <asp:Label ID="lblpcs" runat="server" Text="Pcs." Visible='<%# Eval("bQuantityRead") %>' Enabled='<%# Eval("bQuantitywrite") %>'></asp:Label></span>
                                </td>
                                <td colspan="2" style="border: none !important; text-align: center; background-color: #f9f9fa; color: Gray;">
                                    <%--<asp:Label ID="lblExpectedDC" style="display:none;" runat="server" Text="" ForeColor="Gray"></asp:Label>--%>
                                    <asp:Label ID="lblPlanedForDate" runat="server" Style="text-transform: capitalize !important; font-size: 10px; display: none;" ForeColor="Gray" Visible="false" Text=""></asp:Label>
                                    <asp:TextBox runat="server" ID="txtPlannedForDate" onchange="javascript:ChangePlanDate(this);" Visible="false" Width="70px" Style="display: none;" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("LinktypeForeColor")) %>'></asp:TextBox>
                                    <asp:HiddenField ID="hdnPlanforDate" runat="server" />
                                    &nbsp;
                                    <asp:DropDownList Style="display: none;" ID="ddlMode" Visible="false" onchange="javascript:ChangeMode(this);" Width="75px" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("LinktypeForeColor")) %>'>
                                        <asp:ListItem Text="Auto" Value="1"></asp:ListItem>
                                        <asp:ListItem Text="Manual" Value="2"></asp:ListItem>
                                    </asp:DropDownList>
                                    <asp:DropDownList ID="ddlUnPlanned" Style="display: none;" Visible="false" Width="80px" runat="server">
                                    ...
                                    <asp:DropDownList ID="ddlOuthouse" onchange="javascript:update_OutHouse(this);" Style="float: right; position: relative; top: 3px;" Visible="false" Width="55px" runat="server">
                                    ...
                                    <asp:Label ID="lblholdstatus" ForeColor="Black" Font-Size="10px" Style="float: right; position: relative; top: -2px;" Text="OnHold" runat="server">
                                        <asp:CheckBox ID="chkonhold" Style="position: relative; top: 3px; color: Red" CssClass="bordercolorcheckbox" Checked='<%# Eval("ContractStatus") %>' Enabled='<%#Eval("IsContractHoldWrite") %>' runat="server" ToolTip="Select current status for onhold or unhold" onclick="javascript:UpdateContractholdStatus(this);" />
                                    </asp:Label>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="3" style="border: none !important; text-align: left; height: 150px; background-color: #f9f9fa;">
                                    <asp:HiddenField ID="hdnQuantity" runat="server" Value='<%# Eval("Quantity")%>'></asp:HiddenField>
                                    ...
                                    <asp:HiddenField ID="hdnStcApproved" runat="server" Value='<%#(Eval("ParentOrder") as iKandi.Common.Order).Fits.IsStcApproved%>'></asp:HiddenField>
                                    ...
                                    <asp:Repeater ID="repProduction" runat="server" OnItemDataBound="repProduction_ItemDataBound">
                                        <HeaderTemplate>
                                            <table width="100%" cellpadding="0" cellspacing="0" border="0" class="production-sec">
                                                <tr>
                                                    ...
                                                    <td id="tdva" style="color: Gray" runat="server" width="35px" class="VA-Hide">
                                                        VA
                                                    </td>
                                                    <td width="35px" style="color: Gray">
                                                        Fin/pkd
                                        ...
                                        <ItemTemplate>
                                            <div id="dvProduction" runat="server">
                                                <table cellpadding="0" cellspacing="0" width="100%" align="center" style="font-size: 10px" bgcolor="#fff;" border="0" class="production-sec">
                                                    <tr>
                                                        <td id="tdFacotryName" runat="server" rowspan="2" width="35px" style="border-left: 0px !important;">
                                                            ...
                                                            <asp:HiddenField ID="hdnStitchQty_OutHouse" Value='<%#Eval("StitchQty_OutHouse") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnFinishQty_OutHouse" Value='<%#Eval("FinishQty_OutHouse") %>' runat="server" />
                                                            <asp:HiddenField ID="hdnFinishing_InHouse" Value='<%#Eval("Finishing_InHouse") %>' runat="server" />
                                                            <asp:Label ID="lblFactoryName" Style="color: Gray" runat="server" Text='<%# Eval("FactoryName") %>' ToolTip='<%#Eval("FactoryCodes") %>'>
                                                            </asp:Label><br />
                                                        ...
                                                        <td visible="false" width="35px" id="tdcutissue" runat="server" style="font-size: 10px;" title='<%# Convert.ToInt32(Eval("CutIssueQtyTooltip")).ToString("N0")%>'>
                                                            <asp:Label runat="server" Text='<%#Eval("CutIssueQty") %>' Visible="false" ID="lblcutissue"></asp:Label>
                                                            <asp:TextBox ID="txtcutissue" Text='<%#Eval("CutIssueQty") %>' ReadOnly="true" onclick='<%# "cutissue(" + Eval("OrderID") +","+ Eval("OrderDetailID")+ ","+ Eval("UnitId")+ ");"%>' MaxLength="0" runat="server"></asp:TextBox>
                                                            <%--  </a>--%>
                                                        </td>
                                                        ...
                                                        <td width="35px" style="font-size: 10px">
                                                            <asp:TextBox ID="txtStitchToday" ReadOnly="true" CssClass="numeric-field-without-decimal-places" MaxLength="5" runat="server"></asp:TextBox>
                                                        </td>
                                                        ...
                                                        <td width="35px" class="VA-Hide" runat="server" id="tdvatoday" style="font-size: 10px">
                                                            <asp:TextBox ID="txtVAToday" CssClass="numeric-field-without-decimal-places" MaxLength="3" runat="server"></asp:TextBox>
                                                        </td>
                                                        <td width="35px" style="font-size: 10px">
                                                            <asp:TextBox ID="txtFinishToday" Font-Size="8px" CssClass="do-not-allow-typing" MaxLength="5" runat="server"></asp:TextBox>
                                                        </td>
                                                    ...
                                                    <tr>
                                                        <td style="font-size: 10px; border-left: 0px !imporant;">
                                                            <asp:Label ID="txtCutTotal" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hdnCutTotal" Value="0" runat="server" />
                                                        </td>
                                                        <td style="font-size: 10px">
                                                            <asp:Label ID="txtCutReadyTotal" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:Label>
                                                        ...
                                                        <td style="font-size: 10px" id="tdcutissuetotal" visible="false" runat="server">
                                                            <asp:TextBox ID="txtcutissuetotal" Style="color: Black;" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:TextBox>
                                                            <asp:HiddenField ID="hdncutissuetotal" Value="0" runat="server" />
                                                        </td>
                                                        <td style="font-size: 10px">
                                                            <asp:Label ID="txtStitchTotal" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hdnStitchTotal" Value="0" runat="server" />
                                                        </td>
                                                        <td class="VA-Hide" runat="server" id="tdvaVATotal" style="font-size: 10px">
                                                            <asp:Label ID="txtVATotal" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:Label>
                                                        </td>
                                                        <td style="font-size: 10px">
                                                            <asp:Label ID="txtFinishTotal" Font-Size="10px" CssClass="do-not-allow-typing" MaxLength="3" runat="server"></asp:Label>
                                                            <asp:HiddenField ID="hdnFinishTotal" Value="0" runat="server" />
                                                        </td>
                                                        <td width="35px" runat="server" id="tdrescanValue2">
                                                            <asp:Label ID="lblrescanValue2" runat="server" Style="color: Red; font-weight: 600; font-size: 10px !important"></asp:Label>
                                                        </td>
                                                    </tr>
                                                </table>
                                            </div>
                                            ...
                                            <table cellpadding="0" cellspacing="0" width="100%" align="center" style="font-size: 10px" bgcolor="#fff;" border="0" class="production-sec">
                                                <tr>
                                                    ...
                                                    <td rowspan="2" width="35px">
                                                        <asp:Label ID="lblFactoryName_Footer" Style="color: gray;" Font-Size="10px" runat="server" Font-Bold="true" Text="Total"></asp:Label>
                                                    </td>
                                                    ...
                                                    <td width="35px" rowspan="2" style="font-size: 10px">
                                                        <div runat="server" id="DivCuttotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                    ...
                                                    <td width="35px" rowspan="2" style="font-size: 10px">
                                                        <div runat="server" id="DivCutReadyTotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                    ...
                                                    <td width="35px" style="font-size: 10px" runat="server" visible="false" id="tdcutissuefotertotal">
                                                        <div runat="server" id="DivCutIssuetotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                    ...
                                                    <td width="35px" rowspan="2" style="font-size: 10px">
                                                        <div runat="server" id="DivStitchTotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%; background: #FDFD96;">
                                                    ...
                                                    <td rowspan="2" width="30px" id="tdFinishAllocate_foter" runat="server" style="font-size: 10px">
                                                        <asp:Label ID="lblFinishAllocate_Footer" Font-Bold="false" Style="color: black" runat="server" Text=""></asp:Label>
                                                    </td>
                                                    <td width="35px" rowspan="2" runat="server" id="tdVATotalfoter" class="VA-Hide" style="font-size: 10px">
                                                        <div runat="server" id="DivVATotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                            <asp:Label runat="server" ID="lblVATotal_Footer" Font-Bold="true" Style="font-size: 10px !important;" ForeColor="" Text="" Visible="true"></asp:Label>
                                                        </div>
                                                        <asp:Label ID="lblVATotal_Percent" runat="server" Text=""></asp:Label>
                                                    </td>
                                                    <td width="35px" rowspan="2">
                                                        <div runat="server" id="DivFinishTotal" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                    ...
                                                    <td width="35px" rowspan="2" runat="server" id="tdrescanFooter">
                                                        <div runat="server" id="DivRescanFooter" style="border-bottom: 2px solid #e6e6e6; height: 20px; width: 100%;">
                                                            <asp:Label runat="server" ID="lblOverallRecanFooter" Font-Bold="true" Style="font-size: 10px !important;" ForeColor="" Text="" Visible="true"></asp:Label>
                                                        </div>
                                                        <asp:Label ID="lblPendingRescanFooter" runat="server" Text="" Style="color: Red; font-weight: 600; font-size: 10px !important"></asp:Label>
                                                    </td>
                                                </tr>
                                            </table>
                                        </FooterTemplate>
                    ...
                    <div style='text-align: left;'>
                        <div style="float: left; width: 50%;">
                            <asp:HyperLink ID="hlnkQaPrevStatus" ToolTip="" runat="server" Target="_blank" Style="text-transform: capitalize !important; font-size: 9px !important; padding: 2px !important; color: Gray;" Text='<%# Eval("QualityControl_Prev_Status")%>' CssClass=""></asp:HyperLink>
                            <a href='/Internal/Merchandising/QC.aspx?OrderId=<%# Eval("OrderID")%>&OrderDetailID=<%# Eval("OrderDetailID") %>&InspectionIDMO=<%# Eval("InspectionID") %>' style='text-transform: capitalize !important; font-size: 9px !important; padding: 2px !important; <%# "color :" + Eval("LinktypeForeColor").ToString() %>' target="_blank" title="Quality Assurance Form">
                        ...
                        <div id="dvQCFileUpload" runat="server" style="float: right; width: 50%; text-align: right;">
                            <a rel="shadowbox;" href="../Delivery/frmQcUploadDocs.aspx?OrderId=<%# Eval("OrderID")%>&OrderDetailsId=<%# Eval("OrderDetailID")%>" onclick='return UploadQcDocs(this);' style="cursor: pointer;">
                    ...
                    <div style="width: 100%; height: 15px;">
                        <div style="width: 35%; height: 15px; float: left;" id="maindivmda" runat="server">
                            ...
                            <div style="width: 60%; height: 15px; float: left; text-align: left;" id="spnmdano" title="MDA" runat="server">
                                <input id="mda<%# Container.DataItemIndex + 1 %>" onblur="javascript:return UpdateMDAForMO(this);" size="14px" style='font-size: 8px !important; text-align: left; border: 1px solid #d6d7d8; color: #000; width: 82%; <%# "color :" + Eval("BlackToForeColor").ToString() %>' name="mda<%# Container.DataItemIndex + 1 %>" value="<%# Eval("MDANumber") %>" class='<%#((Eval("ParentOrder") as iKandi.Common.Order).Style.client.IsMDARequired == 0 ) ? "hide_me":"" %>' />&nbsp;&nbsp;
                            </div>
                            <div style="width: 40%; line-height: 15px; height: 15px; float: left; text-align: left;" id="Div2" title="MDA" runat="server">
                                <asp:Label ID="bllmda" ToolTip="mda" Font-Size="8px" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' runat="server" Text='<%# Eval("MDANumber") %>'></asp:Label>
                            </div>
                            <div style="clear: both">
                            </div>
                            <br />
                            <%--abhishek set visibility:collapse boz now there is no use of lblErrorShipment--%>
                            <asp:Label ID="lblErrorShipment" Style="color: black; visibility: collapse; font-size: 8px; background-color: transparent;" runat="server"></asp:Label>
                        </div>
                        <!-----------------changes-22-dec----------->
                        <div id="divFooter" visible="false" runat="server" style="width: 47%; line-height: 24px; height: 24px; float: right; text-align: right; margin-right: 10px;">
                            <span>
                    ...
                    <div style="width: 100%; vertical-align: top;">
                                ...
                                <td colspan="3" style="border: none !important; padding: 0px !important;">
                                    <div style="width: 100%">
                                        <div style="float: left; width: 68%;">
                                            <asp:Label ID="lblShipped" Style="font-size: 8px !important; color: #807F80 !important;" Visible='<%#Eval("IsShipedRead") %>' Width="120px" Enabled='<%#Eval("IsShipedWrite") %>' runat="server" Text="" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>'></asp:Label>
                                        </div>
                      ...
                      <asp:TextBox ID="txtISShippedDate" runat="server" Width="80px" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' style="background-color:#F9F9FA; font-size:8px; text-transform:capitalize; background:none; border:1px solid #d6d7d8; color:#000;  margin-right:5px;" CssClass="date-picker" Text='<%# (Convert.ToDateTime(Eval("IsShipedDate")) == Convert.ToDateTime("01/01/0001")||Convert.ToDateTime(Eval("IsShipedDate")) == Convert.ToDateTime("1/1/1900")) ? "" : Convert.ToDateTime(Eval("IsShipedDate")).ToString("dd m y") %>' Visible='<%#Eval("IsShipedRead") %>' Enabled='<%#Eval("IsShipedWrite") %>'></asp:TextBox>
                                    ...
                                    <table cellpadding="0" cellspacing="0" style="border: none !important; vertical-align: top;">
                                        <tr>
                                            <td style="border: none !important; text-align: left; height: 15px; vertical-align: top;">
                                                <asp:CheckBox ID="chkshipped" Font-Size="8px" onclick="javascript:return CheckShipped(this);" Checked='<%#Eval("IsShiped") %>' Visible='<%#Eval("IsShipedRead") %>' Enabled='<%#Eval("IsShipedWrite") %>' runat="server" />
                                            </td>
                                            <td style="text-align: left; border: none !important; height: 20px; padding-bottom: 5px; vertical-align: top;">
                                                <asp:Label ID="lblShippedCaption" Width="270px" runat="server" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>' Style="background-color: #F9F9FA; font-size: 7px; text-transform: capitalize;" Text="" Visible='<%#Eval("IsShipedRead") %>' Enabled='<%#Eval("IsShipedWrite") %>'></asp:Label>
                                                <asp:HiddenField ID="hdnProductionRemark" runat="server" />
                                            </td>
                                        </tr>
                                        <tr>
                                            <td colspan="2" style="border: none !important;">
                                                <asp:HyperLink ID="viewolay1" Visible="false" ToolTip="VIEW Packing List" runat="server" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/info.jpg" Text=""></asp:HyperLink>
                                                <asp:HyperLink ID="hypPackingName" runat="server" Visible="false" Style="border: 1px solid gray; padding: 5px;">
                                                    <asp:Label ID="lblPackingName" Visible="false" runat="server" Font-Size="9px"></asp:Label>
                                                </asp:HyperLink>
                                                &nbsp; &nbsp;
                                                <asp:HyperLink ID="hypShipmentNo" Visible="false" runat="server" Style="border: 1px solid gray; padding: 5px;">
                                                    <asp:Label ID="lblConsolidated" ToolTip="Shipment No." runat="server" Font-Size="9px" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>'></asp:Label>
                                                </asp:HyperLink>
                                                <asp:HyperLink ID="viewInvoice" Visible="false" ToolTip="VIEW Invoice List" runat="server" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/info.jpg" Text=""></asp:HyperLink>
                                                <asp:HyperLink ID="hypInvoice" Visible="false" runat="server" Style="border: 1px solid gray; padding: 5px;">
                                                ...
                                                <asp:HyperLink ID="hypBankRefNo" Visible="false" runat="server" Style="border: 1px solid gray; padding: 5px;">
                                                    <asp:Label ID="lblBankRefNo" runat="server" ToolTip="Bank Reference No." Font-Size="9px" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>'></asp:Label>
                                                </asp:HyperLink>
                                                <br />
                                                ...
                                                <asp:Label ID="lblPaymentDueDate" Visible="false" ToolTip="Payment Due Date" runat="server" Text='<%# (Convert.ToDateTime(Eval("PaymentDueDate")) == Convert.ToDateTime("1/1/1900")) ? "" : (Convert.ToDateTime(Eval("PaymentDueDate"))).ToString("dd MMM")%>' Font-Size="9px" ForeColor='<%# System.Drawing.ColorTranslator.FromHtml((String)Eval("BlackToForeColor")) %>'></asp:Label>
                                            </td>
                                        </tr>
                                    </table>
                                </td>
                        ...
                        <asp:HiddenField ID="hdnStitchingDetailID" runat="server" Value='<%#Eval("StitchingDetailID") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnPcsPackedToday" runat="server" Value='<%#Eval("PcsPackedToday") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnOverallPcsPacked" runat="server" Value='<%#Eval("OverallPcsPacked") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnOverallPcsStitched" runat="server" Value='<%#Eval("OverallPcsStitched") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnTotalPcsStitchedToday" runat="server" Value='<%#Eval("TotalPcsStitchedToday") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnExpectedFinishDate" runat="server" Value='<%#Eval("ExpectedFinishDate") %>'></asp:HiddenField>
                        <asp:HiddenField ID="hdnIsStitchingComplete" runat="server" Value='<%#Eval("IsStitchingComplete") %>'></asp:HiddenField>
                    </div>
                    <div style="font-size: 9px; color: #0000ee; width: 100%; padding-top: 5px; text-align: left;">
                        <asp:Label ID="lblproductiondealytask" ToolTip="Production Section Delay Task" runat="server" Text='<%# Eval("ProductionDelayTask")%>'></asp:Label>
                    </div>
            ...
            <asp:TemplateField HeaderText="Mode" HeaderStyle-CssClass="vertical_header" ItemStyle-CssClass="vertical_text" Visible="false">
                <ItemTemplate>
                </ItemTemplate>
...
<%--     <asp:Image ID="LoadImg" Style="position: fixed; z-index: 52111; top: 20%; left: 50%;
        ...
        runat="server" />--%>
<asp:ObjectDataSource ID="odsBasicInfo" runat="server" SelectMethod="GetOrdersBasicInfo" TypeName="iKandi.BLL.OrderController"></asp:ObjectDataSource>
<div id="links" class="hide_me">
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0" class="style-remove-border">
        <tr>
            <td colspan="3">
                <a href="/Internal/OrderProcessing/OrderProcessFlow.aspx" class="hyp" target="_blank">Risk Analysis</a>
            </td>
        </tr>
        <tr style="display: none;">
            <td colspan="3">
        ...
        <tr>
            <td colspan="4">
                <a href="../../Internal/OrderProcessing/PoFileUploads.aspx" class="hyp" rel="shadowbox;" onclick='return OpenPOfileUpload(this);'>PO Upload</a>&nbsp; &nbsp; <span id="first-tab">
                    <asp:HyperLink ID="POView1" ToolTip="VIEW PO Upload" runat="server" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/viewIcon.gif" Text=""></asp:HyperLink></span> &nbsp; &nbsp; <span id="second-tab">
                        <asp:HyperLink ID="POView2" ToolTip="VIEW PO Upload" runat="server" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/viewIcon.gif" Text=""></asp:HyperLink></span> &nbsp; &nbsp; <span id="Third-tab">
                            <asp:HyperLink ID="POView3" ToolTip="VIEW PO Upload" runat="server" Target="_blank" ImageUrl="~/App_Themes/ikandi/images/viewIcon.gif" Text=""></asp:HyperLink></span>
            </td>
        </tr>
        <tr style="display: none">
            <td rowspan="2">
        ...
        <tr>
            <td colspan="3">
                <input id="htmlbtnUpload" style="display: none;" class="uploadsubmit submit" type="button" value="Submit" />
                <asp:Button ID="btnback" runat="server" CssClass="btnback button-sumit submit" Style="display: none;" Text="Submit" OnClick="btnback_Click" />
                <asp:HiddenField ID="hdnUploadPOid" Value="" runat="server" />
            </td>
        </tr>
    </table>
    <a href="../../Admin/StyleCodeDetails.aspx" class="hyp stylecode" style="display: none;">Style Details</a>
</div>
<div style="clear: both">
</div>
<script type="text/javascript">
