...
{
    public partial class AllOrdersOnStyle : BaseUserControl
    {
        ...
        public string StyleNumber
        {
            get
            {
                if (!string.IsNullOrEmpty(Request.QueryString["styleNo"]))
                {
                    return Convert.ToString(Request.QueryString["styleNo"]);
                }
                else if (!String.IsNullOrEmpty(styleNumber))
                {
                    return styleNumber;
                }
                else
        ...
        public string OrderIDList
        {
            get
            {
                if (!string.IsNullOrEmpty(Request.QueryString["OrderIDList"]))
                {
                    return Convert.ToString(Request.QueryString["OrderIDList"]);
                }
                else if (!String.IsNullOrEmpty(orderIdList))
                {
                    return orderIdList;
                }
                return string.Empty;
        ...
        public bool AllOrders
        {
            get
            {
                if (!string.IsNullOrEmpty(Request.QueryString["AllOrders"]))
                {
                    return Convert.ToBoolean(Request.QueryString["AllOrders"]);
                }
                else
                {
                    return allOrders;
        ...
        public void BindControls()
        {
            ...
            hiddenStyleNo.Value = this.StyleNumber;
            ds = this.ReportControllerInstance.GetAllOrdersOnStyle(this.StyleNumber, this.OrderIDList, this.AllOrders);
