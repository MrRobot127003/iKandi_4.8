<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmFactoryPerformanceReports.ascx.cs" Inherits="iKandi.Web.UserControls.Reports.frmFactoryPerformanceReports" %>
 <style type="text/css">
      body
      {
          font-family: Arial;
...
td div
{
  ...
  <tr>
  <td colspan="3" style="background-color:#405D99;height:20px;border-bottom: 1px solid #98a9ca;color: #98a9ca; font-size: 14px;">
  Factory Line Specific Achievement
      ...
      <td style="vertical-align:top;padding:0px !important; margin:0px">
      <table cellpadding="0" cellspacing="0" border="0">
      <tr>
      <th style="background-color:#405D99;height:20px; border-right:1px solid #98a9ca;width:70px !important;">
      &nbsp;
      </th>
      <th style="color:#98a9ca;background-color:#405D99;font-size:12px;font-weight:normal;height:20px;width:auto;border-right:1px solid #98a9ca;">
       C-47
      ...
      <td style="padding:0px; margin:0px" colspan="2">
       <asp:GridView runat="server" ID="grdC4546FactorytargetActual" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-Height="20px" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="false"
         ...
         <asp:TemplateField HeaderText="Date">
               ...
               <ItemStyle Height="46px" Width="70px" />
            <HeaderStyle Height="56px" Width="70px" />
            </asp:TemplateField>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine1"></asp:Label>
            
            </ItemTemplate>
          <ItemStyle Height="46px" />
            </asp:TemplateField>
         <asp:TemplateField HeaderStyle-Width="45px">
            <HeaderTemplate>
               Line 2 <br />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine2"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine3"></asp:Label>
           ...
           <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine4"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine5"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine6"></asp:Label>
           ...
           <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine7"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine8"></asp:Label>
        ...
        <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine9"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine10"></asp:Label>
         ...
         <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine11"></asp:Label>
           ...
           <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine12"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine13"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine14"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC4546FactoryAchLine15"></asp:Label>
...
Ach
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
               <tr>
                  <td style="border-bottom:1px solid #dddddd; height:15px">
                  <asp:Label runat="server" ID="lblC4546FactoryTgtTotal" ForeColor="Gray" Text='<%# Eval("lineTotalTgt") %>'></asp:Label>
                  </td>
               
               </tr>
            <tr>
                  <td style="border-bottom:1px solid #dddddd;height:15px">
                  <asp:Label runat="server" ID="lblC4546FactoryActTotal" ForeColor="Gray" Text='<%# Eval("lineTotalAct") %>'></asp:Label>
                  </td>
            ...
            <ItemStyle Height="46px" VerticalAlign="Top" />
            </asp:TemplateField>
      ...
      <td style="vertical-align:top; padding:0px !important; margin:0px">
          <table cellpadding="0" cellspacing="0" border="0">
      <tr>
      <th style="color:#98a9ca;background-color:#405D99;font-size:12px;font-weight:normal;height:20px;border-right:1px solid #98a9ca">
      ...
      <td style="padding:0px; margin:0px">
        <asp:GridView runat="server" ID="grdC47FactorytargetActual" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-Height="20px" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="false"
         ...
         <Columns>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine1"></asp:Label>
         ...
         <asp:TemplateField HeaderStyle-Width="45px">
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine2"></asp:Label>
           ...
           <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine3"></asp:Label>
           ...
           <ItemStyle Height="46px" />
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine4"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine5"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine6"></asp:Label>
           ...
           <ItemStyle Height="46px"/>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine9"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine10"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine11"></asp:Label>
           ...
           <ItemStyle Height="46px"/>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine12"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine13"></asp:Label>
          ...
          <ItemStyle Height="46px"/>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine14"></asp:Label>
            ...
            <ItemTemplate>
            <asp:Label runat="server" ID="lblC47FactoryAchLine15"></asp:Label>
...
Ach.
            ...
            <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
               <tr>
                  <td style="border-bottom:1px solid #dddddd;height:15px;">
                  <asp:Label runat="server" ID="lblC47FactoryTgtTotal" ForeColor="Gray" Text='<%# Eval("lineTotalTgt") %>'></asp:Label>
                  </td>
               
               </tr>
            <tr>
                  <td style="border-bottom:1px solid #dddddd;height:15px;">
                  <asp:Label runat="server" ID="lblC47FactoryActTotal" ForeColor="Gray" Text='<%# Eval("lineTotalAct") %>'></asp:Label>
                  </td>
      ...
      <td  style="vertical-align:top; width:70px; padding:0px !important; margin:0px">
      <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
      <tr>
      <th style="color:#98a9ca;background-color:#405D99;font-size:12px;font-weight:normal;height:20px; border-left:1px solid #98a9ca">
...
Ach.
         ...
         <tr>
         <td style="border-bottom:1px solid #dddddd;height:15px;">
         <asp:Label runat="server" ID="lblFactorytargetActualBiplTgt" ForeColor="Gray" Text='<%# Eval("lineTotalTgt") %>'></asp:Label>
         </td>
         </tr>
          <tr>
         <td style="border-bottom:1px solid #dddddd;height:15px;">
          <asp:Label runat="server" ID="lblFactorytargetActualBiplAct" ForeColor="Gray" Text='<%# Eval("lineTotalAct") %>'></asp:Label>
         </td>
         </tr>
          <tr>
         <td>
    ...
    <table cellpadding="0" cellspacing="0" border="0" style="width:auto">
     <tr>
  <td colspan="4" style="background-color:#405D99;height:20px;border-bottom: 1px solid #98a9ca;color: #98a9ca; font-size: 14px;">
  Factory Line/Slot Specific Achievement
      ...
      <tr>
      <td style="vertical-align:top; width:150px;padding:0px !important; margin:0px">
      <table cellpadding="0" cellspacing="0" border="0" style="width:100%">
      <tr>
      <th style="color:White;background-color:#405D99;font-size:12px;font-weight:normal;height:20px; border-right:1px solid #98a9ca">
      &nbsp;
      </th>
      </tr>
      <tr>
      ...
      <asp:GridView runat="server" ID="grdFactorytargetSlot" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="false"
            HeaderStyle-ForeColor="#FFFFFF" HeaderStyle-BackColor="#405D99" HeaderStyle-HorizontalAlign="Center" Width="100%" OnRowDataBound="grdFactorytargetSlot_RowDataBound" HeaderStyle-Height="20px">
            <Columns>
            ...
            <asp:TemplateField HeaderStyle-Width="67%">
               <ItemTemplate>           
                 <asp:Label runat="server" ID="lblNoOfMonth" Text='<%# Eval("No_Of_Months") %>'></asp:Label> Month     
                </ItemTemplate>
              <ItemStyle Height="14px" ForeColor="Gray" />
            <HeaderStyle Height="20px" CssClass="header-right" />
            </asp:TemplateField>
            </Columns>
      ...
      <td style="padding:0px; margin:0px">
       <asp:GridView runat="server" ID="grdC4546FactorytargetActualSlot" ShowHeader="true" AutoGenerateColumns="false" HeaderStyle-Height="20px" HeaderStyle-Font-Size="12px" HeaderStyle-Font-Bold="false"
         ...
         <Columns>
            <asp:TemplateField HeaderStyle-Width="70px" HeaderStyle-Height="20px">
            <HeaderTemplate>
               Line 1 
      ...
      <td style="vertical-align:top;padding:0px !important; margin:0px">
          <table cellpadding="0" cellspacing="0" border="0">
      <tr>
      <th style="color:#98a9ca;background-color:#405D99;font-size:12px;border-right:1px solid white;font-weight:normal;height:20px;">
