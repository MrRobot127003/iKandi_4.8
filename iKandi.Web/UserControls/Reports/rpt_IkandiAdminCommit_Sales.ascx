<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="rpt_IkandiAdminCommit_Sales.ascx.cs"
    Inherits="iKandi.Web.UserControls.Reports.rpt_IkandiAdminCommit_Sales" %>
<style type="text/css">
    .HeaderClass td
    {
        background: #dddfe4;
