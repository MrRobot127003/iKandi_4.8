...
{
    public partial class RptIkandiCommit_DC : System.Web.UI.UserControl
    {
        ...
        public void BindGrid()
        {
            ...
            DataSet ds = this.ClientControllerInstance.GetIkandiSales_AdminByYearNew_Report_DC(Convert.ToInt32(year[0]), Convert.ToInt32(year[1]));
        ...
        protected void grdIkandiadminCommit_sales_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            if (e.Row.RowType == DataControlRowType.Header)
            {
                ...
                HeaderCell.Attributes.Add("class", "HeaderNameWidth");
                ...
                HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                HeaderCell.RowSpan = 4;
                HeaderCell.Attributes.Add("class", "HeaderDepWidth");
                headerRow1.Cells.Add(HeaderCell);
                ...
                HeaderCell.Text = "Target";
                HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                HeaderCell.Attributes.Add("class", "minWidthHeTarget");
                headerRow4.Cells.Add(HeaderCell);

                HeaderCell = new TableCell();
                HeaderCell.Text = "Actual";
                HeaderCell.HorizontalAlign = HorizontalAlign.Center;
                HeaderCell.Attributes.Add("class", "minWidthHeActual");
                headerRow4.Cells.Add(HeaderCell);
