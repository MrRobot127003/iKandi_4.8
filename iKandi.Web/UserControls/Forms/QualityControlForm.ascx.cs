...
{
    public partial class QualityControlForm : BaseUserControl
    {
        ...
        protected void repeaterQtyCheckedItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
               // qualityControl.OrderDetail.OrderSizes[e.Item.ItemIndex].Quantity * Convert.ToInt32((txtActualSamplesChecked.Text == String.Empty) ? "0" : txtActualSamplesChecked.Text) / Convert.ToInt32(lblTotalQty.Text);
        ...
        private void PopulateQualityData()
        {
            ...
            if (OrderDetailID != -1)
            {
                ...
                qualityControl = this.QualityControllerInstance.GetQualityControlByID(OrderDetailID);
