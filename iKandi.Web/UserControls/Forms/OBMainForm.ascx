<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="OBMainForm.ascx.cs" Inherits="iKandi.Web.UserControls.Forms.OBMainForm" %>
...
<div class="print-box">
  <div class="form_box">
    <div class="form_heading">
      <strong style="color:#39589c;">OB FORM</strong>
    </div>
    <div>
          ...
          <td>
            <table border="0" align="right">
              <tr>
                ...
                <td align="left">
                  <asp:TextBox runat="server" ID="txtStyleNo" Style="width: 180px" CssClass="do-not-disable style-code" MaxLength="16"></asp:TextBox>
                  <asp:HiddenField runat="server" Value="-1" ID="hdnStyleID" />
                </td>
                <td style="width: 75px">
                  <asp:Button ID="btnGo" runat="server" class="go do-not-disable" Text="Search" OnClick="btnGo_Click" />
                </td>
                <td>Client</td>
