...
{
    public partial class mo_dinesh_new : BaseUserControl
    {
        ...
        //new code raghvinder 13 feb 2020
        ...
        private void BindOrderDetailMode(bool isIkandiClient, int CostingId, int ClientId, int DepartmentId, DropDownList ddlMode, int ModeId, int OrderDetailId)
        {
            ...
            ddlMode.Items[0].Attributes.Add("disabled", "disabled");
            ...
            if (isIkandiClient)
            {
                ...
                {
                    int[] permitedModes = { 35, 37, 38 };
                    if (!permitedModes.Contains(objList[i].ModeId) && objList[i].EnableMode == false)
                    {
                        ddlMode.Items[j].Attributes.Add("disabled", "disabled");
                    }
                    j++;
                }
            }
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            //    GridHeader.Attributes.Add("class", "item_list2");
                        ...
                        if (flag == true)
                        {
                            ...
                            if (strSeaVal == "Yes")
                            {
                                if (Session["SearchValues"] != null)
                                {
                                    ...
                                    this.FabricName = dtTemp.Rows[0]["dcFabricName"].ToString();
        ...
        protected void GridView1_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            HtmlGenericControl spn_openThreadAveragePage = (HtmlGenericControl)e.Row.FindControl("spn_openThreadAveragePage");
            HiddenField CuttingStatus = (HiddenField)e.Row.FindControl("hdnCuttingStatus");
            HiddenField IsThreadAverageOptionOnMOVisible = (HiddenField)e.Row.FindControl("hdnIsThreadAverageOptionOnMOVisible");

            //CuttingStatus = 1 means CuttingStarted, 2 means 100% Cutting Done
            if (IsThreadAverageOptionOnMOVisible.Value == "1" && CuttingStatus.Value == "1")
            {
                spn_openThreadAveragePage.Visible = true;
            }
            else
            {
                spn_openThreadAveragePage.Visible = false;
            }
            ...
            Label lblCutwidth5 = e.Row.FindControl("lblCutwidth5") as Label;
            Label lblCutwidth6 = e.Row.FindControl("lblCutwidth6") as Label;
            ...
            // Label lblStitchTotal_Footer = e.Row.FindControl("lblStitchTotal_Footer") as Label;
            ...
            HtmlGenericControl photoshoot_text = e.Row.FindControl("photoshoot_text") as HtmlGenericControl;
            ...
            HtmlTableCell td12f5 = e.Row.FindControl("td12f5") as HtmlTableCell;
            HtmlTableCell td12f6 = e.Row.FindControl("td12f6") as HtmlTableCell;


            HtmlTableCell td10f5 = e.Row.FindControl("td10f5") as HtmlTableCell;
            HtmlTableCell td10f6 = e.Row.FindControl("td10f6") as HtmlTableCell;
            ...
            HtmlTableCell td1p5 = e.Row.FindControl("td1p5") as HtmlTableCell;
            HtmlTableCell td2p5 = e.Row.FindControl("td2p5") as HtmlTableCell;
            HtmlTableCell td1p6 = e.Row.FindControl("td1p6") as HtmlTableCell;
            HtmlTableCell td2p6 = e.Row.FindControl("td2p6") as HtmlTableCell;
            ...
            td1p5.Style.Add("background-color", od.BulkApproval5BackColor);
            td1p6.Style.Add("background-color", od.BulkApproval6BackColor);
            //END
            ...
            td12f5.Style.Add("background-color", od.Percent5BackColor);
            td12f6.Style.Add("background-color", od.Percent6BackColor);
            ...
            HtmlImage imgBiplPrice = (HtmlImage)e.Row.FindControl("imgBiplPrice");
            ...
            HiddenField hdnQualityID_1 = (HiddenField)e.Row.FindControl("hdnQualityID_1");
            HiddenField hdnQualityID_2 = (HiddenField)e.Row.FindControl("hdnQualityID_2");
            HiddenField hdnQualityID_3 = (HiddenField)e.Row.FindControl("hdnQualityID_3");
            HiddenField hdnQualityID_4 = (HiddenField)e.Row.FindControl("hdnQualityID_4");
            HiddenField hdnQualityID_5 = (HiddenField)e.Row.FindControl("hdnQualityID_5");
            HiddenField hdnQualityID_6 = (HiddenField)e.Row.FindControl("hdnQualityID_6");
            ...
            HtmlGenericControl fabric5name = (HtmlGenericControl)e.Row.FindControl("fabric5name");
            HtmlGenericControl fabric6name = (HtmlGenericControl)e.Row.FindControl("fabric6name");
            HtmlGenericControl chkPhotoshot_wrap = (HtmlGenericControl)e.Row.FindControl("chkPhotoshot_wrap");
            ...
            HtmlTableRow trfiveFabric = (HtmlTableRow)e.Row.FindControl("trfiveFabric");
            HtmlTableRow trfiveprint = (HtmlTableRow)e.Row.FindControl("trfiveprint");

            HtmlTableRow trsixFabric = (HtmlTableRow)e.Row.FindControl("trsixFabric");
            HtmlTableRow trsixprint = (HtmlTableRow)e.Row.FindControl("trsixprint");
            ...
            if (Convert.ToInt32(hdnQualityID_1.Value) >= 20000)
            {
                fabric1name.Attributes.Add("style", "color:gray !important");
            }
            if (Convert.ToInt32(hdnQualityID_2.Value) >= 20000)
            {
                fabric2name.Attributes.Add("style", "color:gray !important");
            }
            if (Convert.ToInt32(hdnQualityID_3.Value) >= 20000)
            {
                fabric3name.Attributes.Add("style", "color:gray !important");
            }
            if (Convert.ToInt32(hdnQualityID_4.Value) >= 20000)
            {
                fabric4name.Attributes.Add("style", "color:gray !important");
            }
            if (Convert.ToInt32(hdnQualityID_5.Value) >= 20000)
            {
                fabric5name.Attributes.Add("style", "color:gray !important");
            }
            if (Convert.ToInt32(hdnQualityID_6.Value) >= 20000)
            {
                fabric6name.Attributes.Add("style", "color:gray !important");
            }
            //if (od.OBfile != "")
            ...
            Label lblFab5 = (Label)e.Row.FindControl("lblFab5");
            Label lblFab6 = (Label)e.Row.FindControl("lblFab6");
            ...
            if (spnSerialNumber != null)
            {
                ...
                if (hdnSerialNumber.Value.Substring(0, 3) == "ASO" || hdnSerialNumber.Value.Substring(0, 3) == "RIV")
                {
                    chkPhotoshot_wrap.Style.Add("display", "none!important");
            ...
            if (spnBiplPrice != null)
            {
                if (od.bBIPLPricewrite != true)
                {
                    if (od.bBIPLPrice != true)
                    {
                        ...
                        imgBiplPrice.Visible = false;
                    }
                    else
                    {
                        spnBiplPrice.Visible = false;
                        lblBiplPrice.Visible = true;
                        imgBiplPrice.Visible = true;
                    }
                }
                else
                {
            ...
            Label lblFabric5Details = e.Row.FindControl("lblFabric5Details") as Label;
            Label lblFabric6Details = e.Row.FindControl("lblFabric6Details") as Label;
            ...
            Label lblfabricApprovalColor5 = e.Row.FindControl("lblfabricApprovalColor5") as Label;
            Label lblfabricApprovalColor6 = e.Row.FindControl("lblfabricApprovalColor6") as Label;
            ...
            else
            {
                ...
                {
                    if (od.CutWidth5 != 0)
                        lblCutwidth5.Text = "/" + od.CutWidth5 + " in";
                    lblCutwidth5.Visible = true;
                    fabric5name.Visible = true;
                    lblFab5.Visible = false;
                    lblFabric5Details.Visible = true;
                    lblfabricApprovalColor5.Visible = true;
                    fabric5name.Attributes.Add("onclick", "javascript:return ShowFabricApproval(" + od.ParentOrder.Style.client.ClientID + ", " + od.OrderID + ", " + od.OrderDetailID + ", " + "'" + fabric5name.InnerText.Trim() + "', " + "'" + lblFabric5Details.Text.Trim() + "','" + 5 + "');");
                }
                if (fabric6name != null)
                {
                    if (od.CutWidth6 != 0)
                        lblCutwidth6.Text = "/" + od.CutWidth6 + " in";
                    lblCutwidth6.Visible = true;
                    fabric6name.Visible = true;
                    lblFab6.Visible = false;
                    lblFabric6Details.Visible = true;
                    lblfabricApprovalColor6.Visible = true;
                    fabric6name.Attributes.Add("onclick", "javascript:return ShowFabricApproval(" + od.ParentOrder.Style.client.ClientID + ", " + od.OrderID + ", " + od.OrderDetailID + ", " + "'" + fabric6name.InnerText.Trim() + "', " + "'" + lblFabric6Details.Text.Trim() + "','" + 6 + "');");
                }
            }
            //if (iKandi.Web.Components.ApplicationHelper.LoggedInUser.UserData.Company == iKandi.Common.Company.Boutique)
            //{
            ...
            if (td10f5 != null)
            {
                if (od.Fabric5 != "")
                {
                    trfiveFabric.Visible = true;
                    trfiveprint.Visible = true;
                }
            }
            if (td10f6 != null)
            {
                if (od.Fabric6 != "")
                {
                    trsixFabric.Visible = true;
                    trsixprint.Visible = true;
                }
            }
            ...
            lblikandiGross.Text = "(<span style='color:#0BCD60'> ₹" + Convert.ToString(od.BoutiqueBusiness) + " " + "Lac</span>)";
            ...
            Label technical1 = (Label)e.Row.FindControl("technical");
            Label lblplan1 = (Label)e.Row.FindControl("lblplan");
            Label lblanchoeDetail_Rescan1 = (Label)e.Row.FindControl("lblanchoeDetail_Rescan");
            Label lblhistory1 = (Label)e.Row.FindControl("lblhistory");
            Label lblStatusMode11 = (Label)e.Row.FindControl("lblStatusMode");
            HyperLink lnkreallocation1 = e.Row.FindControl("lnkreallocation") as HyperLink;
            HtmlAnchor lnkopenShipedPopoup1 = e.Row.FindControl("lnkopenShipedPopoup") as HtmlAnchor;
            Label lblst1 = (Label)e.Row.FindControl("lblst");
            ...
            if (od.IsShiped == true)
            {
                ...
                technical1.Style.Add("background-color", "#F9F9FA");
                technical1.Style.Add("color", "#807F80");

                lblplan1.Style.Add("background-color", "#F9F9FA");
                lblplan1.Style.Add("color", "#807F80");

                lblanchoeDetail_Rescan1.Style.Add("background-color", "#F9F9FA");
                lblanchoeDetail_Rescan1.Style.Add("color", "#807F80");

                lblhistory1.Style.Add("background-color", "#F9F9FA");
                lblhistory1.Style.Add("color", "#807F80");

                lblStatusMode11.Style.Add("background-color", "#F9F9FA");
                lblStatusMode11.Style.Add("color", "#807F80");

                lnkreallocation1.Style.Add("background-color", "#F9F9FA");
                lnkreallocation1.Style.Add("color", "#807F80");

                lnkopenShipedPopoup1.Style.Add("background-color", "#F9F9FA");
                lnkopenShipedPopoup1.Style.Add("color", "#807F80");

                lblst1.Style.Add("background-color", "#F9F9FA");
                lblst1.Style.Add("color", "#807F80");
            ...
            HiddenField hdnFab5 = e.Row.FindControl("hdnFab5") as HiddenField;
            HiddenField hdnFab6 = e.Row.FindControl("hdnFab6") as HiddenField;
            ...
            HiddenField hdnFina5Fabric_ToolTip = e.Row.FindControl("hdnFina5Fabric_ToolTip") as HiddenField;
            HiddenField hdnFina6Fabric_ToolTip = e.Row.FindControl("hdnFina6Fabric_ToolTip") as HiddenField;
            ...
            TextBox lblSummary5 = e.Row.FindControl("lblSummary5") as TextBox;
            TextBox lblSummary6 = e.Row.FindControl("lblSummary6") as TextBox;
            ...
            Label lblFabric5OrderAverage = e.Row.FindControl("lblFabric5OrderAverage") as Label;
            Label lblFabric6OrderAverage = e.Row.FindControl("lblFabric6OrderAverage") as Label;

            Label lblFabric4STCAverage = e.Row.FindControl("lblFabric4STCAverage") as Label;
            Label lblFabric5STCAverage = e.Row.FindControl("lblFabric5STCAverage") as Label;
            Label lblFabric6STCAverage = e.Row.FindControl("lblFabric6STCAverage") as Label;
            Label lblFinalOrderFabric4 = e.Row.FindControl("lblFinalOrderFabric4") as Label;
            Label lblFinalOrderFabric5 = e.Row.FindControl("lblFinalOrderFabric5") as Label;
            Label lblFinalOrderFabric6 = e.Row.FindControl("lblFinalOrderFabric6") as Label;
            ...
            TextBox lblQuantityAvl5 = e.Row.FindControl("lblQuantityAvl5") as TextBox;
            lblQuantityAvl5.Text = lblQuantityAvl5.Text == "0k" ? "" : lblQuantityAvl5.Text;

            TextBox lblQuantityAvl6 = e.Row.FindControl("lblQuantityAvl6") as TextBox;
            lblQuantityAvl6.Text = lblQuantityAvl6.Text == "0k" ? "" : lblQuantityAvl6.Text;

            Label lblPercent4 = e.Row.FindControl("lblPercent4") as Label;
            Label lblPercent5 = e.Row.FindControl("lblPercent5") as Label;
            Label lblPercent6 = e.Row.FindControl("lblPercent6") as Label;
            ...
            TextBox txtFab5StartEta = e.Row.FindControl("lblFab5StartEta") as TextBox;
            TextBox txtFab6StartEta = e.Row.FindControl("lblFab6StartEta") as TextBox;
            ...
            TextBox txtFab5EndEta = e.Row.FindControl("lblFab5EndEta") as TextBox;
            TextBox txtFab6EndEta = e.Row.FindControl("lblFab6EndEta") as TextBox;
            ...
            //if (LabelBIHname.ForeColor == System.Drawing.ColorTranslator.FromHtml("#FFFF96"))
            //{
            //    LabelBIHname.ForeColor = System.Drawing.Color.Red;
            //}
            //else if (LabelBIHname.ForeColor == System.Drawing.ColorTranslator.FromHtml("#000000"))
            //{
            //    LabelBIHname.ForeColor = System.Drawing.Color.Green;

            //}
            //else if (Convert.ToDateTime(lblBulkInhouseTgt.Text) == today.)
            //{
            //    LabelBIHname.ForeColor = System.Drawing.Color.Blue;

            //}

            //if (lblBulkInhouseTgt.ForeColor ==System.Drawing.ColorTranslator.FromHtml("#FFFF96"))
            //{

            //    lblBulkInhouseTgt.ForeColor = System.Drawing.Color.Red;
            //}
            //else if (lblBulkInhouseTgt.ForeColor == System.Drawing.ColorTranslator.FromHtml("#000000"))
            //{

            //    lblBulkInhouseTgt.ForeColor = System.Drawing.Color.Green;

            //}
            //else
            //{
            //    lblBulkInhouseTgt.ForeColor = System.Drawing.Color.Blue;
            //}

            // dinesh
            HtmlGenericControl threadaverage_btn = e.Row.FindControl("threadaverage_btn") as HtmlGenericControl;
            ...
            if (od.IsShiped == true)
            {
                ...
                lblSummary5.Attributes.Add("color", od.SummryColor);
                lblSummary6.Attributes.Add("color", od.SummryColor);
            ...
            else
            {
                ...
                if (od.Caption5 == "Black")
                {
                    lblSummary5.CssClass = "summaryColor1";
                }
                if (od.Caption5 == "Red")
                {
                    lblSummary5.CssClass = "summaryColor2";
                }
                if (od.Caption5 == "Green")
                {
                    lblSummary5.CssClass = "summaryColor3";
                }
                if (od.Caption6 == "Black")
                {
                    lblSummary6.CssClass = "summaryColor1";
                }
                if (od.Caption6 == "Red")
                {
                    lblSummary6.CssClass = "summaryColor2";
                }
                if (od.Caption6 == "Green")
                {
                    lblSummary6.CssClass = "summaryColor3";
                }
            }
            ...
            if (lblPercent5.Visible != false)
            {

                // Add By Ravi kumar on 6/2/2015
                if (BIHDate.Date >= System.DateTime.Now.Date)
                {
                    if (txtFab5EndEta.Text != "")
                    {
                        if (lblPercent5.Text != "")
                        {
                            //if (Convert.ToInt32(lblPercent5.Text) >= 100)
                            //{
                            //    BIH_ColorGreen = 1;
                            //}
                            //else
                ...
                if (BIHDate.Date < System.DateTime.Now.Date)
                {
                    if (txtFab5EndEta.Text != "")
                    {
                        //if (BIHDate.Date < Convert.ToDateTime(od.Fabric5ENDETA).Date)
                        //{
                        //    BIH_ColorRed = 1;
                        //}
                        if (lblPercent5.Text != "")
            ...
            if (lblPercent6.Visible != false)
            {

                // Add By Ravi kumar on 6/2/2015
                if (BIHDate.Date >= System.DateTime.Now.Date)
                {
                    if (txtFab6EndEta.Text != "")
                    {
                        if (lblPercent6.Text != "")
                        {
                            //if (Convert.ToInt32(lblPercent6.Text) >= 100)
                            //{
                            //    BIH_ColorGreen = 1;
                            //}
                            //else
                ...
                if (BIHDate.Date < System.DateTime.Now.Date)
                {
                    if (txtFab6EndEta.Text != "")
                    {
                        //if (BIHDate.Date < Convert.ToDateTime(od.Fabric6ENDETA).Date)
                        //{
                        //    BIH_ColorRed = 1;
                        //}
                        if (lblPercent6.Text != "")
            ...
            if (hdnFab5 != null)
            {
                if (hdnFab5.Value == "")
                {
                    lblFabric5Details.Text = "";
                    lblFabric5OrderAverage.Text = "";
                    lblFabric5STCAverage.Text = "";
                    lblFinalOrderFabric5.Text = "";
                    lblQuantityAvl5.Text = "";
                    lblPercent5.Text = "";
                    lblFabric5STCAverage.Visible = false;
                    lblSummary5.Visible = false;
                }
                else
                {
                    lblPercent5.Text = lblPercent5.Text + '%';
                }
            }
            if (hdnFab6 != null)
            {
                if (hdnFab6.Value == "")
                {
                    lblFabric6Details.Text = "";
                    lblFabric6OrderAverage.Text = "";
                    lblFabric6STCAverage.Text = "";
                    lblFinalOrderFabric6.Text = "";
                    lblQuantityAvl6.Text = "";
                    lblPercent6.Text = "";
                    lblFabric6STCAverage.Visible = false;
                    lblSummary6.Visible = false;
                }
                else
                {
                    lblPercent6.Text = lblPercent6.Text + '%';
                }
            }
            ...
            if (Access_ColorRed == 1)
            {
                ...
                if (od.FBIHDateRead == true)
                {
                    ...
                    else
                    {
                        ...
                        // LabelAccBIHname.Style.Add("color", "#FF3300");
            ...
            else
            {
                if (od.FBIHDateRead == true)
                {
                    ...
                    else
                    {
                        ...
                        // LabelAccBIHname.Style.Add("color", "#F1F1F1");
                        // lblACCBulkInhouseTgt.Style.Add("color", "#000000");
                    }
                }
                else
            ...
            else
            {
                ...
                lblPriceSymbol.Attributes.Add("style", "font-size:10px;");
                lblikandiGross.Attributes.Add("style", "font-size:8px;");
            }
            ...
            BindOrderDetailMode(Convert.ToBoolean(od.IsIkandiClient), od.ParentOrder.Costing.CostingID, od.ParentOrder.Style.client.ClientID, od.ParentOrder.Style.DepartmentID, ddlModeChange, Convert.ToInt32(hdnModeId.Value), od.OrderDetailID);
            if (hdnModeId.Value != "")
            {
            ...
            if (od.FOrdWrite == true)
                td2p1.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");
            //  OrderController objOrderController = new OrderController();
            int orderDetailID = 0;
            ...
            if (od.FOrdWrite == true)
                td2p2.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");
            ...
            if (od.FOrdWrite == true)
                td2p3.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");
            ...
            if (od.FOrdWrite == true)
                td2p4.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");
            ...
            //dinesh
            string avg5 = lblFabric5OrderAverage.Text;
            string Fabric5 = hdnFab5.Value;
            string txtavg5 = lblFabric5STCAverage.Text;
            // lblFabric4STCAverage.Attributes.Add("onclick", "javascript:return UpdateCutAvg(this,'5', '" + avg5 + "', '" + StyleId + "', '" + Fabric5 + "')");
            if (od.FOrdWrite == true)
                td2p5.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");


            string avg6 = lblFabric6OrderAverage.Text;
            string Fabric6 = hdnFab6.Value;
            string txtavg6 = lblFabric6STCAverage.Text;
            // lblFabric4STCAverage.Attributes.Add("onclick", "javascript:return UpdateCutAvg(this,'6', '" + avg6 + "', '" + StyleId + "', '" + Fabric5 + "')");
            if (od.FOrdWrite == true)
                td2p6.Attributes.Add("onclick", "javascript:return UpdateCutAvg('" + od.OrderID + "')");
            ...
            if (lblFabric4STCAverage.Text == "0")
                lblFabric4STCAverage.Text = "";
            if (lblFabric5STCAverage.Text == "0")
                lblFabric5STCAverage.Text = "";
            if (lblFabric6STCAverage.Text == "0")
                lblFabric6STCAverage.Text = "";
            ...
            if (lblPercent4.Text == "0%")
                lblPercent4.Text = "";
            if (lblPercent5.Text == "0%")
                lblPercent5.Text = "";
            if (lblPercent6.Text == "0%")
                lblPercent6.Text = "";
            ...
            if (lblQuantityAvl4.Text == "0")
                lblQuantityAvl4.Text = "";
            if (lblQuantityAvl5.Text == "0")
                lblQuantityAvl5.Text = "";
            if (lblQuantityAvl6.Text == "0")
                lblQuantityAvl6.Text = "";
            ...
            if (lblFinalOrderFabric4.Text == "0")
                lblFinalOrderFabric4.Text = "";
            if (lblFinalOrderFabric5.Text == "0")
                lblFinalOrderFabric5.Text = "";
            if (lblFinalOrderFabric6.Text == "0")
                lblFinalOrderFabric6.Text = "";
            ...
            TextBox txtinhouseqntyfab5 = e.Row.FindControl("txtinhouseqntyfab5") as TextBox;
            TextBox txtinhouseqntyfab6 = e.Row.FindControl("txtinhouseqntyfab6") as TextBox;
            ...
            HiddenField hdnFab5incheckedval = e.Row.FindControl("hdnFab5incheckedval") as HiddenField;
            HiddenField hdnFab6incheckedval = e.Row.FindControl("hdnFab6incheckedval") as HiddenField;
            ...
            if (txtinhouseqntyfab5.Text == "0")
                txtinhouseqntyfab5.Text = "";
            if (txtinhouseqntyfab6.Text == "0")
                txtinhouseqntyfab6.Text = "";
            ...
            txtinhouseqntyfab5.Text = txtinhouseqntyfab5.Text == "0k" ? "" : txtinhouseqntyfab5.Text;
            txtinhouseqntyfab6.Text = txtinhouseqntyfab6.Text == "0k" ? "" : txtinhouseqntyfab6.Text;
            ...
            if (hdnFab5incheckedval.Value != "0" && hdnFab5incheckedval.Value != "")
            {
                txtinhouseqntyfab5.ToolTip = Convert.ToInt32(hdnFab5incheckedval.Value).ToString("N0");
            }
            if (hdnFab6incheckedval.Value != "0" && hdnFab6incheckedval.Value != "")
            {
                txtinhouseqntyfab6.ToolTip = Convert.ToInt32(hdnFab6incheckedval.Value).ToString("N0");
            }
            ...
            Label lblfabinHouseAvg5 = e.Row.FindControl("lblfabinHouseAvg5") as Label;
            Label lblfabinHouseAvg6 = e.Row.FindControl("lblfabinHouseAvg6") as Label;
            ...
            if (!string.IsNullOrEmpty(hdnFab5incheckedval.Value) && !string.IsNullOrEmpty(lblFabric5STCAverage.Text))
            {
                string fab5CutIssueAvgtooltip = Math.Round((Convert.ToDecimal(hdnFab5incheckedval.Value) / Convert.ToDecimal(lblFabric5STCAverage.Text)), 0, MidpointRounding.AwayFromZero).ToString();
                string fab5CutIssueAvgIn_K = Math.Round(((Convert.ToDecimal(hdnFab5incheckedval.Value) / Convert.ToDecimal(lblFabric5STCAverage.Text)) / 1000), 1, MidpointRounding.AwayFromZero).ToString();
                lblfabinHouseAvg5.Text = " (" + fab5CutIssueAvgIn_K + "k Pcs)";
                lblfabinHouseAvg5.Text = lblfabinHouseAvg5.Text == " (0k Pcs)" ? "" : lblfabinHouseAvg5.Text;
                lblfabinHouseAvg5.ToolTip = Convert.ToInt32(fab5CutIssueAvgtooltip).ToString("N0");
                //txtinhouseqntyfab1.Text = txtinhouseqntyfab1.Text +" "+ lblfabinHouseAvg.Text;
            }
            if (od.IsShiped == true)
                lblfabinHouseAvg5.ForeColor = Color.Gray;

            if (!string.IsNullOrEmpty(hdnFab6incheckedval.Value) && !string.IsNullOrEmpty(lblFabric6STCAverage.Text))
            {
                string fab6CutIssueAvgtooltip = Math.Round((Convert.ToDecimal(hdnFab6incheckedval.Value) / Convert.ToDecimal(lblFabric6STCAverage.Text)), 0, MidpointRounding.AwayFromZero).ToString();
                string fab6CutIssueAvgIn_K = Math.Round(((Convert.ToDecimal(hdnFab6incheckedval.Value) / Convert.ToDecimal(lblFabric6STCAverage.Text)) / 1000), 1, MidpointRounding.AwayFromZero).ToString();
                lblfabinHouseAvg6.Text = " (" + fab6CutIssueAvgIn_K + "k Pcs)";
                lblfabinHouseAvg6.Text = lblfabinHouseAvg6.Text == " (0k Pcs)" ? "" : lblfabinHouseAvg6.Text;
                lblfabinHouseAvg6.ToolTip = Convert.ToInt32(fab6CutIssueAvgtooltip).ToString("N0");
                //txtinhouseqntyfab1.Text = txtinhouseqntyfab1.Text +" "+ lblfabinHouseAvg.Text;
            }
            if (od.IsShiped == true)
                lblfabinHouseAvg6.ForeColor = Color.Gray;
            ...
            if (lblFinalOrderFabric1.Text != "")
            {
                ...
                //Commented on 10 feb 23
                //double finalOrder1 = 0;
                //finalOrder1 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric1.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric1.Text = Math.Round((finalOrder1), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                // End  

                lblFinalOrderFabric1.Text = lblFinalOrderFabric1.Text + " %";
            ...
            if (lblFinalOrderFabric2.Text != "")
            {
                ...
                //finalOrder2 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric2.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric2.Text = Math.Round((finalOrder2), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                // End   

                lblFinalOrderFabric2.Text = lblFinalOrderFabric2.Text + " %";
            ...
            if (lblFinalOrderFabric3.Text != "")
            {
                ...
                //finalOrder3 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric3.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric3.Text = Math.Round((finalOrder3), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                //END

                lblFinalOrderFabric3.Text = lblFinalOrderFabric3.Text + " %";
            }
            if (lblFinalOrderFabric4.Text != "")
            {
                ...
                //finalOrder4 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric4.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric4.Text = Math.Round((finalOrder4), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                //END

                lblFinalOrderFabric4.Text = lblFinalOrderFabric4.Text + " %";
            }
            if (lblFinalOrderFabric5.Text != "")
            {
                //lblFinalOrderFabric4.ToolTip = string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:N0}", Convert.ToString(finalOrder4 * 1000));
                // double FinalOrderFabric4_kd = (finalOrder4 / 1000);

                //Commented on 10 feb 23
                //double finalOrder5 = 0;
                //finalOrder5 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric5.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric5.Text = Math.Round((finalOrder5), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                //END

                lblFinalOrderFabric5.Text = lblFinalOrderFabric5.Text + " %";
            }
            if (lblFinalOrderFabric6.Text != "")
            {
                //lblFinalOrderFabric4.ToolTip = string.Format(System.Globalization.CultureInfo.InvariantCulture, "{0:N0}", Convert.ToString(finalOrder4 * 1000));
                // double FinalOrderFabric4_kd = (finalOrder4 / 1000);

                //Commented on 10 feb 23
                //double finalOrder6 = 0;
                //finalOrder6 = (Convert.ToDouble(Convert.ToString(lblFinalOrderFabric6.Text).Replace(",", "").Replace("k", "")) / 1000);
                //lblFinalOrderFabric6.Text = Math.Round((finalOrder6), 1, MidpointRounding.AwayFromZero).ToString() + "k";
                //END

                lblFinalOrderFabric6.Text = lblFinalOrderFabric6.Text + " %";
            }
            ...
            lblFinalOrderFabric5.Text = lblFinalOrderFabric5.Text == "0.0k" ? "" : lblFinalOrderFabric5.Text;
            lblFinalOrderFabric6.Text = lblFinalOrderFabric6.Text == "0.0k" ? "" : lblFinalOrderFabric6.Text;
            ...
            lblFinalOrderFabric5.ToolTip = od.Fabric5Required_ToolTip;
            lblFinalOrderFabric6.ToolTip = od.Fabric6Required_ToolTip;
            ...
            hdnFina5Fabric_ToolTip.Value = lblFinalOrderFabric5.ToolTip == "" ? "0" : lblFinalOrderFabric5.ToolTip;
            hdnFina6Fabric_ToolTip.Value = lblFinalOrderFabric6.ToolTip == "" ? "0" : lblFinalOrderFabric6.ToolTip;
            ...
            {
                lblIsRepeatOrder.Text = od.IsRepeat == true ? "&nbsp;&nbsp;&nbsp;(DR)" : string.Empty;
            ...
            TextBox txtStrikeof5 = (TextBox)e.Row.FindControl("txtStrikeof5");
            TextBox txtStrikeof6 = (TextBox)e.Row.FindControl("txtStrikeof6");
            ...
            if (od.IntialAprd5 != 2)
                txtStrikeof5.Attributes.Add("class", "th do-not-allow-typing");
            if (od.IntialAprd6 != 2)
                txtStrikeof6.Attributes.Add("class", "th do-not-allow-typing");
            ...
            //Technical Section Coloring new Logic :Start
            if (od.IsShiped == false)
            {
                DateTime handoverETA = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnhandoverETA")).Value);
                DateTime handoverActual = (((HiddenField)e.Row.FindControl("hdnhandoverActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnhandoverActual")).Value);
                TextBox txHandoverActual1 = (TextBox)e.Row.FindControl("txHandoverActual");
                if (handoverActual > handoverETA) txHandoverActual1.Style.Add("color", "#ff3300");
                else if (handoverActual <= handoverETA) txHandoverActual1.Style.Add("color", "green");
                else txHandoverActual1.Style.Add("color", "gray");


                DateTime patternreadyETA = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnpatternreadyETA")).Value);
                DateTime patternreadyActual = (((HiddenField)e.Row.FindControl("hdnpatternreadyActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnpatternreadyActual")).Value);
                TextBox txtPatternReadyActualDate1 = (TextBox)e.Row.FindControl("txtPatternReadyActualDate");
                if (patternreadyActual > patternreadyETA) txtPatternReadyActualDate1.Style.Add("color", "#ff3300");
                else if (patternreadyActual <= patternreadyETA) txtPatternReadyActualDate1.Style.Add("color", "green");
                else txtPatternReadyActualDate1.Style.Add("color", "gray");

                DateTime samplesentETA = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnsamplesentETA")).Value);
                DateTime samplesentActual = (((HiddenField)e.Row.FindControl("hdnsamplesentActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnsamplesentActual")).Value);
                TextBox txtSampleSentActualDate1 = (TextBox)e.Row.FindControl("txtSampleSentActualDate");
                if (samplesentActual > samplesentETA) txtSampleSentActualDate1.Style.Add("color", "#ff3300");
                else if (samplesentActual <= samplesentETA) txtSampleSentActualDate1.Style.Add("color", "green");
                else txtSampleSentActualDate1.Style.Add("color", "gray");

                DateTime fitcommentETA = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnfitcommentETA")).Value);
                DateTime fitcommentActual = (((HiddenField)e.Row.FindControl("hdnfitcommentActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnfitcommentActual")).Value);
                TextBox txtFitsCommentesUplaodActualDate1 = (TextBox)e.Row.FindControl("txtFitsCommentesUplaodActualDate");
                if (fitcommentActual > fitcommentETA) txtFitsCommentesUplaodActualDate1.Style.Add("color", "#ff3300");
                else if (fitcommentActual <= fitcommentETA) txtFitsCommentesUplaodActualDate1.Style.Add("color", "green");
                else txtFitsCommentesUplaodActualDate1.Style.Add("color", "gray");

                DateTime stcETA = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnstcETA")).Value);
                DateTime stcActual = (((HiddenField)e.Row.FindControl("hdnstcActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnstcActual")).Value);
                Label txtrequested = (Label)e.Row.FindControl("txtrequested");
                if (stcActual > stcETA) txtrequested.Style.Add("color", "#ff3300");
                else if (stcActual <= stcETA) txtrequested.Style.Add("color", "green");
                else txtrequested.Style.Add("color", "gray");

                DateTime patternsampleEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnpatternsampleEta")).Value);
                DateTime patternsampleActual = (((HiddenField)e.Row.FindControl("hdnpatternsampleActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnpatternsampleActual")).Value);
                TextBox lblPatternSampleDate1 = (TextBox)e.Row.FindControl("lblPatternSampleDate");
                if (patternsampleActual > patternsampleEta) lblPatternSampleDate1.Style.Add("color", "#ff3300");
                else if (patternsampleActual <= patternsampleEta) lblPatternSampleDate1.Style.Add("color", "green");
                else lblPatternSampleDate1.Style.Add("color", "gray");

                DateTime cuttingsheetEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdncuttingsheetEta")).Value);
                DateTime cuttingsheetActual = (((HiddenField)e.Row.FindControl("hdncuttingsheetActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdncuttingsheetActual")).Value);
                TextBox lblCuttingSheetDate1 = (TextBox)e.Row.FindControl("lblCuttingSheetDate");
                if (cuttingsheetActual > cuttingsheetEta) lblCuttingSheetDate1.Style.Add("color", "#ff3300");
                else if (cuttingsheetActual <= cuttingsheetEta) lblCuttingSheetDate1.Style.Add("color", "green");
                else lblCuttingSheetDate1.Style.Add("color", "gray");

                DateTime prodfileEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnprodfileEta")).Value);
                DateTime prodfileActual = (((HiddenField)e.Row.FindControl("hdnprodfileActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnprodfileActual")).Value);
                TextBox lblProductionFileDate1 = (TextBox)e.Row.FindControl("lblProductionFileDate");
                if (prodfileActual > prodfileEta) lblProductionFileDate1.Style.Add("color", "#ff3300");
                else if (prodfileActual <= prodfileEta) lblProductionFileDate1.Style.Add("color", "green");
                else lblProductionFileDate1.Style.Add("color", "gray");

                DateTime hoppmEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnhoppmEta")).Value);
                DateTime hoppmActual = (((HiddenField)e.Row.FindControl("hdnhoppmActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdnhoppmActual")).Value);
                Label lblHOPPMActual1 = (Label)e.Row.FindControl("lblHOPPMActual");
                if (hoppmActual > hoppmEta) lblHOPPMActual1.Style.Add("color", "#ff3300");
                else if (hoppmActual <= hoppmEta) lblHOPPMActual1.Style.Add("color", "green");
                else lblHOPPMActual1.Style.Add("color", "gray");

                DateTime topsentEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdntopsentEta")).Value);
                DateTime topsentActual = (((HiddenField)e.Row.FindControl("hdntopsentActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdntopsentActual")).Value);
                Label lblTopSendTarget1 = (Label)e.Row.FindControl("lblTopSendTarget");
                if (topsentActual > topsentEta) lblTopSendTarget1.Style.Add("color", "#ff3300");
                else if (topsentActual <= topsentEta) lblTopSendTarget1.Style.Add("color", "green");
                else lblTopSendTarget1.Style.Add("color", "gray");

                DateTime testreportEta = Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdntestreporteEta")).Value);
                DateTime testreportActual = (((HiddenField)e.Row.FindControl("hdntestreportActual")).Value) == "01-01-0001 00:00:00" ? DateTime.Now : Convert.ToDateTime(((HiddenField)e.Row.FindControl("hdntestreportActual")).Value);
                Label lblTestReportActualDate1 = (Label)e.Row.FindControl("lblTestReportActualDate");
                if (testreportActual > testreportEta) lblTestReportActualDate1.Style.Add("color", "#ff3300");
                else if (testreportActual <= testreportEta) lblTestReportActualDate1.Style.Add("color", "green");
                else lblTestReportActualDate1.Style.Add("color", "gray");
            }

            //Technical Section Coloring new Logic :END
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (txtPatternSampleDate.Text == "")
                    {
                        tdPatternSample.Style.Add("background-color", "#FDFD96");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (txtCuttingSheetDate.Text == "")
                    {
                        tdCuttingSheet.Style.Add("background-color", "#FDFD96");
            ...
            else
            {
                ...
                else
                {
                    if (txtProductionFileDate.Text == "")
                    {
                        tdProdFile.Style.Add("background-color", "#FDFD96");
            ...
            else
            {
                ...
                else
                {
                    if (txHandoverActual.Text == "")
                    {
                        tdHandover.Style.Add("background-color", "#FDFD96");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (lblHOPPMActual.Text == "")
                    {
                        tdHoPPM.Style.Add("background-color", "#FDFD96");
            ...
            Label lbltopsentt = (Label)e.Row.FindControl("lbltopsentt");
            ...
            else
            {
                ...
                else
                {
                    ...
                    if (lblTopSendTarget.Text == "")
                    {
                        tdTopSent.Style.Add("background-color", "#FDFD96");
            ...
            if (lblTOPETA != null)
            {
                if (od.FitsTOPSentRead == true)
                {
                    if (od.IsShiped == true)
                    {
                        ...
                        lbltopsentt.ForeColor = System.Drawing.Color.Black;
                        tdTopSent.Style.Add("background-color", "#F9F9FA");
        ...
        public void MOPaging(int StartIndex)
        {
            ...
            if (this.FabricName != null)
                hdnfld_FabricName.Value = this.FabricName;
            if (hdnfld_FabricName.Value != null)
                this.FabricName = hdnfld_FabricName.Value;
            ...
            DataColumn dcFabricName = new DataColumn("dcFabricName", typeof(string));
            dtSearchValue.Columns.Add(dcFabricName);
            ...
            dtSearchValue.Rows[0][dcFabricName] = this.FabricName;
        ...
        protected void repAccess_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            {
                bool IsExcludeFromBIH = Convert.ToBoolean(DataBinder.Eval(e.Item.DataItem, "IsExcludeFromBIH"));
                ...
                int Stage1 = Convert.ToInt32((DataBinder.Eval(e.Item.DataItem, "Stage1").ToString()));
                string Size = (DataBinder.Eval(e.Item.DataItem, "Size").ToString());
                int Inhouse_Percent = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "Inhouse_Percent"));
                int AccessRecQty = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "SRVReceivedQty"));
                int IssuedQty = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "IssuedQty"));
                int TotalQty = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "TotalQuantity"));
                int IsOldOrder = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "IsOldOrder"));
                //string GrieseFinishTooltip = (DataBinder.Eval(e.Item.DataItem, "Griege_Finish_Stage_tooltip").ToString());
                //string ProcessTooltip = (DataBinder.Eval(e.Item.DataItem, "Process_Stage_tooltip").ToString());
                int AccessoryPending_OrderId = Convert.ToInt32(DataBinder.Eval(e.Item.DataItem, "AccessoryPending_OrderId"));

                Label StageSelectionOption = (Label)e.Item.FindControl("StageSelectionOption");
                Label RaisePoOption = (Label)e.Item.FindControl("RaisePoOption");
                if (AccessoryPending_OrderId > 0)
                {

                    StageSelectionOption.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0BCD60");
                    RaisePoOption.ForeColor = System.Drawing.ColorTranslator.FromHtml("#0BCD60");

                    //imgPending.Src = "../../App_Themes/ikandi/images/icons8-open-in-popup-27.jpg";
                    //imgAccessoryR.Src = "../../App_Themes/ikandi/images/icons8-r-24Grn.jpg";

                }
                else
                {
                    StageSelectionOption.ForeColor = System.Drawing.Color.Blue;
                    RaisePoOption.ForeColor = System.Drawing.Color.Blue;

                    //imgPending.Src = "../../App_Themes/ikandi/images/icons8-open-in-popup-26.jpg";
                    //imgAccessoryR.Src = "../../App_Themes/ikandi/images/icons8-r-24Blu.jpg";
                }

                DateTime PoOrder_Date = Convert.ToDateTime(DataBinder.Eval(e.Item.DataItem, "PoOrder_Date"));
                DateTime SrvEndEta_Date = Convert.ToDateTime(DataBinder.Eval(e.Item.DataItem, "SrvEndEta_Date"));

                Label lblAccessQuality = (Label)e.Item.FindControl("lblAccessQuality");


                if (Size != "")
                    lblAccessQuality.Text = AccessoriesName + " (" + Size + ")";
                else
                    lblAccessQuality.Text = AccessoriesName;

                HiddenField hdnAccessoryMasterId = (HiddenField)e.Item.FindControl("hdnAccessoryMasterId");
                if (Convert.ToInt32(hdnAccessoryMasterId.Value) >= 40000)
                {
                    lblAccessQuality.Attributes.Add("style", "color:gray !important");
                }

                Label lblAccessInHouse = (Label)e.Item.FindControl("lblAccessInHouse");
                lblAccessInHouse.Text = Inhouse_Percent == 0 ? "" : Inhouse_Percent.ToString() + " %";

                Label lblAccessRecQty = (Label)e.Item.FindControl("lblAccessRecQty");
                TextBox txtQuantityAvail = (TextBox)e.Item.FindControl("txtQuantityAvail");
                HiddenField hdnQuantityAvailk = (HiddenField)e.Item.FindControl("hdnQuantityAvailk");

                if (AccessRecQty > 0)
                {
                    lblAccessRecQty.Text = AccessRecQty >= 500 ? Math.Round(Convert.ToDouble(AccessRecQty) / 1000, 1).ToString() + " k" : AccessRecQty.ToString();
                    lblAccessRecQty.ToolTip = AccessRecQty.ToString("N0");

                    hdnQuantityAvailk.Value = AccessRecQty >= 500 ? Math.Round(Convert.ToDouble(AccessRecQty) / 1000, 1).ToString() + " k" : AccessRecQty.ToString();
                    txtQuantityAvail.Text = AccessRecQty >= 500 ? Math.Round(Convert.ToDouble(AccessRecQty) / 1000, 1).ToString() + " k" : AccessRecQty.ToString();
                    txtQuantityAvail.ToolTip = AccessRecQty.ToString("N0");
                }

                string GarmentUnit = (DataBinder.Eval(e.Item.DataItem, "GarmentUnit").ToString());

                Label lblAccessIssuedQty = (Label)e.Item.FindControl("lblAccessIssuedQty");

                if (IssuedQty > 0)
                {
                    lblAccessIssuedQty.Text = IssuedQty >= 500 ? "(" + Math.Round(Convert.ToDouble(IssuedQty) / 1000, 1).ToString() + " k " + GarmentUnit + ")" : "(" + IssuedQty.ToString() + " " + GarmentUnit + ")";
                    lblAccessIssuedQty.ToolTip = IssuedQty.ToString("N0");
                }

                Label lblAccessTotalQty = (Label)e.Item.FindControl("lblAccessTotalQty");
                if (TotalQty > 0)
                {
                    lblAccessTotalQty.Text = TotalQty >= 0 ? Math.Round(Convert.ToDouble(TotalQty) / 1000, 1).ToString() + " k" : TotalQty.ToString();
                    lblAccessTotalQty.ToolTip = TotalQty.ToString("N0");
                }

                Label lblAccessOrderOn = (Label)e.Item.FindControl("lblAccessOrderOn");
                lblAccessOrderOn.Text = PoOrder_Date == DateTime.MinValue ? "" : PoOrder_Date.ToString("dd MMM");

                HtmlTableCell tdAccessOrderOn = (HtmlTableCell)e.Item.FindControl("tdAccessOrderOn");
                if (lblAccessOrderOn.Text != "")
                    tdAccessOrderOn.Style.Add("background-color", "#eaece4");

                Label lblAccesActuakDate = (Label)e.Item.FindControl("lblAccesActuakDate");
                lblAccesActuakDate.Text = SrvEndEta_Date == DateTime.MinValue ? "" : SrvEndEta_Date.ToString("dd MMM");

                Label lblStageTooltip = (Label)e.Item.FindControl("lblStageTooltip");

                //string StageTooltip = "";
                //if (GrieseFinishTooltip != "")
                //    StageTooltip = GrieseFinishTooltip;
                //if (ProcessTooltip != "")
                //    StageTooltip = StageTooltip + " " + ProcessTooltip;

                //lblStageTooltip.Text = StageTooltip;

                if (IsOldOrder == 1)
                {
                    lblAccessRecQty.Visible = false;
                    txtQuantityAvail.Visible = true;
                }
                else
                {
                    lblAccessRecQty.Visible = true;
                    txtQuantityAvail.Visible = false;
                }

                DateTime BIHDate = Convert.ToDateTime(ViewState["BIHDate"].ToString());

                if (BIHDate.Date >= System.DateTime.Now.Date && !IsExcludeFromBIH)
                {
                    if (lblAccesActuakDate.Text != "")
                    {

                        if (Inhouse_Percent > 0)
                        {
                            if (Inhouse_Percent >= 100)
                            {
                                Access_ColorGreen = 1;
                            }
                            else
                ...
                if (BIHDate.Date < System.DateTime.Now.Date && !IsExcludeFromBIH)
                {
                    if (lblAccesActuakDate.Text != "")
                    {
                        ...
                        if (BIHDate.Date < Convert.ToDateTime(SrvEndEta_Date).Date)
                        {
                            Access_ColorRed = 1;
                        }
                        if (Inhouse_Percent > 0)
        ...
        protected void repProduction_ItemDataBound(object sender, RepeaterItemEventArgs e)
        {
            ...
            if (e.Item.ItemType == ListItemType.Item || e.Item.ItemType == ListItemType.AlternatingItem)
            {
                ...
                txtVAToday.Text = TodayValueAddedQty == 0 ? "" : TodayValueAddedQty.ToString("N0");
                // End Adding
                ...
                if (Convert.ToDouble(TotalStitched) >= 1000)
                    StitchTotalTotal = Math.Round(Convert.ToDouble(TotalStitched) / 1000, 1);
                else
                    StitchTotalTotal = Convert.ToInt32(Convert.ToDouble(TotalStitched));
            ...
            if (e.Item.ItemType == ListItemType.Footer)
            {
                ...
                if (IsShipped == true)
                {
                    ...
                    lblCutTotal_Percent.CssClass = "MOProdSecGray";
                    lblCutIssuetotal_percent.CssClass = "MOProdSecGray";
                    DivStitchTotal.Attributes.Add("style", "background:#f9f9fa !important;border-bottom: 1px solid #d6d6d699 !important;");//updated code by bharat on 18-feb 
                }
