...
{
    public partial class frmFactorywiseforceMMR : System.Web.UI.UserControl
    {
        ...
        public void bindgrd()
        {
            ...
            DataSet ds = objAdminController.GetworkerType_MMR();
        ...
        protected void grdCurrency_RowUpdating(object sender, GridViewUpdateEventArgs e)
        {
            ...
            RadioButton rdo_IsStatus = Rows.FindControl("rdo_isStatus1") as RadioButton;
            ...
            Result = objAdminController.UpdateWorkerBAL_MMR(txtWorkertype.Text, salary, CurrentLoggedInUserID, id, DdlStaff, Machine_Count_rdo, MmrCount, txt_Discription.Text, OT1, OT2, OT3, OT4, Isfactorystaff, ddlcatogar, measurment, Qntys, Percentages, isStatus);
            if (Result == 0)
            {
                string script = string.Empty;
        ...
        protected void btnsubmit_Click(object sender, EventArgs e)
        {
            ...
            if (rdo_IsStatus1.Checked == false && rdo_IsStatus2.Checked == false)
            {
                string script = string.Empty;
                script = "ShowHideMessageBox(true, 'Select Status','Manpower form');";
                ScriptManager.RegisterStartupScript(Page, typeof(Page), "ShowMessage", script, true);
                return;
            ...
            int result = objAdminController.InsertUpdateWorkerBAL_MMR(txtWorker.Value.Trim(), Convert.ToInt32(txtsalary.Value.Trim()), CurrentLoggedInUserID, machinecount, Obbased, ddlstaffvalue, Discription,
                OT1, OT2, OT3, OT4, isstaff, ddlCatogarySelected, measurment, Qntys, Percentages, IsStatus);
            if (result > 0)
            {
        ...
        protected void grdCurrency_RowDataBound(object sender, GridViewRowEventArgs e)
        {
            ...
            if (e.Row.RowType == DataControlRowType.DataRow)
            {
                ...
                if ((e.Row.RowState & DataControlRowState.Edit) > 0)
                {
                    ...
                    RadioButton rdo_isStatus1 = (RadioButton)e.Row.FindControl("rdo_isStatus1");
                    RadioButton rdo_isStatus2 = (RadioButton)e.Row.FindControl("rdo_isStatus2");
                    ...
                    if (dr["IsStatus"].ToString() == "True")
                    {
                        rdo_isStatus1.Checked = true;
                    }
                    else
                    {
                        rdo_isStatus2.Checked = true;
                    }
