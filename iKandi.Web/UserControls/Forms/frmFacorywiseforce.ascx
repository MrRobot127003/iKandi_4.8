<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="frmFacorywiseforce.ascx.cs"
    Inherits="iKandi.Web.UserControls.Forms.frmFacorywiseforce" %>
<style type="text/css">
    .style1
    {
        width: 12%;
                                        ...
                                        <td valign="top">
                                           ...
                                           <asp:ListItem Value="4" Text="">Pcs Per hour based</asp:ListItem>--%>
                                                    ...
                                                    <asp:TemplateField HeaderText="Measure ment" HeaderStyle-Font-Bold="false" HeaderStyle-Width="50PX">
                                                        ...
                                                        <EditItemTemplate>
                                                            <div style="text-transform: capitalize;">
                                                                <asp:TextBox ID="txtMeasurementgrd" MaxLength="4" onkeypress="return onlyNumbers(event);"
