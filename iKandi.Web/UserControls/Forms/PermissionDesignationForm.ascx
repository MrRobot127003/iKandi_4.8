<%@ Control Language="C#" AutoEventWireup="true" CodeBehind="PermissionDesignationForm.ascx.cs" Inherits="iKandi.Web.UserControls.Lists.PermissionDesignation" %>
<style type="text/css">
    .style1
    {
        height: 14px;
...
<script type="text/javascript">
    ...
    $(function () {
        $('.permissionDesignation input', "#main_content").click(function () {
            var objRow = $(this).parents("tr");
            var rowindex = objRow.get(0).rowIndex;
            var designationID = $('#<%=ddlDesignation.ClientID %>', "#main_content").val();
            ...
            proxy.invoke('SavePermission', { permissionId: permissionControl.val(), userId: '-1', designationId: designationID, read: readValue, write: writeValue, applicationModuleId: applicationModuleID, applicationModuleColumnId: '-1', departmentId: '-1' },
        function (submit) {
    ...
    $(function () {
        $('.permissionApplicationModuleDesignation input', "#main_content").click(function () {
            ...
            proxy.invoke('SavePermission', { permissionId: permissionControl.val(), userId: '-1', designationId: designationID, read: readValue, write: writeValue, applicationModuleId: applicationModuleID, applicationModuleColumnId: applicationModuleColumnID, departmentId: '-1' },
        function (submit) {
            permissionControl.val(submit);
            //jQuery.facebox('Data has been saved successfully!');   
        }, onPageError, false, false);
...
<table width="100%" border="0" cellspacing="0" cellpadding="0">
      <tr>
        ...
        <td width="1205" class="da_table_heading_bg"><span class="da_h1">Permission Designation</span></td>
...
<table cellspacing="3" width="100%">
    <tr>
        <td align="right">
            <asp:DropDownList ID="ddlDesignation" runat="server" Width="265px" 
                AutoPostBack="true" CssClass="input_in" Style="margin-left: 0px" 
            ...
            <asp:GridView ID="grdUserPermissions" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Read" SortExpression="Read" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="chkRead" runat="server" Checked='<%# Bind("Read") %>'  CssClass="permissionDesignation"/>--%>
                            <asp:RadioButton ID="chkRead" GroupName="applicationModule" runat="server" Checked='<%# Bind("Read") %>'  CssClass="permissionDesignation"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Read/Write" SortExpression="Write" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="chkWrite" runat="server" Checked='<%# Bind("Write") %>'  CssClass="permissionDesignation"/>--%>
                            <asp:RadioButton ID="chkWrite" GroupName="applicationModule" runat="server" Checked='<%# Bind("Write") %>'  CssClass="permissionDesignation"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                                         <asp:TemplateField HeaderText="Restrict" SortExpression="Write" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkRestrict" runat="server" Checked='<%# Convert.ToBoolean( Eval("Write")) || Convert.ToBoolean( Eval("Read"))  %>' CssClass="permissionDesignation" />
                        </ItemTemplate>
                    </asp:TemplateField>
                    
                </Columns>
                <EmptyDataTemplate><lable>No record Found</lable></EmptyDataTemplate>
            </asp:GridView>
            <asp:ObjectDataSource ID="odsPermission" runat="server" SelectMethod="GetPermissionByDesignation"
    ...
    <tr>
        <td align="right" class="style1">
            <asp:DropDownList ID="ddlApplicationModuleName" runat="server" Width="265px" 
                AutoPostBack="true" CssClass="input_in" Style="margin-left: 0px" >
        ...
        <td>
            <asp:GridView ID="grdApplicationModulePermission" runat="server" AutoGenerateColumns="False"
                ...
                <Columns>
                    ...
                    <asp:TemplateField HeaderText="Read" SortExpression="Read" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="chkPermissionRead" runat="server" Checked='<%# Bind("Read") %>'  CssClass ="permissionApplicationModuleDesignation"/>--%>
                            <asp:RadioButton ID="chkPermissionRead" GroupName="applicationModuleColumn" runat="server" Checked='<%# Bind("Read") %>'  CssClass ="permissionApplicationModuleDesignation"/>
                        </ItemTemplate>
                    </asp:TemplateField>
                    <asp:TemplateField HeaderText="Read/Write" SortExpression="Write" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <%--<asp:CheckBox ID="chkPermissionWrite" runat="server" Checked='<%# Bind("Write") %>' CssClass="permissionApplicationModuleDesignation" />--%>
                            <asp:RadioButton ID="chkPermissionWrite" GroupName="applicationModuleColumn" runat="server" Checked='<%# Bind("Write") %>' CssClass="permissionApplicationModuleDesignation" />
                        </ItemTemplate>
                    </asp:TemplateField>
                      <asp:TemplateField HeaderText="Restrict" SortExpression="Write" ControlStyle-Width="25%">
                        <ItemTemplate>
                            <asp:CheckBox ID="chkRestrict" runat="server" Checked='<%# Convert.ToBoolean( Eval("Write")) || Convert.ToBoolean( Eval("Read"))  %>' CssClass="permissionApplicationModuleDesignation" />
                        </ItemTemplate>
                    </asp:TemplateField>
                </Columns>
            ...
            <asp:ObjectDataSource ID="odsColumnPermission" runat="server" 
                TypeName="iKandi.BLL.PermissionController" 
                OldValuesParameterFormatString="original_{0}" 
                SelectMethod="GetColumnPermissionByDesignation" >
                <SelectParameters>
                    <asp:ControlParameter ControlID="ddlDesignation" Name="DesignationID" 
