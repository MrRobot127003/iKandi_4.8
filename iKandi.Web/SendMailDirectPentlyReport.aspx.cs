...
{
    public partial class SendMailDirectPentlyReport : System.Web.UI.Page
    {
        string MailType = "Penalty Reports";
        string Flag = string.Empty;
        protected void Page_Load(object sender, EventArgs e)
        {
            //string url = "http://192.168.0.4/PentlyReportNew.aspx";//Live

            string url = "http://localhost:3220/PentlyReportNew.aspx";
