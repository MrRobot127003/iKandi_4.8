...
{
    public partial class frmMeterageScheduler : System.Web.UI.Page
    {
        string MailType = "Fabric Average Saving Report";
        string Flag = string.Empty;
        string FitsPath = string.Empty;
        string name = "";
        protected void Page_Load(object sender, EventArgs e)
        {
            string url = "http://localhost:3220/QuarterlyAverageSavingReport.aspx";
        ...
        public Boolean SendClientRegistrationEmail(String ClientName, String UsernamePasswordList, String ToEmail, string MailType)
        {
            ...
            try
            {
                ...
                {
                    if (MailType == "Fabric Average Saving Report")
                    {
                        List<Attachment> atts = new List<Attachment>();

                        //ReportType = "HandOver-PreOrder";
                        name = "Fabric_Average_Saving" + ".xlsx";
