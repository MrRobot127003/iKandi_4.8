    ...
    public partial class Login : BasePage
    {
        ...
        public string UserName
        {
            get
            {
                ...
                if (null != Request.QueryString["un"]) { un = Request.QueryString["un"].ToString(); }
                return un;
            }
        }
        ...
        public string Password
        {
            get
            {
                ...
                if (null != Request.QueryString["pwd"]) { pwd = Request.QueryString["pwd"].ToString(); }
                return pwd;
            }
        }
        ...
        public string ScreenShotUrl
        {
            get
            {
                ...
                if (null != Request.QueryString["ssu"]) { ssu = Request.QueryString["ssu"].ToString(); ssu = HttpUtility.UrlDecode(ssu); }
                return ssu;
            }
        }
        public string IsSupplierLogin
        {
            ...
            {
                string un = string.Empty;
                if (null != Request.QueryString["IsSupplierLogin"]) { un = Request.QueryString["IsSupplierLogin"].ToString(); }
                return un;
            }
        }
        #endregion
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            if (HttpRuntime.Cache["WORKFLOWPHASE"] != null) { HttpRuntime.Cache.Remove("WORKFLOWPHASE"); }
            if (HttpRuntime.Cache["PERMISSION"] != null) { HttpRuntime.Cache.Remove("PERMISSION"); }
            if (HttpRuntime.Cache["APPLICATIONMODULE"] != null) { HttpRuntime.Cache.Remove("APPLICATIONMODULE"); }
            if (HttpRuntime.Cache["APPLICATIONUSERS"] != null) { HttpRuntime.Cache.Remove("APPLICATIONUSERS"); }
            if (HttpRuntime.Cache["ALLOCATEDUNITDATA"] != null) { HttpRuntime.Cache.Remove("ALLOCATEDUNITDATA"); }
            ...
            // Below is comented by Sanjev on 19/04/2021 for stop of ikandi domain
            ...
            //        RemoveItemFromDropDown(ddlDomain, "6");
            //    }
            //}
            //else
            //{
        ...
        protected void Login1_LoggingIn(object sender, LoginCancelEventArgs e)
        {
            ...
            if (Convert.ToInt32(ddlDomain.SelectedValue) < 3 && Convert.ToInt32(ddlDomain.SelectedValue) > -1)
                (sender as System.Web.UI.WebControls.Login).UserName = (sender as System.Web.UI.WebControls.Login).UserName + (ddlDomain.SelectedValue == "1" ? "@ikandi.org.uk" : ddlDomain.SelectedItem.Text);
        ...
        protected void Login1_Authenticate(object sender, AuthenticateEventArgs e)
        {
            ...
            Boolean ispproved = false;
            if (mUser != null)
            {
                ispproved = mUser.IsApproved;
            }
            ...
            if (mUser != null && ispproved == false)
            {
                e.Authenticated = false;

                (sender as System.Web.UI.WebControls.Login).FailureText = "Your Username invalid/ Inactive.";
                return;
            }
            ...
            else
            {
                ...
                if (count < 5)
                {
                    ...
                    msg = "Your Username or Password invalid.";
                    switch (count)
                    {
                        case 1:
            ...
            if ((e.Authenticated == true && Convert.ToInt32(ddlDomain.SelectedValue) < 3))
            {
                ...
                else
                {
                    ...
                    if (Dns.GetHostName() == "sanjeev-pc" || Dns.GetHostName() == "shubhendu-PC" || Dns.GetHostName().ToUpper() == "ravishankar-PC".ToUpper() || Dns.GetHostName() == "dineshS-PC" || Dns.GetHostName()=="shubhandu") // abhishek : For Local login 
                    {
                        e.Authenticated = true;
                    }
                    else
