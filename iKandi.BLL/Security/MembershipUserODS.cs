...
namespace iKandi.BLL.Security
{
    ...
    public class MembershipUserODS
    {
        ...
        /// 
        [DataObjectMethod(DataObjectMethodType.Update, false)]
        static public void Update(string Username, bool isApproved, string cityProvince, string state, string country, string phoneNumber, string company)
        {
            bool dirtyFlag = false;
            MembershipUser mu = Membership.GetUser(Username);

            //UserProfile profile = (UserProfile)ProfileBase.Create(mu.UserName);
            ////profile.Address1 = address1;
            ////profile.Address2 = address2;
            ////profile.AreaOfPCInterest = areaOfPCInterest;
            //profile.Company = company;
            ////profile.FirstName = firstName;
            ////profile.MiddleName = middleName;
            ////profile.LastName = lastName;
            //profile.CityProvince = cityProvince;
        ...
        /// <summary>
        /// Returns the user details by username
        /// </summary>
        /// <param name="username"></param>
        /// <returns></returns>
        [DataObjectMethod(DataObjectMethodType.Select, true)]
        static public MembershipUserWrapper GetMember(string email)
        {
        ...
        [DataObjectMethod(DataObjectMethodType.Update, false)]
        static public void UpdateUsers(bool IsApproved, string FirstName, string CityProvince, string State, string Country, string PhoneNumber, string Company,  string original_UserName)
        {
            bool dirtyFlag = false;
            MembershipUser mu = Membership.GetUser(original_UserName);
            ...
            string usernameToFind, string sortData)
        {
            ...
            if (usernameToFind != null)
            {
                ...
                if (mu != null)
                {
                    ...
                    //UserProfile profile = (UserProfile)ProfileBase.Create(mu.UserName);
                    //md.Address1 = profile.Address1;
                    //md.Address2 = profile.Address2;
                    //md.AreaOfPCInterest = profile.AreaOfPCInterest;
                    //md.Company = profile.Company;
                    //md.FirstName = profile.FirstName;
                    //md.MiddleName = profile.MiddleName;
                    //md.LastName = profile.LastName;
                    //md.CityProvince = profile.CityProvince;
                    //md.Country = profile.Country;
                    //md.Industry = profile.Industry;
                    //md.State = profile.State;
                    //md.PhoneNumber = profile.PhoneNumber;
